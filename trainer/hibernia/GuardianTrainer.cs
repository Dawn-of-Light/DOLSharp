...
namespace DOL.GS.Trainer
{
	...
	/// Guardian Trainer
	/// </summary>	
	public class GuardianTrainer : GameStandardTrainer
	{
		/// <summary>
		...
		public static void OnServerStartup(DOLEvent e, object sender, EventArgs args)
		{
			...
			if(!allStartupItems.Contains(training_sword_hib_template))
			{
				allStartupItems.Add(training_sword_hib_template);
		...
		/// <returns></returns>
 		...
 		{		
			...
			player.Out.SendMessage(this.Name + " says, \"[Hero], [Champion] or [Blademaster]?\"", eChatType.CT_Say, eChatLoc.CL_PopupWindow);												
