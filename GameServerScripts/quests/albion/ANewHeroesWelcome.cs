...
namespace DOL.GS.Quests.Albion
{
    public class ANewHeroesWelcome : RewardQuest
    {
        ...
        //    get
        //    {
        //        return String.Format("Deliver the message from Master Claistan to Pompin the Crier.  He's most knowledgable about current events.  He can fill you in on the latest local news and perhaps give you a task.\nQuest Goal : Take the message to Pompin the Crier (1/1).");
        //    }
        //}
