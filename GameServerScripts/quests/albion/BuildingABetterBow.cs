    ...
    public class BuildingABetterBow : BaseQuest
    {
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            */
            ...
            // item db check
            wellPreservedBones = (GenericItemTemplate)GameServer.Database.FindObjectByKey(typeof(GenericItemTemplate), "well_preserved_bone");
            if (wellPreservedBones == null)
            {
                ...
                wellPreservedBones.ItemTemplateID = "well_preserved_bone";
            ...
            // item db check
            twoWellPreservedBones = (GenericItemTemplate)GameServer.Database.FindObjectByKey(typeof(GenericItemTemplate), "two_well_preserved_bones");
            if (twoWellPreservedBones == null)
            {
                ...
                twoWellPreservedBones.ItemTemplateID = "two_well_preserved_bones";
        ...
        private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
        {
            ...
            else
            {
                ...
                if (!QuestMgr.GiveQuestToPlayer(typeof(BuildingABetterBow), player))
                    return;
        ...
        public override void Notify(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (e == GameLivingEvent.EnemyKilled)
            {
                if (Step == 2)
                {
                    ...
                    if (gArgs.Target.Name == "skeleton")
                    {
                        if (Util.Chance(50))
                        {
                            ...
                            GiveItemToPlayer(gArgs.Target, wellPreservedBones.CreateInstance());
                            Step = 3;
                        }
                        return;
                    }
                ...
                else if (Step == 3)
                {
                    ...
                    if (gArgs.Target.Name == "skeleton")
                    {
                        ...
                        {
                            player.Out.SendDialogBox(eDialogCode.SimpleWarning, 0x00, 0x00, 0x00, 0x00, eDialogType.Ok, true, "You select a well-preserved bone from the \nremains and place it in your pack. \nYour journal has been updated.");
                            RemoveItemFromPlayer(wellPreservedBones);
                            GiveItemToPlayer(twoWellPreservedBones.CreateInstance());
                            Step = 4;
                        }
                        return;
                    }
            ...
            else if (e == GamePlayerEvent.GiveItem)
            {
                if (Step == 4)
                {
                    ...
                    if (gArgs.Target.Name == elvarIronhand.Name && gArgs.Item.Name == twoWellPreservedBones.Name)
                    {
