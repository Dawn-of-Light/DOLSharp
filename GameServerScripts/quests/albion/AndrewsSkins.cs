...
namespace DOL.GS.Quests.Albion
{
    ...
    */
     ...
     */
    [NHibernate.Mapping.Attributes.Subclass(NameType = typeof(AndrewsSkins), ExtendsType = typeof(AbstractQuest))]
    public class AndrewsSkins : BaseQuest
    {
        ...
        public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
        {
            ...
            */
            ...
            // item db check
            bundleOfBearSkins = (GenericItemTemplate)GameServer.Database.FindObjectByKey(typeof(GenericItemTemplate), "bundle_of_bear_skins");
            if (bundleOfBearSkins == null)
            {
                ...
                bundleOfBearSkins.ItemTemplateID = "bundle_of_bear_skins";
            ...
            // item db check
            spoolOfLeatherworkingThread = (GenericItemTemplate)GameServer.Database.FindObjectByKey(typeof(GenericItemTemplate), "spool_of_leatherworking_thread");
            if (spoolOfLeatherworkingThread == null)
            {
                ...
                spoolOfLeatherworkingThread.ItemTemplateID = "spool_of_leatherworking_thread";
            ...
            // item db check
            chokerOfTheBear = (NecklaceTemplate)GameServer.Database.FindObjectByKey(typeof(NecklaceTemplate), "choker_of_the_bear");
            if (chokerOfTheBear == null)
            {
                ...
                chokerOfTheBear.ItemTemplateID = "choker_of_the_bear";
                    ...
                    switch (wArgs.Text)
                    {
                        case "thread":
                            if (quest.Step == 2)
                            {
                                ...
                                player.Inventory.AddItem(eInventorySlot.FirstBackpack, spoolOfLeatherworkingThread.CreateInstance());
        ...
        protected static void QuestDialogResponse(DOLEvent e, object sender, EventArgs args)
        {
            ...
            if (gArgs != null && gArgs.QuestDescriptor.LinkedQuestType.Equals(typeof(AndrewsSkins)))
            {
                ...
                if (e == GamePlayerEvent.AcceptQuest)
                {
                    ...
                    {
                        // give letter        
                        player.Inventory.AddItem(eInventorySlot.FirstBackpack, bundleOfBearSkins.CreateInstance());
