...
namespace DOL.GS.Quests.Albion
{
	...
	*/
	 ...
	 */
	[NHibernate.Mapping.Attributes.Subclass(NameType = typeof(TraitorInCotswold), ExtendsType = typeof(AbstractQuest))]
	public class TraitorInCotswold : BaseFrederickQuest
	{
		...
		public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
		{
			...
			*/
			...
			// item db check
			necklaceOfDoppelganger = (NecklaceTemplate) GameServer.Database.FindObjectByKey(typeof (NecklaceTemplate), "necklace_of_the_doppelganger");
			...
			// item db check
			recruitsBoots = (FeetArmorTemplate) GameServer.Database.FindObjectByKey(typeof (FeetArmorTemplate), "recruits_studded_boots");
			if (recruitsBoots == null)
			{
				...
				recruitsBoots.ItemTemplateID = "recruits_studded_boots";
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					switch (wArgs.Text)
					{
						...
						case "problem":
							player.Out.SendCustomDialog("Will you help Cotswold by taking on this vital mission?", new CustomDialogResponse(CheckPlayerAcceptQuest));
							break;
					}
				}
				else
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!QuestMgr.GiveQuestToPlayer(typeof(TraitorInCotswold), player, masterFrederick))
					return;
				...
				// give necklace  
				player.Inventory.AddItem(eInventorySlot.FirstEmptyBackpack, necklaceOfDoppelganger.CreateInstance());
		...
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
			...
			if (Step == 4 && e == GamePlayerEvent.GiveItem)
			{
				...
				if (gArgs.Target.Name == masterFrederick.Name && gArgs.Item.Name == fairyPlans.Name)
				{
					RemoveItemFromPlayer(masterFrederick, fairyPlans);
		...
		public override void FinishQuest()
		{
			...
			RemoveItemFromPlayer(masterFrederick, necklaceOfDoppelganger);
