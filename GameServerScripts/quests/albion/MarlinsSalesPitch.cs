...
namespace DOL.GS.Quests.Albion
{
    ...
    public class MarlinsSalesPitch : BaseQuest
    {
                ...
                if (quest == null)
                {
                    switch (wArgs.Text)
                    {
                        case "business":
                            ...
                            break;
                        case "drum":
                            player.Out.SendCustomDialog(" Will you help Marlin retrieve his lost drum? [Levels 17-20] ", new CustomDialogResponse(CheckPlayerAcceptQuest));
                            break;
                    }
                }
                else
        ...
        public override void FinishQuest()
        {
            ...
            m_questPlayer.GainExperience((long)((m_questPlayer.ExperienceForNextLevel - m_questPlayer.ExperienceForCurrentLevel) / 9), 0, 0, true);
