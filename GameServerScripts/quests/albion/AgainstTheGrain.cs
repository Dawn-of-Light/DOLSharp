...
namespace DOL.GS.Quests.Albion
{
     ...
     */
    [NHibernate.Mapping.Attributes.Subclass(NameType = typeof(AgainstTheGrain), ExtendsType = typeof(AbstractQuest))] 
	public class AgainstTheGrain : BaseQuest
	{
		...
		public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
		{
			...
			*/
			...
			if (npcs.Length == 0)
			{
				...
				laridiaTheMinstrel.RegionId = 1;

				GameNpcInventoryTemplate template = new GameNpcInventoryTemplate();
				template.AddNPCEquipment(eInventorySlot.HandsArmor, 137, 9, 0);
				template.AddNPCEquipment(eInventorySlot.FeetArmor, 138, 9, 0);
				template.AddNPCEquipment(eInventorySlot.TorsoArmor, 134, 9, 0);
				template.AddNPCEquipment(eInventorySlot.Cloak, 96, 72, 0);
				template.AddNPCEquipment(eInventorySlot.LegsArmor, 140, 43, 0);
				template.AddNPCEquipment(eInventorySlot.ArmsArmor, 141, 43, 0);
        ...
        protected static void QuestDialogResponse(DOLEvent e, object sender, EventArgs args)
		{
            ...
            if (gArgs != null && gArgs.QuestDescriptor.LinkedQuestType.Equals(typeof(AgainstTheGrain)))
            {
