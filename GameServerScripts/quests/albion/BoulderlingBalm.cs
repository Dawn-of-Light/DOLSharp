                ...
                if (quest == null)
                {
                    switch (wArgs.Text)
                    {
                        ...
                        case "battle":
                            ...
                            player.Out.SendCustomDialog("Will you gather the ingredients for Brother Maynard's special balm? [Levels 10-13]", new CustomDialogResponse(CheckPlayerAcceptQuest));
                            break;                        
                    }
                }
                else
