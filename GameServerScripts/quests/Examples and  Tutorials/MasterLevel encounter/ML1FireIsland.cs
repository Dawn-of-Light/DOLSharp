...
namespace DOL.GS
{
    public class Ianetor : GameNPC
    {
        ...
        public void SpawnEncounter()
        {
            ...
            sunkaio.GuildName = string.Empty;
            sunkaio.X = 431865;
            sunkaio.Y = 544121;
            sunkaio.Z = 8311;
            ...
            zopureo.GuildName = string.Empty;
            zopureo.X = 432767;
            zopureo.Y = 543483;
            zopureo.Z = 8291;
        ...
        public static void SpawnIanetor1(int region)
        {
            ...
            ianetor1.GuildName = string.Empty;
            ianetor1.Model = 1194;
            ianetor1.Realm = 0;
        ...
        public static void SpawnIanetor2(int region)
        {
            ...
            ianetor2.GuildName = string.Empty;
            ianetor2.Model = 1194;
            ianetor2.Realm = 0;
