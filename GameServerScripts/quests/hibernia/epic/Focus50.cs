...
// end item			
			...
			if (RangerEpicBoots == null)
			{
				...
				RangerEpicBoots.ItemTemplateID = "RangerEpicBoots";
...
//end item
			...
			if (RangerEpicHelm == null)
			{
				...
				RangerEpicHelm.ItemTemplateID = "RangerEpicHelm";
...
//end item
			...
			if (RangerEpicGloves == null)
			{
				...
				RangerEpicGloves.ItemTemplateID = "RangerEpicGloves";
			...
			if (RangerEpicVest == null)
			{
				...
				RangerEpicVest.ItemTemplateID = "RangerEpicVest";
			...
			if (RangerEpicLegs == null)
			{
				...
				RangerEpicLegs.ItemTemplateID = "RangerEpicLegs";
			...
			if (RangerEpicArms == null)
			{
				...
				RangerEpicArms.ItemTemplateID = "RangerEpicArms";
...
//Hero Epic Sleeves End
			...
			if (HeroEpicBoots == null)
			{
				...
				HeroEpicBoots.ItemTemplateID = "HeroEpicBoots";
...
//end item
			...
			if (HeroEpicHelm == null)
			{
				...
				HeroEpicHelm.ItemTemplateID = "HeroEpicHelm";
...
//end item
			...
			if (HeroEpicGloves == null)
			{
				...
				HeroEpicGloves.ItemTemplateID = "HeroEpicGloves";
			...
			if (HeroEpicVest == null)
			{
				...
				HeroEpicVest.ItemTemplateID = "HeroEpicVest";
			...
			if (HeroEpicLegs == null)
			{
				...
				HeroEpicLegs.ItemTemplateID = "HeroEpicLegs";
			...
			if (HeroEpicArms == null)
			{
				...
				HeroEpicArms.ItemTemplateID = "HeroEpicArms";
			...
			if (HeroEpicBoots == null)
			{
				...
				WardenEpicBoots.ItemTemplateID = "WardenEpicBoots";
...
//end item
			...
			if (WardenEpicHelm == null)
			{
				...
				WardenEpicHelm.ItemTemplateID = "WardenEpicHelm";
...
//end item
			...
			if (WardenEpicGloves == null)
			{
				...
				WardenEpicGloves.ItemTemplateID = "WardenEpicGloves";
			...
			if (WardenEpicVest == null)
			{
				...
				WardenEpicVest.ItemTemplateID = "WardenEpicVest";
			...
			if (WardenEpicLegs == null)
			{
				...
				WardenEpicLegs.ItemTemplateID = "WardenEpicLegs";
			...
			if (WardenEpicArms == null)
			{
				...
				WardenEpicArms.ItemTemplateID = "WardenEpicArms";
			...
			if (EldritchEpicBoots == null)
			{
				...
				EldritchEpicBoots.ItemTemplateID = "EldritchEpicBoots";
...
//end item
			...
			if (EldritchEpicHelm == null)
			{
				...
				EldritchEpicHelm.ItemTemplateID = "EldritchEpicHelm";
...
//end item
			...
			if (EldritchEpicGloves == null)
			{
				...
				EldritchEpicGloves.ItemTemplateID = "EldritchEpicGloves";
			...
			if (EldritchEpicVest == null)
			{
				...
				EldritchEpicVest.ItemTemplateID = "EldritchEpicVest";
			...
			if (EldritchEpicLegs == null)
			{
				...
				EldritchEpicLegs.ItemTemplateID = "EldritchEpicLegs";
			...
			if (EldritchEpicArms == null)
			{
				...
				EldritchEpicArms.ItemTemplateID = "EldritchEpicArms";
...
//Item Descriptions End
		...
		public override void Notify(DOLEvent e, object sender, EventArgs args)
		{
			...
			if (Step == 2 && e == GamePlayerEvent.GiveItem)
			{
				...
				if (gArgs.Target.Name == Ainrebh.Name && gArgs.Item.ItemTemplateID == GreenMaw_key.ItemTemplateID)
				{
