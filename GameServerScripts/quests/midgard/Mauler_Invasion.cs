...
namespace DOL.GS.Quests.Midgard {
	...
	GameNPC[] npcs;
		...
		QuestBuilder builder = QuestMgr.getBuilder(typeof(maulerinvasion));
			...
			a.AddRequirement(eRequirementType.QuestGivable,"DOL.GS.Quests.Midgard.maulerinvasion",VikingKreimhilde);
			a.AddRequirement(eRequirementType.QuestPending,"DOL.GS.Quests.Midgard.maulerinvasion",(eComparator)5);
			...
			a.AddRequirement(eRequirementType.QuestGivable,"DOL.GS.Quests.Midgard.maulerinvasion",VikingKreimhilde);
			a.AddRequirement(eRequirementType.QuestPending,"DOL.GS.Quests.Midgard.maulerinvasion",(eComparator)5);
			a.AddAction(eActionType.OfferQuest,"DOL.GS.Quests.Midgard.maulerinvasion","Will you help Viking Kreimhilde reduce the black mauler cub population? [Levels 1-4]");
			AddQuestPart(a);
			a = builder.CreateQuestPart(VikingKreimhilde,-1);
				a.AddTrigger(eTriggerType.DeclineQuest,null,"DOL.GS.Quests.Midgard.maulerinvasion");
			a.AddAction(eActionType.Talk,"No problem. See you.",VikingKreimhilde);
			AddQuestPart(a);
			a = builder.CreateQuestPart(VikingKreimhilde,-1);
				a.AddTrigger(eTriggerType.AcceptQuest,null,"DOL.GS.Quests.Midgard.maulerinvasion");
			a.AddAction(eActionType.GiveQuest,"DOL.GS.Quests.Midgard.maulerinvasion",VikingKreimhilde);
			...
			a.AddRequirement(eRequirementType.QuestStep,"DOL.GS.Quests.Midgard.maulerinvasion",3,(eComparator)1);
			a.AddAction(eActionType.GiveItem,blackmaulercubpelt);
			a.AddAction(eActionType.IncQuestStep,"DOL.GS.Quests.Midgard.maulerinvasion");
			AddQuestPart(a);
			a = builder.CreateQuestPart(VikingKreimhilde,-1);
				a.AddTrigger(eTriggerType.Interact,null,VikingKreimhilde);
			a.AddRequirement(eRequirementType.QuestStep,"DOL.GS.Quests.Midgard.maulerinvasion",3,(eComparator)3);
			...
			a.AddAction(eActionType.SetQuestStep,null,4);
			AddQuestPart(a);
			a = builder.CreateQuestPart(VikingKreimhilde,-1);
				a.AddTrigger(eTriggerType.GiveItem,VikingKreimhilde,blackmaulercubpelt);
			a.AddRequirement(eRequirementType.QuestStep,"DOL.GS.Quests.Midgard.maulerinvasion",4,(eComparator)3);
			...
			a.AddAction(eActionType.SetQuestStep,"DOL.GS.Quests.Midgard.maulerinvasion",5);
			a.AddAction(eActionType.TakeItem,blackmaulercubpelt);
			AddQuestPart(a);
			a = builder.CreateQuestPart(VikingKreimhilde,-1);
				a.AddTrigger(eTriggerType.GiveItem,VikingKreimhilde,blackmaulercubpelt);
			a.AddRequirement(eRequirementType.QuestStep,"DOL.GS.Quests.Midgard.maulerinvasion",5,(eComparator)3);
			a.AddRequirement(eRequirementType.Level,1,(eComparator)3);
			...
			a.AddAction(eActionType.GiveXP,5);
			a.AddAction(eActionType.GiveGold,27);
			a.AddAction(eActionType.FinishQuest,"DOL.GS.Quests.Midgard.maulerinvasion");
			a.AddAction(eActionType.TakeItem,blackmaulercubpelt);
			AddQuestPart(a);
			a = builder.CreateQuestPart(VikingKreimhilde,-1);
				a.AddTrigger(eTriggerType.GiveItem,VikingKreimhilde,blackmaulercubpelt);
			a.AddRequirement(eRequirementType.QuestStep,"DOL.GS.Quests.Midgard.maulerinvasion",5,(eComparator)3);
			a.AddRequirement(eRequirementType.Level,2,(eComparator)3);
			a.AddAction(eActionType.Talk,"Excellent! I shall send these on to Jordheim as proof there really is problem here in Mularn. I shall send your name along with the pelts so they know which brave adventurer obtained them. Here is the money I promised you. Spend it wisely!",VikingKreimhilde);
			...
			a = builder.CreateQuestPart(VikingKreimhilde,-1);
				a.AddTrigger(eTriggerType.GiveItem,VikingKreimhilde,blackmaulercubpelt);
			a.AddRequirement(eRequirementType.QuestStep,"DOL.GS.Quests.Midgard.maulerinvasion",5,(eComparator)3);
			a.AddRequirement(eRequirementType.Level,3,(eComparator)3);
			a.AddAction(eActionType.Talk,"Excellent! I shall send these on to Jordheim as proof there really is problem here in Mularn. I shall send your name along with the pelts so they know which brave adventurer obtained them. Here is the money I promised you. Spend it wisely!",VikingKreimhilde);
			a.AddAction(eActionType.GiveXP,40);
			a.AddAction(eActionType.GiveGold,27);
			a.AddAction(eActionType.FinishQuest,"DOL.GS.Quests.Midgard.maulerinvasion");
			a.AddAction(eActionType.TakeItem,blackmaulercubpelt);
			AddQuestPart(a);
			a = builder.CreateQuestPart(VikingKreimhilde,-1);
				a.AddTrigger(eTriggerType.GiveItem,VikingKreimhilde,blackmaulercubpelt);
			a.AddRequirement(eRequirementType.QuestStep,"DOL.GS.Quests.Midgard.maulerinvasion",5,(eComparator)3);
			a.AddRequirement(eRequirementType.Level,4,(eComparator)3);
			a.AddAction(eActionType.Talk,"Excellent! I shall send these on to Jordheim as proof there really is problem here in Mularn. I shall send your name along with the pelts so they know which brave adventurer obtained them. Here is the money I promised you. Spend it wisely!",VikingKreimhilde);
