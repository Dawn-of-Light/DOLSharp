...
using DOL.AI.Brain;
	...
	public class trialofstrength : BaseQuest
	{
		...
		* Constructor
		*/
		public trialofstrength() : base()
		{
		}

		public trialofstrength(GamePlayer questingPlayer) : this(questingPlayer, 1)
		{
		}

		public trialofstrength(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public trialofstrength(GamePlayer questingPlayer, DBQuest dbQuest) : base(questingPlayer, dbQuest)
	{
	}
