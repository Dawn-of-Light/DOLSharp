...
*/
        ...
        public override void AbortQuest()
        {
            ...
            RemoveItem(QuestPlayer, askefruerWings, false);
            RemoveItem(QuestPlayer, askefruerWings, false);
            RemoveItem(QuestPlayer, askefruerWings, false);
        ...
        public override void FinishQuest()
        {
            ...
            RemoveItem(dalikor, QuestPlayer, dustyOldMap);

            if (QuestPlayer.HasAbilityToUseItem(recruitsArms))
            {
                GiveItem(dalikor, QuestPlayer, recruitsArms);
            }
            else
            {
                GiveItem(dalikor, QuestPlayer, recruitsSleeves);
            }
