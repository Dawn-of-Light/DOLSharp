	...
	public class Defenders_50 : BaseQuest
	{
		...
		public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
		{
			...
			if (ScoutEpicHelm == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.Dexterity, eProperty.Quickness, eProperty.Resist_Crush, eProperty.Resist_Heat },
				                     new []{ 12, 22, 8, 8 });
				i.AddQuestObjectToDatabase();
				ScoutEpicHelm = i;
			...
			if (ScoutEpicGloves == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.Dexterity, eProperty.Skill_Long_bows, eProperty.Resist_Body, eProperty.Resist_Slash },
				                     new []{ 21, 5, 8, 8 });
				i.AddQuestObjectToDatabase();
				ScoutEpicGloves = i;
			...
			if (ScoutEpicVest == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.Strength, eProperty.Resist_Thrust, eProperty.Resist_Spirit, eProperty.MaxHealth },
				                     new []{ 18, 4, 4, 45 });
				i.AddQuestObjectToDatabase();
			...
			if (ScoutEpicArms == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.Constitution, eProperty.Strength, eProperty.Resist_Energy, eProperty.Resist_Slash },
				                     new []{ 22, 18, 4, 4 });
				i.AddQuestObjectToDatabase();
				ScoutEpicArms = i;
			...
			if (ArmsmanEpicBoots == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.Strength, eProperty.Quickness, eProperty.Resist_Spirit },
				                     new []{ 15, 15, 8 });
				i.AddQuestObjectToDatabase();
				ArmsmanEpicBoots = i;
			...
			if (ArmsmanEpicHelm == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.Constitution, eProperty.Quickness, eProperty.Resist_Body, eProperty.Resist_Crush },
				                     new []{ 19, 18, 6, 6 });
				i.AddQuestObjectToDatabase();
				ArmsmanEpicHelm = i;
			...
			if (ArmsmanEpicGloves == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.Strength, eProperty.Dexterity, eProperty.Resist_Cold, eProperty.Resist_Slash },
				                     new []{ 22, 15, 6, 6 });
				i.AddQuestObjectToDatabase();
				ArmsmanEpicGloves = i;
			...
			if (ArmsmanEpicVest == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.Strength, eProperty.Resist_Slash, eProperty.Resist_Energy, eProperty.MaxHealth },
				                     new []{ 18, 4, 4, 45 });
				i.AddQuestObjectToDatabase();
				ArmsmanEpicVest = i;
			...
			if (ArmsmanEpicLegs == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.Constitution, eProperty.Strength, eProperty.Resist_Matter, eProperty.Resist_Crush },
				                     new []{ 24, 10, 8, 8 });
				i.AddQuestObjectToDatabase();
				ArmsmanEpicLegs = i;
			...
			if (ArmsmanEpicArms == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.Constitution, eProperty.Dexterity, eProperty.Resist_Heat, eProperty.Resist_Thrust },
				                     new []{ 19, 18, 6, 6 });
				i.AddQuestObjectToDatabase();
				ArmsmanEpicArms = i;
			...
			if (FriarEpicBoots == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.Quickness, eProperty.Dexterity, eProperty.Constitution, eProperty.Resist_Spirit },
				                     new []{ 18, 15, 12, 10 });
				i.AddQuestObjectToDatabase();
				FriarEpicBoots = i;
			...
			if (FriarEpicHelm == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.Dexterity, eProperty.Piety, eProperty.Constitution, eProperty.Skill_Enhancement },
				                     new []{ 15, 12, 10, 4 });
				i.AddQuestObjectToDatabase();
				FriarEpicHelm = i;
			...
			if (FriarEpicGloves == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.Piety, eProperty.Quickness, eProperty.Resist_Crush, eProperty.Skill_Rejuvenation },
				                     new []{ 15, 15, 6, 6 });
				i.AddQuestObjectToDatabase();
				FriarEpicGloves = i;
			...
			if (FriarEpicVest == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.MaxMana, eProperty.Resist_Crush, eProperty.Resist_Spirit, eProperty.MaxHealth },
				                     new []{ 10, 6, 4, 33 });
				i.AddQuestObjectToDatabase();
				FriarEpicVest = i;
			...
			if (FriarEpicLegs == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.Strength, eProperty.Constitution, eProperty.Resist_Heat, eProperty.Resist_Slash },
				                     new []{ 15, 22, 6, 6 });
				i.AddQuestObjectToDatabase();
				FriarEpicLegs = i;
			...
			if (FriarEpicArms == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.Piety, eProperty.Dexterity, eProperty.Resist_Cold, eProperty.Resist_Thrust },
				                     new []{ 18, 6, 8, 8 });
				i.AddQuestObjectToDatabase();
				FriarEpicArms = i;
			...
			if (TheurgistEpicBoots == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.Dexterity, eProperty.Resist_Cold, eProperty.Resist_Body, eProperty.Resist_Energy },
				                     new []{ 16, 6, 8, 8 });
				i.AddQuestObjectToDatabase();
			...
			if (TheurgistEpicHelm == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.Intelligence, eProperty.Dexterity, eProperty.Resist_Spirit, eProperty.Resist_Crush },
				                     new []{ 21, 13, 8, 8 });
				i.AddQuestObjectToDatabase();
				TheurgistEpicHelm = i;
			...
			if (TheurgistEpicGloves == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.Dexterity, eProperty.Intelligence, eProperty.Resist_Heat, eProperty.Resist_Matter },
				                     new []{ 16, 18, 8, 8 });
				i.AddQuestObjectToDatabase();
			...
			if (TheurgistEpicVest == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.MaxHealth, eProperty.MaxMana, eProperty.Resist_Cold },
				                     new []{ 24, 14, 4 });
				i.AddQuestObjectToDatabase();
				TheurgistEpicVest = i;
			...
			if (TheurgistEpicLegs == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.Constitution, eProperty.Skill_Wind, eProperty.Resist_Energy, eProperty.Resist_Cold },
				                     new []{ 19, 4, 10, 10 });
			...
			if (TheurgistEpicArms == null)
			{
				...
				i.SetTemplateBonuses(new []{ eProperty.Intelligence, eProperty.Skill_Earth, eProperty.Dexterity },
				                     new []{ 18, 4, 16 });
