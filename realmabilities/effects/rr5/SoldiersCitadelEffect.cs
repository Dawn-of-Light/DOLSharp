...
namespace DOL.GS.Effects
{
    ...
    public class SoldiersCitadelEffect : TimedEffect
    {
        ...
        public override void Start(GameLiving target)
        {
            ...
            if (target is GamePlayer)
            {
                ...
                EffectOwner.BuffBonusCategory4[(int)eProperty.ParryChance] += 50;
                EffectOwner.BuffBonusCategory4[(int)eProperty.BlockChance] += 50;
    ...
    public class SoldiersCitadelSecondaryEffect : TimedEffect
    {
        ...
        public override void Start(GameLiving target)
        {
            ...
            {
                EffectOwner = target as GamePlayer;
                EffectOwner.BuffBonusCategory4[(int)eProperty.ParryChance] -= 10;
                EffectOwner.BuffBonusCategory4[(int)eProperty.BlockChance] -= 10;
                GameEventMgr.AddHandler(EffectOwner, GamePlayerEvent.Quit, new DOLEventHandler(PlayerLeftWorld));
            }
        }
        public override void Stop()
