		...
		public override IList DelveInfo
		{
			get
			{
				...
				*/
				...
				list.Add("Function: damage/speed decrease");
				list.Add(" "); //empty line
				list.Add(Spell.Description);
				list.Add(" "); //empty line
				list.Add("Speed decrease: " + Spell.Value + "%");
				if(Spell.Damage != 0) list.Add("Damage: " + Spell.Damage.ToString("0.###;0.###'%'"));
				if(Spell.LifeDrainReturn != 0) list.Add("Health returned: " + Spell.LifeDrainReturn + "% of damage dealt");
