...
namespace DOL.GS.GameEvents
{
        public class ServerListUpdate
        {
                ...
                /// The Script Version
                /// </summary>
                protected static double ScriptVersion = 2.0;
                ...
                private static void StartList()
                {
                        ...
                        string Updater = "";
                                ...
                                Updater = UrlEncode("http://portal.dolserver.net/serverlist.php?action=submit&username=" + UserName + "&password=" + Password + "&totalclients=" + stormClients.ToString() + "&version=" + ScriptVersion);
