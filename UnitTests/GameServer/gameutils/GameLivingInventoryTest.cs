...
{	
	...
	public class GameLivingInventoryTest : DOLTestCase
	{
		...
		public void TestAddTemplate()
		{
			...
			if (gameLivingInventory.AddTemplate(template,7,eInventorySlot.RightHandWeapon,eInventorySlot.FourthQuiver))
			...
			PrintInventory(gameLivingInventory);
          	...
          	if (gameLivingInventory.AddTemplate(template,4,eInventorySlot.RightHandWeapon,eInventorySlot.FourthQuiver))
