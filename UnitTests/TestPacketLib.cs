...
namespace DOL.Tests
{
    ...
    public class TestPacketLib : IPacketLib
    {
        ...
        public int BowPrepare {
            ...
            set { if (BowPrepareSetFunc != null)
                {
                    BowPrepareSetFunc(this, value);
                }
            }
        }
        ...
        public int BowShoot {
            ...
            set { if (BowShootSetFunc != null)
                {
                    BowShootSetFunc(this, value);
                }
            }
        }
        ...
        public int OneDualWeaponHit {
            ...
            set { if (OneDualWeaponHitSetFunc != null)
                {
                    OneDualWeaponHitSetFunc(this, value);
                }
            }
        }
        ...
        public int BothDualWeaponHit {
            ...
            set { if (BothDualWeaponHitSetFunc != null)
                {
                    BothDualWeaponHitSetFunc(this, value);
                }
            }
        }
        ...
        {
            if (SendTCPPacket != null)
            {
                SendTCPPacket(this, packet);
            }
        }
        ...
        {
            if (SendTCPRawPacket != null)
            {
                SendTCPRawPacket(this, packet);
            }
        }
        ...
        {
            if (SendUDPRawPacket != null)
            {
                SendUDPRawPacket(this, packet);
            }
        }
        ...
        {
            if (SendWarlockChamberEffectMethod != null)
            {
                SendWarlockChamberEffectMethod(this, player);
            }
        }
        ...
        {
            if (SendVersionAndCryptKeyMethod != null)
            {
                SendVersionAndCryptKeyMethod(this);
            }
        }
        ...
        {
            if (SendLoginDeniedMethod != null)
            {
                SendLoginDeniedMethod(this, et);
            }
        }
        ...
        {
            if (SendLoginGrantedMethod != null)
            {
                SendLoginGrantedMethod(this);
            }
        }
        ...
        {
            if (SendLoginGrantedByteMethod != null)
            {
                SendLoginGrantedByteMethod(this, color);
            }
        }
        ...
        {
            if (SendSessionIDMethod != null)
            {
                SendSessionIDMethod(this);
            }
        }
        ...
        {
            if (SendPingReplyMethod != null)
            {
                SendPingReplyMethod(this, timestamp, sequence);
            }
        }
        ...
        {
            if (SendRealmMethod != null)
            {
                SendRealmMethod(this, realm);
            }
        }
        ...
        {
            if (SendCharacterOverviewMethod != null)
            {
                SendCharacterOverviewMethod(this, realm);
            }
        }
        ...
        {
            if (SendDupNameCheckReplyMethod != null)
            {
                SendDupNameCheckReplyMethod(this, name, nameExists);
            }
        }
        ...
        {
            if (SendBadNameCheckReplyMethod != null)
            {
                SendBadNameCheckReplyMethod(this, name, bad);
            }
        }
        ...
        {
            if (SendAttackModeMethod != null)
            {
                SendAttackModeMethod(this, attackState);
            }
        }
        ...
        {
            if (SendCharCreateReplyMethod != null)
            {
                SendCharCreateReplyMethod(this, name);
            }
        }
        ...
        {
            if (SendCharStatsUpdateMethod != null)
            {
                SendCharStatsUpdateMethod(this);
            }
        }
        ...
        {
            if (SendCharResistsUpdateMethod != null)
            {
                SendCharResistsUpdateMethod(this);
            }
        }
        ...
        {
            if (SendRegionsMethod != null)
            {
                SendRegionsMethod(this);
            }
        }
        ...
        {
            if (SendGameOpenReplyMethod != null)
            {
                SendGameOpenReplyMethod(this);
            }
        }
        ...
        {
            if (SendPlayerPositionAndObjectIDMethod != null)
            {
                SendPlayerPositionAndObjectIDMethod(this);
            }
        }
        ...
        {
            if (SendPlayerJumpMethod != null)
            {
                SendPlayerJumpMethod(this, headingOnly);
            }
        }
        ...
        {
            if (SendPlayerInitFinishedMethod != null)
            {
                SendPlayerInitFinishedMethod(this, mobs);
            }
        }
        ...
        {
            if (SendUDPInitReplyMethod != null)
            {
                SendUDPInitReplyMethod(this);
            }
        }
        ...
        public void SendMessage(string msg, eChatType type, eChatLoc loc)
        {
            ...
            {
                SendMessageMethod(this, msg, type, loc);
            }
        }
        ...
        {
            if (SendPlayerCreateMethod != null)
            {
                SendPlayerCreateMethod(this, playerToCreate);
            }
        }
        ...
        {
            if (SendObjectGuildIDMethod != null)
            {
                SendObjectGuildIDMethod(this, obj, guild);
            }
        }
        ...
        {
            if (SendPlayerQuitMethod != null)
            {
                SendPlayerQuitMethod(this, totalOut);
            }
        }
        ...
        {
            if (SendObjectRemoveMethod != null)
            {
                SendObjectRemoveMethod(this, obj);
            }
        }
        ...
        {
            if (SendObjectCreateMethod != null)
            {
                SendObjectCreateMethod(this, obj);
            }
        }
        ...
        {
            if (SendDebugModeMethod != null)
            {
                SendDebugModeMethod(this, on);
            }
        }
        ...
        {
            if (SendModelChangeMethod != null)
            {
                SendModelChangeMethod(this, obj, newModel);
            }
        }
        ...
        {
            if (SendModelAndSizeChangeMethod != null)
            {
                SendModelAndSizeChangeMethod(this, obj, newModel, newSize);
            }
        }
        ...
        {
            if (SendModelAndSizeChangeIDMethod != null)
            {
                SendModelAndSizeChangeIDMethod(this, objectId, newModel, newSize);
            }
        }
        ...
        {
            if (SendEmoteAnimationMethod != null)
            {
                SendEmoteAnimationMethod(this, obj, emote);
            }
        }
        ...
        {
            if (SendNPCCreateMethod != null)
            {
                SendNPCCreateMethod(this, npc);
            }
        }
        ...
        {
            if (SendLivingEquipmentUpdateMethod != null)
            {
                SendLivingEquipmentUpdateMethod(this, living);
            }
        }
        ...
        {
            if (SendRegionChangedMethod != null)
            {
                SendRegionChangedMethod(this);
            }
        }
        ...
        {
            if (SendUpdatePointsMethod != null)
            {
                SendUpdatePointsMethod(this);
            }
        }
        ...
        {
            if (SendUpdateMoneyMethod != null)
            {
                SendUpdateMoneyMethod(this);
            }
        }
        ...
        {
            if (SendUpdateMaxSpeedMethod != null)
            {
                SendUpdateMaxSpeedMethod(this);
            }
        }
        ...
        {
            if (SendDelveInfoMethod != null)
            {
                SendDelveInfoMethod(this, info);
            }
        }
        ...
        {
            if (SendCombatAnimationMethod != null)
            {
                SendCombatAnimationMethod(this, attacker, defender, weaponID, shieldID, style, stance, result, targetHealthPercent);
            }
        }
        ...
        {
            if (SendStatusUpdateMethod != null)
            {
                SendStatusUpdateMethod(this);
            }
        }
        ...
        {
            if (SendStatusUpdateByteMethod != null)
            {
                SendStatusUpdateByteMethod(this, sittingFlag);
            }
        }
        ...
        {
            if (SendSpellCastAnimationMethod != null)
            {
                SendSpellCastAnimationMethod(this, spellCaster, spellID, castingTime);
            }
        }
        ...
        {
            if (SendSpellEffectAnimationMethod != null)
            {
                SendSpellEffectAnimationMethod(this, spellCaster, spellTarget, spellid, boltTime, noSound, success);
            }
        }
        ...
        {
            if (SendRidingMethod != null)
            {
                SendRidingMethod(this, rider, steed, dismount);
            }
        }
        ...
        {
            if (SendFindGroupWindowUpdateMethod != null)
            {
                SendFindGroupWindowUpdateMethod(this, list);
            }
        }
        ...
        {
            if (SendGroupInviteCommandMethod != null)
            {
                SendGroupInviteCommandMethod(this, invitingPlayer, inviteMessage);
            }
        }
        ...
        {
            if (SendDialogBoxMethod != null)
            {
                SendDialogBoxMethod(this, code, data1, data2, data3, data4, type, autoWrapText, message);
            }
        }
        ...
        {
            if (SendCustomDialogMethod != null)
            {
                SendCustomDialogMethod(this, msg, callback);
            }
        }

        public Action<TestPacketLib, string, CustomDialogResponse> SendCustomDialogMethodTwo { get; set; } // patch 0017
        public void SendCustomDialog(string msg, CustomDialogResponse callback, bool customFormat)
        {
            if (SendCustomDialogMethod != null) SendCustomDialogMethodTwo(this, msg, callback);
        }
        ...
        {
            if (SendCheckLOSMethod != null)
            {
                SendCheckLOSMethod(this, Checker, Target, callback);
            }
        }
        ...
        {
            if (SendCheckLOSMgrMethod != null)
            {
                SendCheckLOSMgrMethod(this, source, target, callback);
            }
        }
        ...
        {
            if (SendGuildLeaveCommandMethod != null)
            {
                SendGuildLeaveCommandMethod(this, invitingPlayer, inviteMessage);
            }
        }
        ...
        {
            if (SendGuildInviteCommandMethod != null)
            {
                SendGuildInviteCommandMethod(this, invitingPlayer, inviteMessage);
            }
        }
        ...
        {
            if (SendQuestOfferWindowMethod != null)
            {
                SendQuestOfferWindowMethod(this, questNPC, player, quest);
            }
        }
        ...
        {
            if (SendQuestRewardWindowMethod != null)
            {
                SendQuestRewardWindowMethod(this, questNPC, player, quest);
            }
        }
        ...
        {
            if (SendQuestOfferWindowDataMethod != null)
            {
                SendQuestOfferWindowDataMethod(this, questNPC, player, quest);
            }
        }
        ...
        {
            if (SendQuestRewardWindowDataMethod != null)
            {
                SendQuestRewardWindowDataMethod(this, questNPC, player, quest);
            }
        }
        ...
        {
            if (SendQuestSubscribeCommandMethod != null)
            {
                SendQuestSubscribeCommandMethod(this, invitingNPC, questid, inviteMessage);
            }
        }
        ...
        {
            if (SendQuestAbortCommandMethod != null)
            {
                SendQuestAbortCommandMethod(this, abortingNPC, questid, abortMessage);
            }
        }
        ...
        {
            if (SendGroupWindowUpdateMethod != null)
            {
                SendGroupWindowUpdateMethod(this);
            }
        }
        ...
        {
            if (SendGroupMembersUpdateMethod != null)
            {
        ...
        {
            if (SendInventoryItemsUpdateMethod != null)
            {
                SendInventoryItemsUpdateMethod(this, itemsToUpdate);
            }
        }
        ...
        {
            if (SendInventorySlotsUpdateMethod != null)
            {
                SendInventorySlotsUpdateMethod(this, slots);
            }
        }
        ...
        {
            if (SendInventoryItemsUpdateWindowMethod != null)
            {
                SendInventoryItemsUpdateWindowMethod(this, windowType, itemsToUpdate);
            }
        }
        ...
        {
            if (SendInventoryItemsUpdateDictMethod != null)
            {
                SendInventoryItemsUpdateDictMethod(this, updateItems, windowType);
            }
        }
        ...
        {
            if (SendDoorStateMethod != null)
            {
                SendDoorStateMethod(this, region, door);
            }
        }
        ...
        {
            if (SendMerchantWindowMethod != null)
            {
                SendMerchantWindowMethod(this, itemlist, windowType);
            }
        }
        ...
        {
            if (SendTradeWindowMethod != null)
            {
                SendTradeWindowMethod(this);
            }
        }
        ...
        {
            if (SendCloseTradeWindowMethod != null)
            {
                SendCloseTradeWindowMethod(this);
            }
        }
        ...
        {
            if (SendPlayerDiedMethod != null)
            {
                SendPlayerDiedMethod(this, killedPlayer, killer);
            }
        }
        ...
        {
            if (SendPlayerReviveMethod != null)
            {
                SendPlayerReviveMethod(this, revivedPlayer);
            }
        }
        ...
        {
            if (SendPlayerForgedPositionMethod != null)
            {
                SendPlayerForgedPositionMethod(this, player);
            }
        }
        ...
        {
            if (SendUpdatePlayerMethod != null)
            {
                SendUpdatePlayerMethod(this);
            }
        }
        ...
        {
            if (SendUpdatePlayerSkillsMethod != null)
            {
                SendUpdatePlayerSkillsMethod(this);
            }
        }
        ...
        {
            if (SendUpdateWeaponAndArmorStatsMethod != null)
            {
                SendUpdateWeaponAndArmorStatsMethod(this);
            }
        }
        ...
        {
            if (SendCustomTextWindowMethod != null)
            {
                SendCustomTextWindowMethod(this, caption, text);
            }
        }
        ...
        {
            if (SendPlayerTitlesMethod != null)
            {
                SendPlayerTitlesMethod(this);
            }
        }
        ...
        {
            if (SendPlayerTitleUpdateMethod != null)
            {
                SendPlayerTitleUpdateMethod(this, player);
            }
        }
        ...
        {
            if (SendEncumberanceMethod != null)
            {
                SendEncumberanceMethod(this);
            }
        }
        ...
        {
            if (SendAddFriendsMethod != null)
            {
                SendAddFriendsMethod(this, friendNames);
            }
        }
        ...
        {
            if (SendRemoveFriendsMethod != null)
            {
                SendRemoveFriendsMethod(this, friendNames);
            }
        }
        ...
        {
            if (SendTimerWindowMethod != null)
            {
                SendTimerWindowMethod(this, title, seconds);
            }
        }
        ...
        {
            if (SendCloseTimerWindowMethod != null)
            {
                SendCloseTimerWindowMethod(this);
            }
        }
        ...
        {
            if (SendCustomTrainerWindowMethod != null)
            {
                SendCustomTrainerWindowMethod(this, type, tree);
            }
        }
        ...
        {
            if (SendChampionTrainerWindowMethod != null)
            {
                SendChampionTrainerWindowMethod(this, type);
            }
        }
        ...
        {
            if (SendTrainerWindowMethod != null)
            {
                SendTrainerWindowMethod(this);
            }
        }
        ...
        {
            if (SendInterruptAnimationMethod != null)
            {
                SendInterruptAnimationMethod(this, living);
            }
        }
        ...
        {
            if (SendDisableSkillMethod != null)
            {
                SendDisableSkillMethod(this, skills);
            }
        }
        ...
        {
            if (SendUpdateIconsMethod != null)
            {
                SendUpdateIconsMethod(this, changedEffects, lastUpdateEffectsCount);
            }
        }
        ...
        {
            if (SendLevelUpSoundMethod != null)
            {
                SendLevelUpSoundMethod(this);
            }
        }
        ...
        {
            if (SendRegionEnterSoundMethod != null)
            {
                SendRegionEnterSoundMethod(this, soundId);
            }
        }
        ...
        {
            if (SendDebugMessageMethod != null)
            {
                SendDebugMessageMethod(this, format, parameters);
            }
        }
        ...
        {
            if (SendDebugPopupMessageMethod != null)
            {
                SendDebugPopupMessageMethod(this, format, parameters);
            }
        }
        ...
        {
            if (SendEmblemDialogueMethod != null)
            {
                SendEmblemDialogueMethod(this);
            }
        }
        ...
        {
            if (SendWeatherMethod != null)
            {
                SendWeatherMethod(this, x, width, speed, fogdiffusion, intensity);
            }
        }
        ...
        {
            if (SendPlayerModelTypeChangeMethod != null)
            {
                SendPlayerModelTypeChangeMethod(this, player, modelType);
            }
        }
        ...
        {
            if (SendObjectDeleteMethod != null)
            {
                SendObjectDeleteMethod(this, obj);
            }
        }
        ...
        {
            if (SendObjectUpdateMethod != null)
            {
                SendObjectUpdateMethod(this, obj);
            }
        }
        ...
        {
            if (SendQuestListUpdateMethod != null)
            {
                SendQuestListUpdateMethod(this);
            }
        }
        ...
        {
            if (SendQuestUpdateMethod != null)
            {
                SendQuestUpdateMethod(this, quest);
            }
        }
        ...
        {
            if (SendConcentrationListMethod != null)
            {
                SendConcentrationListMethod(this);
            }
        }
        ...
        {
            if (SendUpdateCraftingSkillsMethod != null)
            {
                SendUpdateCraftingSkillsMethod(this);
            }
        }
        ...
        {
            if (SendChangeTargetMethod != null)
            {
                SendChangeTargetMethod(this, newTarget);
            }
        }
        ...
        {
            if (SendChangeGroundTargetMethod != null)
            {
                SendChangeGroundTargetMethod(this, newTarget);
            }
        }
        ...
        {
            if (SendPetWindowMethod != null)
            {
                SendPetWindowMethod(this, pet, windowAction, aggroState, walkState);
            }
        }
        ...
        {
            if (SendPlaySoundMethod != null)
            {
                SendPlaySoundMethod(this, soundType, soundID);
            }
        }
        ...
        {
            if (SendNPCsQuestEffectMethod != null)
            {
                SendNPCsQuestEffectMethod(this, npc, indicator);
            }
        }
        ...
        {
            if (SendMasterLevelWindowMethod != null)
            {
                SendMasterLevelWindowMethod(this, ml);
            }
        }
        ...
        {
            if (SendHexEffectMethod != null)
            {
                SendHexEffectMethod(this, player , effect1, effect2, effect3, effect4, effect5);
            }
        }
        ...
        {
            if (SendRvRGuildBannerMethod != null)
            {
                SendRvRGuildBannerMethod(this, player, show);
            }
        }
        ...
        {
            if (SendSiegeWeaponAnimationMethod != null)
            {
                SendSiegeWeaponAnimationMethod(this, siegeWeapon);
            }
        }
        ...
        {
            if (SendSiegeWeaponFireAnimationMethod != null)
            {
                SendSiegeWeaponFireAnimationMethod(this, siegeWeapon, timer);
            }
        }
        ...
        {
            if (SendSiegeWeaponCloseInterfaceMethod != null)
            {
                SendSiegeWeaponCloseInterfaceMethod(this);
            }
        }
        ...
        {
            if (SendSiegeWeaponInterfaceMethod != null)
            {
                SendSiegeWeaponInterfaceMethod(this, siegeWeapon, time);
            }
        }
        ...
        {
            if (SendLivingDataUpdateMethod != null)
            {
                SendLivingDataUpdateMethod(this, living, updateStrings);
            }
        }
        ...
        public void SendSoundEffect(ushort soundId, ushort zoneId, ushort x, ushort y, ushort z, ushort radius)
        {
            ...
            {
                SendSoundEffectMethod(this, soundId, zoneId, x, y, z, radius);
            }
        }
        ...
        {
            if (SendKeepInfoMethod != null)
            {
                SendKeepInfoMethod(this, keep);
            }
        }
        ...
        {
            if (SendKeepRealmUpdateMethod != null)
            {
                SendKeepRealmUpdateMethod(this, keep);
            }
        }
        ...
        {
            if (SendKeepRemoveMethod != null)
            {
                SendKeepRemoveMethod(this, keep);
            }
        }
        ...
        {
            if (SendKeepComponentInfoMethod != null)
            {
                SendKeepComponentInfoMethod(this, keepComponent);
            }
        }
        ...
        {
            if (SendKeepComponentDetailUpdateMethod != null)
            {
                SendKeepComponentDetailUpdateMethod(this, keepComponent);
            }
        }
        ...
        {
            if (SendKeepComponentRemoveMethod != null)
            {
                SendKeepComponentRemoveMethod(this, keepComponent);
            }
        }
        ...
        {
            if (SendKeepClaimMethod != null)
            {
                SendKeepClaimMethod(this, keep, flag);
            }
        }
        ...
        {
            if (SendKeepComponentUpdateMethod != null)
            {
                SendKeepComponentUpdateMethod(this, keep, LevelUp);
            }
        }
        ...
        {
            if (SendKeepComponentInteractMethod != null)
            {
                SendKeepComponentInteractMethod(this, component);
            }
        }
        ...
        {
            if (SendKeepComponentHookPointMethod != null)
            {
                SendKeepComponentHookPointMethod(this, component, selectedHookPointIndex);
            }
        }
        ...
        {
            if (SendClearKeepComponentHookPointMethod != null)
            {
                SendClearKeepComponentHookPointMethod(this, component, selectedHookPointIndex);
            }
        }
        ...
        {
            if (SendHookPointStoreMethod != null)
            {
                SendHookPointStoreMethod(this, hookPoint);
            }
        }
        ...
        {
            if (SendWarmapUpdateMethod != null)
            {
                SendWarmapUpdateMethod(this, list);
            }
        }
        ...
        {
            if (SendWarmapDetailUpdateMethod != null)
            {
                SendWarmapDetailUpdateMethod(this, fights, groups);
            }
        }
        ...
        {
            if (SendWarmapBonusesMethod != null)
            {
                SendWarmapBonusesMethod(this);
            }
        }
        ...
        {
            if (SendHouseMethod != null)
            {
                SendHouseMethod(this, house);
            }
        }
        ...
        {
            if (SendHouseOccupiedMethod != null)
            {
                SendHouseOccupiedMethod(this, house, flagHouseOccuped);
            }
        }
        ...
        {
            if (SendRemoveHouseMethod != null)
            {
                SendRemoveHouseMethod(this, house);
            }
        }
        ...
        {
            if (SendGardenMethod != null)
            {
                SendGardenMethod(this, house);
            }
        }
        ...
        {
            if (SendGardenIntMethod != null)
            {
                SendGardenIntMethod(this, house, i);
            }
        }
        ...
        {
            if (SendEnterHouseMethod != null)
            {
                SendEnterHouseMethod(this, house);
            }
        }
        ...
        {
            if (SendExitHouseMethod != null)
            {
                SendExitHouseMethod(this, house, unknown);
            }
        }
        ...
        {
            if (SendFurnitureMethod != null)
            {
                SendFurnitureMethod(this, house);
            }
        }
        ...
        {
            if (SendFurnitureIntMethod != null)
            {
                SendFurnitureIntMethod(this, house, i);
            }
        }
        ...
        {
            if (SendHousePayRentDialogMethod != null)
            {
                SendHousePayRentDialogMethod(this, title);
            }
        }
        ...
        {
            if (SendToggleHousePointsMethod != null)
            {
                SendToggleHousePointsMethod(this, house);
            }
        }
        ...
        {
            if (SendRentReminderMethod != null)
            {
                SendRentReminderMethod(this, house);
            }
        }
        ...
        {
            if (SendMarketExplorerWindowMethod != null)
            {
                SendMarketExplorerWindowMethod(this, items, page, maxpage);
            }
        }
        ...
        {
            if (SendMarketExplorerWindowMthod != null)
            {
                SendMarketExplorerWindowMthod(this);
            }
        }
        ...
        {
            if (SendConsignmentMerchantMoneyMethod != null)
            {
                SendConsignmentMerchantMoneyMethod(this, money);
            }
        }
        ...
        {
            if (SendHouseUsersPermissionsMethod != null)
            {
                SendHouseUsersPermissionsMethod(this, house);
            }
        }
        ...
        {
            if (SendStarterHelpMethod != null)
            {
                SendStarterHelpMethod(this);
            }
        }
        ...
        {
            if (SendPlayerFreeLevelUpdateMethod != null)
            {
                SendPlayerFreeLevelUpdateMethod(this);
            }
        }
        ...
        {
            if (SendMovingObjectCreateMethod != null)
            {
                SendMovingObjectCreateMethod(this, obj);
            }
        }
        ...
        {
            if (SendSetControlledHorseMethod != null)
            {
                SendSetControlledHorseMethod(this, player);
            }
        }
        ...
        {
            if (SendControlledHorseMethod != null)
            {
                SendControlledHorseMethod(this, player, flag);
            }
        }
        ...
        {
            if (CheckLengthHybridSkillsPacketMethod != null)
            {
                CheckLengthHybridSkillsPacketMethod(this, pak, maxSkills, first);
            }
        }
        ...
        {
            if (SendNonHybridSpellLinesMethod != null)
            {
                SendNonHybridSpellLinesMethod(this);
            }
        }
        ...
        {
            if (SendCrashMethod != null)
            {
                SendCrashMethod(this, str);
            }
        }
        ...
        {
            if (SendRegionColorSchemeMethod != null)
            {
                SendRegionColorSchemeMethod(this);
            }
        }
        ...
        {
            if (SendRegionColorSchemeByteMethod != null)
            {
                SendRegionColorSchemeByteMethod(this, color);
            }
        }
        ...
        {
            if (SendVampireEffectMethod != null)
            {
                SendVampireEffectMethod(this, living, show);
            }
        }
        ...
        {
            if (SendXFireInfoMethod != null)
            {
                SendXFireInfoMethod(this, flag);
            }
        }
        ...
        {
            if (SendMinotaurRelicMapRemoveMethod != null)
            {
                SendMinotaurRelicMapRemoveMethod(this, id);
            }
        }
        ...
        {
            if (SendMinotaurRelicMapUpdateMethod != null)
            {
                SendMinotaurRelicMapUpdateMethod(this, id, region, x, y, z);
            }
        }
        ...
        {
            if (SendMinotaurRelicWindowMethod != null)
            {
                SendMinotaurRelicWindowMethod(this, player, spell, flag);
            }
        }
        ...
        {
            if (SendMinotaurRelicBarUpdateMethod != null)
            {
                SendMinotaurRelicBarUpdateMethod(this, player, xp);
            }
        }
        ...
        {
            if (SendBlinkPanelMethod != null)
            {
                SendBlinkPanelMethod(this, flag);
            }
        }
