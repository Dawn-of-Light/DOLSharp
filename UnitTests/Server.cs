...
namespace DOL.Server.Tests
{
    public class ServerTests
    {
        ...
        protected GamePlayer CreateMockGamePlayer()
        {
            ...
            Account account = GameServer.Database.SelectObject<Account>(string.Empty);
            ...
            client.Version = GameClient.eClientVersion.Version1124;
            client.Socket = new Socket(AddressFamily.InterNetwork,SocketType.Stream,ProtocolType.Tcp);
            client.Account = account;
            client.PacketProcessor = new GS.PacketHandler.PacketProcessor(client);
            client.Out = new GS.PacketHandler.PacketLib1124(client);
