...
namespace DOL.GS.PacketHandler
{
	...
	public interface IPacketLib
	{
		...
		void SendRemoveObject(GameObject obj, eRemoveType type);
		void SendItemCreate(GameObject obj);
		...
		void SendNPCCreate(GameObject obj);
		void SendNPCUpdate(GameObject obj);
		...
		void SendInventorySlotsUpdate(byte preAction, ICollection slots);
		void SendDoorState(IDoor door);
		void SendMerchantWindow(IGameMerchant merchant);
