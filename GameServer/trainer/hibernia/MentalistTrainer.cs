...
namespace DOL.GS.Trainer
{
    ...
    public class MentalistTrainer : GameTrainer
    {
        ...
        private const string WeaponId1 = "mentalist_item";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            {
                player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "MentalistTrainer.Interact.Text2", Name, player.GetName(0, false)), eChatType.CT_Say, eChatLoc.CL_ChatWindow);
            }
            else
            {
                ...
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "MentalistTrainer.Interact.Text1", Name, player.GetName(0, false)), eChatType.CT_System, eChatLoc.CL_PopupWindow);
