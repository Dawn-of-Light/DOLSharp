...
namespace DOL.GS.Trainer
{
    ...
    public class BonedancerTrainer : GameTrainer
    {
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            {
                player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "BonedancerTrainer.Interact.Text2", Name), eChatType.CT_System, eChatLoc.CL_ChatWindow);
            }
            else
            {
                ...
                {
                    player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "BonedancerTrainer.Interact.Text1", Name), eChatType.CT_Say, eChatLoc.CL_PopupWindow);
