    ...
    public class MysticTrainer : GameTrainer
    {
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            if (player.CharacterClass.ID == (int)TrainedClass)
            {
                ...
                if (player.Level >= 5)
                {
                    player.Out.SendMessage(Name + " says, \"You must now seek your training elsewhere. Which path would you like to follow? [Runemaster] or [Spiritmaster]?\"", eChatType.CT_Say, eChatLoc.CL_PopupWindow);
                }
                else
                {
            ...
            switch (text) {
                case "Runemaster":
                    if (player.Race == (int)eRace.Frostalf || player.Race == (int)eRace.Kobold || player.Race == (int)eRace.Norseman || player.Race == (int)eRace.Dwarf) {
                        ...
                        player.Out.SendMessage(Name + " says, \"The path of a Runemaster is not available to your race. Please choose another.\"",eChatType.CT_Say,eChatLoc.CL_PopupWindow);
                    }
                ...
                case "Spiritmaster":
                    if (player.Race == (int)eRace.Kobold || player.Race == (int)eRace.Frostalf || player.Race == (int)eRace.Norseman) {
                        ...
                        player.Out.SendMessage(Name + " says, \"The path of a Spiritmaster is not available to your race. Please choose another.\"",eChatType.CT_Say,eChatLoc.CL_PopupWindow);
                    }
