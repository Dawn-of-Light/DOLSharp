...
namespace DOL.GS.Trainer
{
    ...
    public class RunemasterTrainer : GameTrainer
    {
        ...
        private const string WeaponId = "runemaster_item";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            else
            {
                ...
                {
                    player.Out.SendMessage(Name + " says, \"Do you desire to [join the House of Odin] and defend our realm as a Runemaster?\"",eChatType.CT_Say,eChatLoc.CL_PopupWindow);
