...
namespace DOL.GS.Trainer
{
    ...
    public class WarriorTrainer : GameTrainer
    {
        ...
        private const string WeaponId = "warrior_item";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            else
            {
                ...
                {
                    player.Out.SendMessage(Name + " says, \"Do you desire to [join the House of Tyr] and defend our realm as a Warrior?\"",eChatType.CT_Say,eChatLoc.CL_PopupWindow);
