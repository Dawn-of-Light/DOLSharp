...
namespace DOL.GS.Trainer
{
    ...
    public class ScoutTrainer : GameTrainer
    {
        ...
        private const string WeaponId1 = "scout_item";
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            else
            {
                ...
                {
                    player.Out.SendMessage(Name + " says, \"Do you desire to [join the Defenders of Albion] and defend our realm as a Scout?\"",eChatType.CT_Say,eChatLoc.CL_PopupWindow);
