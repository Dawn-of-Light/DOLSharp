...
namespace DOL.GS.Trainer
{
	...
	public class FighterTrainer : GameTrainer
	{
		...
		public override bool WhisperReceive(GameLiving source, string text)
		{
			...
			switch (text) {
				case "Armsman":
					if(player.Race == (int)eRace.Avalonian || player.Race == (int)eRace.Briton || player.Race == (int)eRace.HalfOgre || player.Race == (int)eRace.Highlander || player.Race == (int)eRace.Inconnu || player.Race == (int)eRace.Saracen || player.Race == (int)eRace.Korazh)
					{
