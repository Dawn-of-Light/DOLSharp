		...
		/// <returns></returns>
 		...
 		{		
			...
			else
			{
				...
				{
					player.Out.SendMessage(Name + " says, \"Do you desire to [join the Academy] and sing our song throughout Albion as a Minstrel?\"",eChatType.CT_Say,eChatLoc.CL_PopupWindow);
