...
namespace DOL.GS.Commands
{
	...
	public class PlayerCommandHandler : AbstractCommandHandler, ICommandHandler
	{
                ...
                case "name":
                    {
                        ...
                        var character = DOLDB<DOLCharacters>.SelectObject(DB.Column(nameof(DOLCharacters.Name)).IsEqualTo(args[2]));
		...
		private void Show_Info(GamePlayer player, GameClient client)
		{
			...
			text.Add("  - XPs/RPs/BPs : " + player.Experience + " xp, " + player.RealmPoints + " rp, " + player.Wallet.GetBalance(Currency.BountyPoints).Amount + " bp");
