...
namespace DOL.GS.Commands
{
    ...
    public class PlayerCommandHandler : AbstractCommandHandler, ICommandHandler
    {
                ...
                case "name":
                    {
                        ...
                        client.Out.SendMessage(
                            "You successfully changed this players name to " + player.Name + "!",
                                               eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                            ...
                            case "change":
                                {
                                    ...
                                    client.Out.SendMessage(
                                        "You successfully changed " + player.Name + "'s lastname to " + player.LastName + "!",
                                                           eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                    player.SaveIntoDatabase();
                                    break;
                                }
                ...
                case "level":
                    {
                        try
                        {
                            ...
                            {
                                client.Out.SendMessage(
                                    "You changed " + player.Name + "'s level successfully to " + newLevel + "!",
                                                       eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                player.Out.SendMessage(
                                ...
                                case "reset":
                                    {
                                        ...
                                        client.Out.SendMessage(
                                            "You changed " + player.Name + " back to his or her original model successfully!",
                                                               eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                        player.Out.SendMessage(
                                ...
                                default:
                                    {
                                        ...
                                        client.Out.SendMessage(
                                            "You successfully changed " + player.Name + "'s form! (ID:#" + modelID + ")",
                                                               eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                        player.Out.SendMessage(
                ...
                case "rps":
                    {
                        ...
                        try
                        {
                            ...
                            client.Out.SendMessage(
                                "You gave " + player.Name + " " + amount + " realmpoints succesfully!",
                                                   eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                            player.Out.SendMessage(
                ...
                case "xpa":
                    {
                        ...
                        try
                        {
                            ...
                            client.Out.SendMessage(
                                "You gave " + player.Name + " " + amount + " experience succesfully!",
                                                   eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                            player.Out.SendMessage(
                ...
                case "bps":
                    {
                        ...
                        try
                        {
                            ...
                            client.Out.SendMessage(
                                "You gave " + player.Name + " " + amount + " bountypoints succesfully!",
                                                   eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                            player.Out.SendMessage(
                        ...
                        try
                        {
                            ...
                            switch (args[2])
                            {
                                ...
                                case "dex":
                                    {
                                        ...
                                        player.Out.SendMessage(
                                            ...
                                            eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                        client.Out.SendMessage(
                                            "You gave " + player.Name + " " + value + " dexterity successfully!",
                                                               eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                    }
                                ...
                                case "str":
                                    {
                                        ...
                                        player.Out.SendMessage(
                                            ...
                                            eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                        client.Out.SendMessage(
                                            "You gave " + player.Name + " " + value + " strength successfully!",
                                                               eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                    }
                                ...
                                case "con":
                                    {
                                        ...
                                        client.Out.SendMessage(
                                            "You gave " + player.Name + " " + value + " constitution successfully!",
                                                               eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                    }
                                ...
                                case "emp":
                                    {
                                        ...
                                        player.Out.SendMessage(
                                            ...
                                            eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                        client.Out.SendMessage(
                                            "You gave " + player.Name + " " + value + " empathy successfully!",
                                                               eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                    }
                                ...
                                case "int":
                                    {
                                        ...
                                        client.Out.SendMessage(
                                            "You gave " + player.Name + " " + value + " intelligence successfully!",
                                                               eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                    }
                                ...
                                case "pie":
                                    {
                                        ...
                                        player.Out.SendMessage(
                                            ...
                                            eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                        client.Out.SendMessage(
                                            "You gave " + player.Name + " " + value + " piety successfully!",
                                                               eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                    }
                                ...
                                case "qui":
                                    {
                                        ...
                                        player.Out.SendMessage(
                                            ...
                                            eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                        client.Out.SendMessage(
                                            "You gave " + player.Name + " " + value + " quickness successfully!",
                                                               eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                    }
                                ...
                                case "cha":
                                    {
                                        ...
                                        player.Out.SendMessage(
                                            ...
                                            eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                        client.Out.SendMessage(
                                            "You gave " + player.Name + " " + value + " charisma successfully!",
                                                               eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                    }
                                ...
                                case "all":
                                    {
                                        ...
                                        client.Out.SendMessage(
                                            "You gave " + player.Name + " " + value + " to all stats successfully!",
                                                               eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                    }
                                ...
                                default:
                                    {
                                        client.Out.SendMessage(
                                            "Try using: dex, str, con, emp, int, pie, qui, cha, or all as a type of stat.",
                ...
                case "friend":
                    {
                        ...
                        if (fclient == null)
                        {
                            ...
                            if (player.GetFriends().Contains(name) && player.RemoveFriend(name))
                            {
                                ...
                                client.Out.SendMessage(
                                    "Removed " + name + " from " + player.Name + "'s friend list successfully!",
                                                       eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                return;
                            }
                            else
                        ...
                        switch (result)
                        {
                            ...
                            case 4: // guessed name
                                ...
                                else if (player.AddFriend(name))
                                {
                                    ...
                                    client.Out.SendMessage(
                                        "Added " + name + " to " + player.Name + "'s friend list successfully!",
                                                           eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                }
                            ...
                            case "line":
                                {
                                    ...
                                    client.Out.SendMessage(
                                        amount + " single respec given successfully to " + player.Name + "!",
                                                           eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                    break;
                                }
                            ...
                            case "all":
                                {
                                    ...
                                    client.Out.SendMessage(
                                        amount + " full respec given successfully to " + player.Name + "!",
                                                           eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                    break;
                                }
                            ...
                            case "realm":
                                {
                                    ...
                                    client.Out.SendMessage(
                                        amount + " realm respec given successfully to " + player.Name + "!",
                                                           eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                    break;
                                }
                            ...
                            case "dol":
                                {
                                    ...
                                    client.Out.SendMessage(
                                        amount + " DOL (full) respec given successfully to " + player.Name + "!",
                                                           eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                    break;
                                }
                            ...
                            case "champion":
                                {
                                    ...
                                    client.Out.SendMessage(
                                        amount + " champion respec given successfully to " + player.Name + "!",
                                                           eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                    break;
                                }
                ...
                case "rez":
                    {
                        ...
                        if (args.Length == 2 && player != null)
                        {
                            if (!player.IsAlive)
                            {
                                ...
                                player.Out.SendMessage(
                                    "You have been resurrected by " + client.Player.GetName(0, false) + "!",
                                                       eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                ...
                                case "albs":
                                    {
                                        foreach (GameClient aplayer in WorldMgr.GetClientsOfRealm(eRealm.Albion))
                                        {
                                            if (!aplayer.Player.IsAlive)
                                            {
                                                ...
                                                aplayer.Player.Out.SendMessage(
                                                    "You have been resurrected by " + client.Player.GetName(0, false) + "!",
                                                                               eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                ...
                                case "hibs":
                                    {
                                        foreach (GameClient hplayer in WorldMgr.GetClientsOfRealm(eRealm.Hibernia))
                                        {
                                            if (!hplayer.Player.IsAlive)
                                            {
                                                ...
                                                hplayer.Player.Out.SendMessage(
                                                    "You have been resurrected by " + client.Player.GetName(0, false) + "!",
                                                                               eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                ...
                                case "mids":
                                    {
                                        foreach (GameClient mplayer in WorldMgr.GetClientsOfRealm(eRealm.Midgard))
                                        {
                                            if (!mplayer.Player.IsAlive)
                                            {
                                                ...
                                                mplayer.Player.Out.SendMessage(
                                                    "You have been resurrected by " + client.Player.GetName(0, false) + "!",
                                                                               eChatType.CT_System, eChatLoc.CL_SystemWindow);
                                ...
                                case "all":
                                    {
                                        foreach (GameClient allplayer in WorldMgr.GetAllPlayingClients())
                                        {
                                            if (!allplayer.Player.IsAlive)
                                            {
                                                ...
                                                allplayer.Player.Out.SendMessage(
                                                    "You have been resurrected by " + client.Player.GetName(0, false) + "!",
                                                                                 eChatType.CT_System, eChatLoc.CL_SystemWindow);
                            ...
                            case "self":
                                {
                                    ...
                                    {
                                        client.Out.SendMessage(
                                            "You are already dead. Use /player rez <self> to resurrect yourself.",
                                                               eChatType.CT_Important, eChatLoc.CL_SystemWindow);
                                        return;
                                    }
                                    else
                            ...
                            case "guild":
                                {
                                    ...
                                    foreach (GameClient pname in WorldMgr.GetAllPlayingClients())
                                    {
                                        ...
                                        if (pname.Player.GuildName == guild && guild != string.Empty)
                                        {
                                            count++;
                ...
                case "inventory":
                    {
                        ...
                        if (args.Length == 2)
                        {
                            Show_Inventory(player, client, string.Empty);
                            return;
                        }
        ...
        private void Show_Info(GamePlayer player, GameClient client)
        {
            ...
            text.Add("  - Guild : " + player.GuildName + " " + (player.GuildRank != null ? "Rank: " + player.GuildRank.RankLevel.ToString() : string.Empty));
            ...
            text.Add("  - Craftingskill : " + player.CraftingPrimarySkill + string.Empty);
            text.Add("  - Money : " + Money.GetString(player.GetCurrentMoney()) + string.Empty);
            text.Add("  - Model ID : " + player.Model);
            text.Add("  - Region OID : " + player.ObjectID);
            text.Add("  - AFK Message: " + player.TempProperties.getProperty<string>(GamePlayer.AFK_MESSAGE) + string.Empty);
            text.Add(" ");
