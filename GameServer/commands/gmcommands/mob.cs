...
namespace DOL.GS.Commands
{
	[Cmd("&mob", //command to handle
		...
		"'/mob CreateRandomMultiple <number> [radius(50)]' to create multiple random mobs within radius",
	...
	public class MobCommandHandler : AbstractCommandHandler, ICommandHandler
	{
		...
		public void OnCommand(GameClient client, string[] args)
		{
			    ...
			    && targetMob == null)
			{
				...
				{
					client.Out.SendMessage("Cannot use " + client.Player.TargetObject + " for /mob command.", eChatType.CT_System,
			...
			switch (args[1])
			{
				case "create":
					...
					break;
				case "fastcreate":
					FastCreate(client, args);
					break;
				case "nfastcreate":
					FastCreateMultiple(client, args);
					break;
				case "CreateRandomMultiple":
					CreateRandomMultiple(client, args);
					break;
				case "Model":
					Model(client, targetMob, args);
					break;
				case "size":
					Size(client, targetMob, args);
					break;
				case "name":
					Name(client, targetMob, args);
					break;
				case "guild":
					Guild(client, targetMob, args);
					break;
				case "peace":
					Peace(client, targetMob, args);
					break;
				case "aggro":
					Aggro(client, targetMob, args);
					break;
				case "range":
					Range(client, targetMob, args);
					break;
				case "distance":
					Distance(client, targetMob, args);
					break;
				case "roaming":
					Roaming(client, targetMob, args);
					break;
				case "damagetype":
					DamageType(client, targetMob, args);
					break;
				case "movehere":
					MoveHere(client, targetMob, args);
					break;
				case "location":
					Location(client, targetMob, args);
					break;
				case "remove":
					Remove(client, targetMob, args);
					break;
				case "transparent": // deprecated, use "ghost"
				case "ghost":
					Ghost(client, targetMob, args);
					break;
				case "stealth":
					Stealth(client, targetMob, args);
					break;
				case "torch":
					Torch(client, targetMob, args);
					break;
				case "statue":
					Statue(client, targetMob, args);
					break;
				case "fly":
					Fly(client, targetMob, args);
					break;
				case "swimming":
					Swimming(client, targetMob, args);
					break;
				case "noname":
					NoName(client, targetMob, args);
					break;
				case "notarget":
					NoTarget(client, targetMob, args);
					break;
				case "kill":
					Kill(client, targetMob, args);
					break;
				case "flags":
					Flags(client, targetMob, args);
					break;
				case "regen": // deprecated, use "heal"
				case "heal":
					Heal(client, targetMob, args);
					break;
				case "attack":
					Attack(client, targetMob, args);
					break;
				case "info":
					Info(client, targetMob, args);
					break;
				case "stats":
					Stats(client, targetMob, args);
					break;
				case "realm":
					Realm(client, targetMob, args);
					break;
				case "speed":
					Speed(client, targetMob, args);
					break;
				case "level":
					Level(client, targetMob, args);
					break;
				case "levela":
					LevelAndAdjust(client, targetMob, args);
					break;
				case "brain":
					Brain(client, targetMob, args);
					break;
				case "respawn":
					Respawn(client, targetMob, args);
					break;
				case "questinfo":
					QuestInfo(client, targetMob, args);
					break;
				case "equipinfo":
					EquipInfo(client, targetMob, args);
					break;
				case "equiptemplate":
					EquipTemplate(client, targetMob, args);
					break;
				case "dropcount":
					DropCount(client, targetMob, args);
					break;
				case "addloot":
					AddLoot(client, targetMob, args);
					break;
				case "viewloot":
					ViewLoot(client, targetMob, args);
					break;
				case "removeloot":
					RemoveLoot(client, targetMob, args);
					break;
				case "refreshloot":
					RefreshLoot(client, targetMob, args);
					break;
				case "copy":
					Copy(client, targetMob, args);
					break;
				case "npctemplate":
					NPCTemplate(client, targetMob, args);
					break;
				case "class":
					SetClass(client, targetMob, args);
					break;
				case "path":
					Path(client, targetMob, args);
					break;
				case "house":
					House(client, targetMob, args);
					break;
				case "str":
				case "con":
				case "dex":
				...
				case "pie":
				case "cha":
					Stat(client, targetMob, args);
					break;
				case "tether":
					Tether(client, targetMob, args);
					break;
				case "hood":
					Hood(client, targetMob, args);
					break;
				case "cloak":
					Cloak(client, targetMob, args);
					break;
				case "bodytype":
					BodyType(client, targetMob, args);
					break;
				case "race":
					Race(client, targetMob, args);
					break;
				case "gender":
					Gender(client, targetMob, args);
					break;
				case "select":
					Select(AUTOSELECT_RADIUS, client);
					break;
				case "reload":
					Reload(client, targetMob, args);
					break;
				case "findname":
					FindName(client, args);
					break;
				default:
					DisplaySyntax(client);
					return;
		...
		private void Create(GameClient client, string[] args)
		{
			...
			//Create a new mob
			GameNPC mob = null;
			var asms = new ArrayList(ScriptMgr.Scripts);
			...
			if (mob == null)
			{
				client.Out.SendMessage("There was an error creating an instance of " + theType + "!", eChatType.CT_System,
				                       eChatLoc.CL_SystemWindow);
				return;
			}
			...
			client.Out.SendMessage(
				"The mob has been created with the peace flag, so it can't be attacked, to remove type /mob peace",
		...
		private void FastCreateMultiple(GameClient client, string[] args)
		{
			byte level = 1;
			ushort model = 408;
			byte realm = 0;
		...
		private void CreateRandomMultiple(GameClient client, string[] args)
		{
			ushort number = 1;
			ushort radius = 50;
		...
		private GameNPC FindOID(GameClient client, GameNPC targetMob, string[] args)
		{
			ushort mobOID;
			if (ushort.TryParse(args[3], out mobOID))
			{
				...
				if (obj == null)
				{
					client.Out.SendMessage("No object with OID: " + args[1] + " in current Region.", eChatType.CT_System,
					                       eChatLoc.CL_SystemWindow);
					return null;
				}
				else
				{
					...
					{
						client.Out.SendMessage("Object " + mobOID + " is a " + obj.GetType() + ", not a GameNPC.", eChatType.CT_System,
						                       eChatLoc.CL_SystemWindow);
						return null;
					}
				}
		...
		private static void Peace(GameClient client, GameNPC targetMob, string[] args)
		{
			targetMob.Flags ^= (uint) GameNPC.eFlags.PEACE;
			targetMob.SaveIntoDatabase();
			client.Out.SendMessage("Mob PEACE flag is set to " + ((targetMob.Flags & (uint) GameNPC.eFlags.PEACE) != 0),
		...
		private void Race(GameClient client, GameNPC targetMob, string[] args)
		{
			...
			if (!int.TryParse(args[2], out raceID))
			{
				...
				var npcRace = GameServer.Database.SelectObject<Race>("`Name` = '" + GameServer.Database.Escape(raceName) + "'");
		...
		private void Range(GameClient client, GameNPC targetMob, string[] args)
		{
			try
			{
				var aggroBrain = targetMob.Brain as IOldAggressiveBrain;
		...
		private void Distance(GameClient client, GameNPC targetMob, string[] args)
		{
			try
			{
				...
				targetMob.SaveIntoDatabase();
				client.Out.SendMessage("Mob max distance changed to: " + targetMob.MaxDistance, eChatType.CT_System,
				                       eChatLoc.CL_SystemWindow);
			}
			catch (Exception)
			{
		...
		private void Roaming(GameClient client, GameNPC targetMob, string[] args)
		{
			...
			try
			{
				...
				targetMob.SaveIntoDatabase();
				client.Out.SendMessage("Mob Roaming Range changed to: " + targetMob.RoamingRange, eChatType.CT_System,
				                       eChatLoc.CL_SystemWindow);
			}
			catch (Exception)
			{
		...
		private void DamageType(GameClient client, GameNPC targetMob, string[] args)
		{
			try
			{
				var damage = (eDamageType) Enum.Parse(typeof (eDamageType), args[2], true);
		...
		private static void MoveHere(GameClient client, GameNPC targetMob, string[] args)
		{
			targetMob.MoveTo(client.Player.CurrentRegionID, client.Player.X, client.Player.Y, client.Player.Z,
			                 client.Player.Heading);
			targetMob.SaveIntoDatabase();
			client.Out.SendMessage("Target Mob '" + targetMob.Name + "' moved to your location!", eChatType.CT_System,
			                       eChatLoc.CL_SystemWindow);
		}

		private static void Location(GameClient client, GameNPC targetMob, string[] args)
		{
		...
		private void Remove(GameClient client, GameNPC targetMob, string[] args)
		{
			...
			{
				var mobs = GameServer.Database.SelectObjects<Mob>("Name = '" + mobName + "'");

				if (mobs.Count == 0)
				{
					var deleteLootObjs = GameServer.Database.SelectObjects<DBMobXLootTemplate>("MobName = '" + mobName + "'");

					foreach (DBMobXLootTemplate o in deleteLootObjs)
						GameServer.Database.DeleteObject(o);

					var deleteTempObjs = GameServer.Database.SelectObjects<DBLootTemplate>("TemplateName = '" + mobName + "'");

					foreach (DBLootTemplate o in deleteTempObjs)
						GameServer.Database.DeleteObject(o);
		...
		private void Flags(GameClient client, GameNPC targetMob, string[] args)
		{
			...
			targetMob.SaveIntoDatabase();
			client.Out.SendMessage("Mob flags are set to " + targetMob.Flags, eChatType.CT_System, eChatLoc.CL_SystemWindow);
		}

		private static void Ghost(GameClient client, GameNPC targetMob, string[] args)
		{
			targetMob.Flags ^= (uint) GameNPC.eFlags.GHOST;
			targetMob.SaveIntoDatabase();
			client.Out.SendMessage("Mob GHOST flag is set to " + ((targetMob.Flags & (uint) GameNPC.eFlags.GHOST) != 0),
			                       eChatType.CT_System, eChatLoc.CL_SystemWindow);
		}

		private static void Stealth(GameClient client, GameNPC targetMob, string[] args)
		{
			targetMob.Flags ^= (uint) GameNPC.eFlags.STEALTH;
			targetMob.SaveIntoDatabase();
			client.Out.SendMessage("Mob STEALTH flag is set to " + ((targetMob.Flags & (uint) GameNPC.eFlags.STEALTH) != 0),
			                       eChatType.CT_System, eChatLoc.CL_SystemWindow);
		}

		private static void Torch(GameClient client, GameNPC targetMob, string[] args)
		{
			targetMob.Flags ^= (uint) GameNPC.eFlags.TORCH;
			targetMob.SaveIntoDatabase();
			client.Out.SendMessage("Mob TORCH flag is set to " + ((targetMob.Flags & (uint) GameNPC.eFlags.TORCH) != 0),
			                       eChatType.CT_System, eChatLoc.CL_SystemWindow);
		}

		private static void Statue(GameClient client, GameNPC targetMob, string[] args)
		{
			targetMob.Flags ^= (uint) GameNPC.eFlags.STATUE;
			targetMob.SaveIntoDatabase();

			if ((targetMob.Flags & (uint) GameNPC.eFlags.STATUE) > 0)
				client.Out.SendMessage("You have set the STATUE flag - you will need to use \"/debug on\" to target this NPC.",
				                       eChatType.CT_Important, eChatLoc.CL_SystemWindow);

			client.Out.SendMessage(
				targetMob.Name + "'s STATUE flag is set to " + ((targetMob.Flags & (uint) GameNPC.eFlags.STATUE) != 0),
				eChatType.CT_System, eChatLoc.CL_SystemWindow);
		}
		...
		private void Fly(GameClient client, GameNPC targetMob, string[] args)
		{
			...
			client.Out.SendMessage(
				targetMob.Name + "'s FLYING flag is set to " + ((targetMob.Flags & (uint) GameNPC.eFlags.FLYING) != 0),
				eChatType.CT_System, eChatLoc.CL_SystemWindow);
		}

		private static void NoName(GameClient client, GameNPC targetMob, string[] args)
		{
			targetMob.Flags ^= (uint) GameNPC.eFlags.DONTSHOWNAME;
			targetMob.SaveIntoDatabase();
			client.Out.SendMessage(
				"Mob DONTSHOWNAME flag is set to " + ((targetMob.Flags & (uint) GameNPC.eFlags.DONTSHOWNAME) != 0),
				eChatType.CT_System, eChatLoc.CL_SystemWindow);
		}

		private static void NoTarget(GameClient client, GameNPC targetMob, string[] args)
		{
			targetMob.Flags ^= (uint) GameNPC.eFlags.CANTTARGET;
			targetMob.SaveIntoDatabase();
			client.Out.SendMessage(
				"Mob CANTTARGET flag is set to " + ((targetMob.Flags & (uint) GameNPC.eFlags.CANTTARGET) != 0), eChatType.CT_System,
				eChatLoc.CL_SystemWindow);
		}

		private static void Kill(GameClient client, GameNPC targetMob, string[] args)
		{
			try
			{
		...
		private static void Heal(GameClient client, GameNPC targetMob, string[] args)
		{
			try
			{
				...
				client.Out.SendMessage(
					"Mob '" + targetMob.Name + "' healed (" + targetMob.Health + "/" + targetMob.MaxHealth + ")", eChatType.CT_System,
					eChatLoc.CL_SystemWindow);
			}
			catch (Exception e)
			{
		...
		private static void Attack(GameClient client, GameNPC targetMob, string[] args)
		{
		...
		private static void Info(GameClient client, GameNPC targetMob, string[] args)
		{
			...
			info.Add(" + Class: " + targetMob.GetType());
			...
			info.Add(" + " + targetMob.Strength + "  /  " + targetMob.Constitution + "  /  " + targetMob.Dexterity + "  /  " +
			         targetMob.Quickness);
			info.Add(" + INT  /  EMP  /  PIE  /  CHR");
			info.Add(" + " + targetMob.Intelligence + "  /  " + targetMob.Empathy + "  /  " + targetMob.Piety + "  /  " +
			         targetMob.Charisma);
			info.Add(" + Block / Parry / Evade %:  " + targetMob.BlockChance + " / " + targetMob.ParryChance + " / " +
			         targetMob.EvadeChance);
			...
			info.Add(string.Format(" + Flags: {0} (0x{1})", ((GameNPC.eFlags) targetMob.Flags).ToString("G"),
			                       targetMob.Flags.ToString("X")));
		...
		private static void Stats(GameClient client, GameNPC targetMob, string[] args)
		{
			if (targetMob == null)
			{
		...
		private void Realm(GameClient client, GameNPC targetMob, string[] args)
		{
			...
			try
			{
				...
				targetMob.SaveIntoDatabase();
				client.Out.SendMessage("Mob realm changed to: " + GlobalConstants.RealmToName(targetMob.Realm), eChatType.CT_System,
				                       eChatLoc.CL_SystemWindow);
			}
			catch (Exception)
			{
		...
		private void Speed(GameClient client, GameNPC targetMob, string[] args)
		{
			...
			try
			{
				...
				targetMob.SaveIntoDatabase();
				client.Out.SendMessage("Mob MaxSpeed changed to: " + targetMob.MaxSpeedBase, eChatType.CT_System,
				                       eChatLoc.CL_SystemWindow);
			}
			catch (Exception)
			{
		...
		private void LevelAndAdjust(GameClient client, GameNPC targetMob, string[] args)
		{
			byte level;
			...
			try
			{
				...
				targetMob.SaveIntoDatabase();
				client.Out.SendMessage("Mob level changed to: " + targetMob.Level + " and stats adjusted", eChatType.CT_System,
				                       eChatLoc.CL_SystemWindow);
			}
			catch (Exception)
			{
		...
		private void Brain(GameClient client, GameNPC targetMob, string[] args)
		{
			try
			{
				...
				if (brain == null)
				{
					client.Out.SendMessage("There was an error creating an instance of " + brainType + "!", eChatType.CT_System,
					                       eChatLoc.CL_SystemWindow);
				}
				else
				{
					...
					targetMob.SaveIntoDatabase();
					client.Out.SendMessage(targetMob.Name + "'s brain set to " + targetMob.Brain, eChatType.CT_System,
					                       eChatLoc.CL_SystemWindow);
				}
			}
			catch (Exception)
		...
		private static void QuestInfo(GameClient client, GameNPC targetMob, string[] args)
		{
		...
		private static void EquipInfo(GameClient client, GameNPC targetMob, string[] args)
		{
			if (targetMob.Inventory == null)
			{
			...
			{
				var t = (GameNpcInventoryTemplate) targetMob.Inventory;
				closed = t.IsClosed ? " (closed)" : " (open)";
			}

			string message = string.Format("			         Inventory: {0}{1}, equip template ID: {2}", targetMob.Inventory.GetType(),
			                               closed, targetMob.EquipmentTemplateID);
			...
			{
				client.Out.SendMessage("Slot Description : [" + GlobalConstants.SlotToName(item.SlotPosition) + "]",
				                       eChatType.CT_System, eChatLoc.CL_PopupWindow);
				client.Out.SendMessage("------------", eChatType.CT_System, eChatLoc.CL_PopupWindow);
				client.Out.SendMessage("         Slot: " + GlobalConstants.SlotToName(item.Item_Type), eChatType.CT_System,
		...
		private void EquipTemplate(GameClient client, GameNPC targetMob, string[] args)
		{
			...
			if (args[2].ToLower() == "create")
			{
				try
				{
					if (targetMob.Inventory != null)
					{
						client.Out.SendMessage("Target mob inventory is set to " + targetMob.Inventory.GetType() + ", remove it first.",
						                       eChatType.CT_System, eChatLoc.CL_SystemWindow);
						return;
					}
			...
			else if (args[2].ToLower() == "load")
			{
				if (args.Length > 3)
				{
					...
					{
						client.Out.SendMessage("Target mob is not using GameNpcInventoryTemplate.", eChatType.CT_System,
						                       eChatLoc.CL_SystemWindow);
						return;
					}
					try
					{
						var load = new GameNpcInventoryTemplate();

						if (!load.LoadFromDatabase(args[3]))
						{
							client.Out.SendMessage("Error loading equipment template \"" + args[3] + "\"", eChatType.CT_System,
							                       eChatLoc.CL_SystemWindow);
							return;
						}
			...
			var template = targetMob.Inventory as GameNpcInventoryTemplate;
			if (template == null)
			{
				client.Out.SendMessage("Target mob is not using GameNpcInventoryTemplate.", eChatType.CT_System,
				                       eChatLoc.CL_SystemWindow);
				...
				case "add":
					{
						if (args.Length >= 5)
						{
							try
							{
								...
								{
									client.Out.SendMessage("Couldn't add new item to slot " + slot + ". Template could be closed.",
									                       eChatType.CT_System, eChatLoc.CL_SystemWindow);
									return;
								}

								client.Out.SendMessage("Item added to the mob's inventory template.", eChatType.CT_System,
								                       eChatLoc.CL_SystemWindow);
							}
							catch
							{
				...
				case "remove":
					{
						if (args.Length > 3)
						{
							try
							{
								...
								{
									client.Out.SendMessage("Couldn't remove item from slot " + slot + ". Template could be closed.",
									                       eChatType.CT_System, eChatLoc.CL_SystemWindow);
									return;
								}
								client.Out.SendMessage("Mob inventory template slot " + slot + " cleaned!", eChatType.CT_System,
								                       eChatLoc.CL_SystemWindow);
							}
							catch
							{
				...
				case "save":
					{
						if (args.Length > 3)
						{
							...
							if (existingTemplates.Count > 0)
							{
								...
								{
									client.Out.SendMessage(
										"Template with name '" + args[3] +
										"' already exists. Use the 'replace' parameter if you want to overwrite it.", eChatType.CT_System,
										eChatLoc.CL_SystemWindow);
									return;
								}
							}
							...
							{
								client.Out.SendMessage("Error saving template with name " + args[3], eChatType.CT_System,
								                       eChatLoc.CL_SystemWindow);
								return;
							}
							...
							client.Out.SendMessage("Target mob equipment template is saved as '" + args[3] + "'", eChatType.CT_System,
							                       eChatLoc.CL_SystemWindow);
							return;
						}
						else
		...
		{
			var temp = GameServer.Database.SelectObject<DBMobXLootTemplate>(
				                                 "MobName = '" + GameServer.Database.Escape(targetMob.Name) + "'");
		...
		private void AddLoot(GameClient client, GameNPC targetMob, string[] args)
		{
			try
			{
				...
				var item = GameServer.Database.FindObjectByKey<ItemTemplate>(lootTemplateID);
				if (item == null)
				{
					DisplayMessage(client,
					               "You cannot add the " + lootTemplateID + " to the " + targetMob.Name +
				...
				var template = GameServer.Database.SelectObjects<DBLootTemplate>("TemplateName = '" + GameServer.Database.Escape(name) +
					                                                  "' AND ItemTemplateID = '" +
					                                                  GameServer.Database.Escape(lootTemplateID) + "'");
				if (template != null)
				{
				...
				{
					var itemtemplate = GameServer.Database.FindObjectByKey<ItemTemplate>(lootTemplateID);
				...
				var mxlt = GameServer.Database.SelectObject<DBMobXLootTemplate>("MobName = '" + targetMob.Name + "'");
				...
				client.Out.SendMessage(
					"The " + lootTemplateID + " was succesfully added to the " + name + " with a " + chance + "% chance to drop.",
					eChatType.CT_System, eChatLoc.CL_SystemWindow);
			}
			catch (Exception)
			{
		...
		private static void Swimming(GameClient client, GameNPC targetMob, string[] args)
		{
			targetMob.Flags ^= (uint) GameNPC.eFlags.SWIMMING;
			targetMob.SaveIntoDatabase();
			client.Out.SendMessage("Mob SWIMMING flag is set to " + ((targetMob.Flags & (uint) GameNPC.eFlags.SWIMMING) != 0),
			                       eChatType.CT_System, eChatLoc.CL_SystemWindow);
		}
		...
		private static void RemoveLoot(GameClient client, GameNPC targetMob, string[] args)
		{
			string lootTemplateID = args[2];
			string name = targetMob.Name;

			if (lootTemplateID.ToLower() == "all")
			{
				var template = GameServer.Database.SelectObjects<DBLootTemplate>("TemplateName = '" + GameServer.Database.Escape(name) + "'");
		...
		private static void RefreshLoot(GameClient client, GameNPC targetMob, string[] args)
		{
			LootMgr.RefreshTemplateGenerator(targetMob);
		}

		private void SetClass(GameClient client, GameNPC targetMob, string[] args)
		{
			if (args.Length < 3)
			{
				DisplaySyntax(client, args[1]);
			...
			if (mob == null)
			{
				client.Out.SendMessage("There was an error creating an instance of " + args[2] + ".", eChatType.CT_System,
				                       eChatLoc.CL_SystemWindow);
				return;
			}
			...
			if (brain == null)
			{
				client.Out.SendMessage("Cannot create brain, standard brain being applied", eChatType.CT_System,
				                       eChatLoc.CL_SystemWindow);
			...
			else
			{
				...
				var tsbrain = (StandardMobBrain) targetMob.Brain;
		...
		private static void Copy(GameClient client, GameNPC targetMob, string[] args)
		{
			GameNPC mob = null;
			...
			if (args.Length > 2)
			{
				...
				var dbMob = GameServer.Database.SelectObject<Mob>("Name = '" + mobName + "'");
			...
			else
			{
				...
				if (mob == null)
				{
					client.Out.SendMessage("There was an error creating an instance of " + targetMob.GetType().FullName + "!",
					                       eChatType.CT_System, eChatLoc.CL_SystemWindow);
					return;
				}
			}
		...
		private void NPCTemplate(GameClient client, GameNPC targetMob, string[] args)
		{
			...
			{
				NPCTemplateCreate(client, targetMob, args);
				return;
			}
		...
		private void NPCTemplateCreate(GameClient client, GameNPC targetMob, string[] args)
		{
			if (args.Length < 4)
			{
				DisplaySyntax(client, args[1], args[2]);
			...
			try
			{
				...
				switch (statType)
				{
					...
					case "CON":
						...
						break;
					case "DEX":
						targetMob.Dexterity = statval;
						break;
					case "QUI":
						targetMob.Quickness = statval;
						break;
					case "INT":
						targetMob.Intelligence = statval;
						break;
					case "EMP":
						targetMob.Empathy = statval;
						break;
					case "PIE":
						targetMob.Piety = statval;
						break;
					case "CHA":
						targetMob.Charisma = statval;
						break;
				}
				...
				if (targetMob.LoadedFromScript)
				{
					...
					client.Out.SendMessage("This mob is loaded from a script - stat changes cannot be saved.", eChatType.CT_System,
					                       eChatLoc.CL_SystemWindow);
				}
			}
			catch (Exception)
		...
		private void Tether(GameClient client, GameNPC targetMob, string[] args)
		{
			try
			{
				...
				client.Out.SendMessage(
					"Keep in mind that this setting is volatile, it needs to be set in this NPC's template to become permanent.",
					eChatType.CT_System, eChatLoc.CL_SystemWindow);
			}
			catch (Exception)
			{
		...
		private static void Hood(GameClient client, GameNPC targetMob, string[] args)
		{
			targetMob.IsCloakHoodUp ^= true;
			targetMob.UpdateNPCEquipmentAppearance();
			targetMob.SaveIntoDatabase();
			client.Out.SendMessage("Mob IsCloakHoodUp flag is set to " + targetMob.IsCloakHoodUp, eChatType.CT_System,
			                       eChatLoc.CL_SystemWindow);
		}

		private static void Cloak(GameClient client, GameNPC targetMob, string[] args)
		{
			targetMob.IsCloakInvisible ^= true;
			targetMob.UpdateNPCEquipmentAppearance();
			targetMob.SaveIntoDatabase();
			client.Out.SendMessage("Mob IsCloakInvisible flag is set to " + targetMob.IsCloakHoodUp, eChatType.CT_System,
			                       eChatLoc.CL_SystemWindow);
		}
		...
		private void BodyType(GameClient client, GameNPC targetMob, string[] args)
		{
			...
			if (args.Length > 2 && int.TryParse(args[2], out type))
			{
				...
				targetMob.SaveIntoDatabase();
				client.Out.SendMessage("Mob BodyType changed to " + targetMob.BodyType, eChatType.CT_System,
				                       eChatLoc.CL_SystemWindow);
			}
			else
			{
		...
		{
			if (name.Length > 47)
				client.Out.SendMessage("WARNING: name length=" + name.Length + " but only first 47 chars will be shown.",
				                       eChatType.CT_System, eChatLoc.CL_SystemWindow);
			return name;
		}
		...
		{
			if (name.Length > 47)
				client.Out.SendMessage("WARNING: guild name length=" + name.Length + " but only first 47 chars will be shown.",
				                       eChatType.CT_System, eChatLoc.CL_SystemWindow);
			return name;
		}

		private static GameNPC Select(ushort range, GameClient client)
		{
			...
			foreach (GameNPC wantedMob in client.Player.GetNPCsInRadius(range))
			{
				if (wantedMob == null)
				{
					client.Out.SendMessage("Unable to autoselect an NPC - nothing in range", eChatType.CT_System,
					                       eChatLoc.CL_SystemWindow);
				}
				else
				{
					client.Out.SendMessage("You have autoselected the mob with OID " + wantedMob.ObjectID, eChatType.CT_System,
					                       eChatLoc.CL_SystemWindow);
					client.Out.SendChangeTarget(wantedMob);
				}
				return wantedMob;
			}
			return null;
		...
		private static void Reload(GameClient client, GameNPC targetMob, string[] args)
		{
			var mobs = new ArrayList();
		...
		private static void FindName(GameClient client, string[] args)
		{
			if (args.Length < 3)
				return;
			...
			var mobs = GameServer.Database.SelectObjects<Mob>("name like '%" + GameServer.Database.Escape(args[2]) +
				                                       "%' order by level desc limit " + maxreturn);
