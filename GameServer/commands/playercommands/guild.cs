                    ...
                    case "removeaccount":
                        {
                            ...
                            if (chs.Count > 0)
                            {
                                ...
                                {
                                    plys += (plys != string.Empty ? "," : string.Empty) + ch.Name;
                    ...
                    case "who":
                        {
                            ...
                            if (args.Length == 6 && args[2] == "window")
                            {
                                ...
                                if (int.TryParse(args[3], out sortTemp) && int.TryParse(args[4], out page) && byte.TryParse(args[5], out showTemp) && sortTemp >= -7 && sortTemp <= 7)
                                {
                            ...
                            {
                                client.Out.SendMessage("total member online:        " + ind.ToString(), eChatType.CT_Guild, eChatLoc.CL_SystemWindow);
                            }
