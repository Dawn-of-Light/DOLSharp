...
namespace DOL.GS.Commands
{
	...
	public class GuildCommandHandler : AbstractCommandHandler, ICommandHandler
	{
		...
		public static bool IsValidGuildName(string guildName)
		{
			...
			guildName = guildName.Replace("ƒ", "A");
			guildName = guildName.Replace("÷", "O");
			guildName = guildName.Replace("‹", "U");
			guildName = guildName.Replace("‰", "a");
			guildName = guildName.Replace("ˆ", "o");
			guildName = guildName.Replace("¸", "u");
			guildName = guildName.Replace("·", "a");
			guildName = guildName.Replace("È", "e");
			guildName = guildName.Replace("Ì", "i");
			guildName = guildName.Replace("Û", "o");
			guildName = guildName.Replace("˙", "u");
			guildName = guildName.Replace("¡", "A");
			guildName = guildName.Replace("…", "E");
			guildName = guildName.Replace("Õ", "I");
			guildName = guildName.Replace("”", "O");
			guildName = guildName.Replace("⁄", "U");
