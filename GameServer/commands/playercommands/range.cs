    ...
    public class RangeCommandHandler : AbstractCommandHandler, ICommandHandler
    {
        public void OnCommand(GameClient client, string[] args)
        {
            ...
            else if (living == null || (living != null && client.Account.PrivLevel > 1))
            {
                ...
                DisplayMessage(client, LanguageMgr.GetTranslation(client.Account.Language, "Scripts.Players.Range.Result", range, client.Player.TargetInView ? string.Empty : LanguageMgr.GetTranslation(client.Account.Language, "Scripts.Players.Range.NotVisible")));
            }
            else
            {
