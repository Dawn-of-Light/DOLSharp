...
{
    [Cmd("&bang", ePrivLevel.Player, "Bang on your shield", "/bang")]
	[Cmd("&beckon", ePrivLevel.Player, "Makes a beckoning gesture with character's hand", "/beckon")]
	[Cmd("&beg", ePrivLevel.Player, "Plea for items or money", "/beg")]
	[Cmd("&blush", ePrivLevel.Player, "Act in a shy manner", "/blush")]
	[Cmd("&bow", ePrivLevel.Player, "Give an honorable bow", "/bow")]
	[Cmd("&charge", ePrivLevel.Player, "Onward!", "/charge")]
	[Cmd("&cheer", ePrivLevel.Player, "Cheer with both hands in the air", "/cheer")]
	[Cmd("&clap", ePrivLevel.Player, "Make a clapping gesture", "/clap")]
	[Cmd("&cry", ePrivLevel.Player, "Sob pathetically", "/cry")]
	[Cmd("&curtsey", ePrivLevel.Player, "Give a low curtsey", "/curtsey")]
	[Cmd("&dance", ePrivLevel.Player, "Dance a little jig", "/dance")]
	[Cmd("&dismiss", ePrivLevel.Player, "Make a dismissing gesture", "/dismiss")]
	[Cmd("&flex", ePrivLevel.Player, "Makes a flexing gesture", "/flex")]
	[Cmd("&hug", ePrivLevel.Player, "Makes a hugging gesture", "/hug")]
	[Cmd("&induct", ePrivLevel.Player, "Make a ceremonial induction gesture", "/induct")]
	[Cmd("&kiss", ePrivLevel.Player, "Blow a kiss", "/kiss")]
	[Cmd("&laugh", ePrivLevel.Player, "Makes a laughing gesture", "/bang")]
	[Cmd("&military", ePrivLevel.Player, "A military salute", "/military")]
	[Cmd("&no", ePrivLevel.Player, "Shake your head", "/no")]
	[Cmd("&point", ePrivLevel.Player, "Points to something in front of you", "/point")]
	[Cmd("&ponder", ePrivLevel.Player, "For when you just want to go \"hmmmmmmm\"", "/ponder")]
	[Cmd("&present", ePrivLevel.Player, "To present someone with something", "/present")]
	[Cmd("&raise", ePrivLevel.Player, "Raise your hand, as in volunteering or getting attention", "/raise")]
	[Cmd("&rude", ePrivLevel.Player, "A rude gesture", "/rude")]
	[Cmd("&salute", ePrivLevel.Player, "Makes a stiff salute", "/salute")]
	[Cmd("&shrug", ePrivLevel.Player, "Shrug your shoulders", "/shrug")]
	[Cmd("&slap", ePrivLevel.Player, "Slap someone", "/slap")]
	[Cmd("&slit", ePrivLevel.Player, "Let your enemy know what you want to do to him", "/slit")]
	[Cmd("&surrender", ePrivLevel.Player, "I give up!", "/surrender")]
	[Cmd("&taunt", ePrivLevel.Player, "A very mean gesture when you really want to insult someone", "/taunt")]
	[Cmd("&victory", ePrivLevel.Player, "Make a victory cheer", "/victory")]
	[Cmd("&wave", ePrivLevel.Player, "Makes a waving gesture", "/wave")]
	[Cmd("&yes", ePrivLevel.Player, "Nod your head", "/yes")]
	//New
	[Cmd("&sweat", ePrivLevel.Player, "sweat", "/sweat")]
	[Cmd("&stagger", ePrivLevel.Player, "stagger", "/stagger")]
	[Cmd("&yawn", ePrivLevel.Player, "yawn", "/yawn")]
	[Cmd("&doh", ePrivLevel.Player, "doh", "/doh")]
	[Cmd("&confuse", ePrivLevel.Player, "Confused", "/confuse")]
	[Cmd("&shiver", ePrivLevel.Player, "shiver", "/shiver")]
	[Cmd("&rofl", ePrivLevel.Player, "rofl", "/rofl")]
	[Cmd("&mememe", ePrivLevel.Player, "mememe", "/mememe")]
	[Cmd("&worship", ePrivLevel.Player, "worship", "/worship")]
	[Cmd("&drink", ePrivLevel.Player, "drink", "/drink")]
	[Cmd("&angry", ePrivLevel.Player, "Look angrily around", "/angry")]
	[Cmd("&lookfar", ePrivLevel.Player, "Lets you look into the distance", "/lookfar")]
	[Cmd("&smile", ePrivLevel.Player, "Make a big smile", "/smile")]
	[Cmd("&stench", ePrivLevel.Player, "Wave away the local stench", "/stench")]
