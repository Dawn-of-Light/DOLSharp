...
{
	/// <summary>
	/// This class represents an inventory item for a player
	/// </summary>
	public class PlayerInventoryItem : InventoryItem, IPlayerInventoryItem
	{
		...
		public PlayerInventoryItem(ItemTemplate template)
			: base(template)
		{
		}

		public PlayerInventoryItem(ItemUnique template)
			: base(template)
		{
		}

		public PlayerInventoryItem(InventoryItem item)
			: base(item)
		{
