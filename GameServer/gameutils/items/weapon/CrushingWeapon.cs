...
{
	/// <summary>
	/// Summary description for a CrushingWeapon
	/// </summary> 
	public class CrushingWeapon : Weapon
	{
		/// <summary>
		...
		public override eDamageType DamageType 
		{
			get
			{
				// CrushingWeapon can make damage of type : 
		...
		{
			get	// CrushingWeapon can only be right or left hand
			{
		...
		{
			get { return eObjectType.CrushingWeapon; }
		}
	}
}
