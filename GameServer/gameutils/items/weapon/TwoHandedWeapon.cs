...
{
	/// <summary>
	/// Summary description for a TwoHandedWeapon
	/// </summary> 
	public class TwoHandedWeapon : Weapon
	{
		...
		public override eDamageType DamageType 
		{
			get
			{
				// TwoHandedWeapon can make damage of type : 
		...
		{
			// TwoHandedWeapon can only be two hand
		...
		{
			get { return eObjectType.TwoHandedWeapon; }
		}
	}
}
