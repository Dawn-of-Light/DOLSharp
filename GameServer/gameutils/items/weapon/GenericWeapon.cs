...
{
	/// <summary>
	/// Summary description for a Generic Weapon
	/// </summary> 
	public class GenericWeapon : Weapon
	{
		...
		public override eInventorySlot[] EquipableSlot 
		{
			get
			{
				return new eInventorySlot[] {eInventorySlot.RightHandWeapon, eInventorySlot.LeftHandWeapon, eInventorySlot.TwoHandWeapon, eInventorySlot.DistanceWeapon };
			}
		}
		...
		{
			get { return eObjectType.GenericWeapon; }
		}
	}
}
