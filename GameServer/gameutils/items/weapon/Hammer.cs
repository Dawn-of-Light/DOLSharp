...
{
	/// <summary>
	/// Summary description for a Hammer
	/// </summary> 
	public class Hammer : Weapon
	{
		...
		public override eDamageType DamageType 
		{
			get
			{
				// Hammer can make damage of type : 
		...
		{
			get	// Hammer can only be right and two hand (no left hand hammer)
			{
