...
namespace DOL.GS
{
    ...
    /// </summary> 
    public abstract class MagicalStackableItem: StackableItem
    {
        #region declaration
        /// <summary>
        ...
        {
            MagicalStackableItem magicalItem = item as MagicalStackableItem;
            if (magicalItem == null) return false;

            return ( base.CanStackWith(item)
                && SpellID == magicalItem.SpellID);
        }
    }
}
