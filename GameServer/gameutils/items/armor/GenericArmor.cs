...
namespace DOL.GS
{
	...
	/// </summary> 
	public class GenericArmor : Armor
	{
		/// <summary>
		...
		{
			get { return new eInventorySlot[] {eInventorySlot.ArmsArmor, eInventorySlot.LegsArmor, eInventorySlot.FeetArmor, eInventorySlot.HandsArmor, eInventorySlot.TorsoArmor, eInventorySlot.HeadArmor}; }
		}
		...
		{
			get { return eObjectType.GenericArmor; }
		}
	}
}
