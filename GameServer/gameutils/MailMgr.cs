        ...
        public static bool Init()
        {
            ...
            try
            {
                if (file.Exists)
                {
                    ...
                    if (m_enable)
                    {
                        m_username = xmlConfig["Username"].GetString(string.Empty);
                        m_password = xmlConfig["Password"].GetString(string.Empty);
                        m_emailAddress = xmlConfig["EmailAddress"].GetString(string.Empty);
                        m_smtpServer = xmlConfig["SMTPServer"].GetString(string.Empty);
                ...
                else
                {
                    ...
                    xmlConfig["Username"].Set(string.Empty);
                    xmlConfig["Password"].Set(string.Empty);
                    xmlConfig["EmailAddress"].Set(string.Empty);
                    xmlConfig["SMTPServer"].Set(string.Empty);
