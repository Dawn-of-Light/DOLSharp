...
namespace DOL.GS
{
	...
	public class SinglePermission
	{
		...
		{
			DataObject obj = GameServer.Database.SelectObject(typeof(DBSinglePermission), "Command = '" + GameServer.Database.Escape(command) + "' and PlayerID = '" + player.PlayerCharacter.ObjectId + "'");
			if (obj == null)
				return false;
			return true;
		}
