...
{
	/// <summary>
	/// Summary description for a TravelTicketTemplate
	/// </summary> 
	public class TravelTicketTemplate : GenericItemTemplate
	{
		#region Declaraction
		/// <summary>
		/// The pathID used by the object
		/// </summary>
		protected int m_tripPathID;

		#endregion

		#region Get and Set
		/// <summary>
		/// Gets or sets the pathId used by this template
		/// </summary>
		...
		{
			TravelTicket item = new TravelTicket();
			item.Name = m_name;
			item.Level = m_level;
