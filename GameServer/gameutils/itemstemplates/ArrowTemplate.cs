...
{
	/// <summary>
	/// Summary description for a ArrowTemplate
	/// </summary> 
	public class ArrowTemplate : AmmunitionTemplate
	{
		/// <summary>
		...
		{
			get { return eObjectType.Arrow; }
		}

		/// <summary>
		/// Create a object usable by players using this template (a stack of 20 arrows)
		/// </summary>
