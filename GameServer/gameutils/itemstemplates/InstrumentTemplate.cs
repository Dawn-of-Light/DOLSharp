...
namespace DOL.GS
{
	...
	/// <summary>
	/// Summary description for a InstrumentTemplate
	/// </summary> 
	public class InstrumentTemplate : VisibleEquipmentTemplate
	{
		#region Declaraction
		/// <summary>
		/// The type of instrument
		/// </summary>
		protected eInstrumentType m_type;

		#endregion

		#region Get and Set
		/// <summary>
		/// Gets or sets the instrument type of this template
		/// </summary>
