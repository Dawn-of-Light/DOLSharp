...
{
	/// <summary>
	/// Summary description for a MagicalDustTemplate
	/// </summary> 
	public class MagicalDustTemplate : GenericItemTemplate
	{
		#region Declaraction
		/// <summary>
		/// The bonus percent of this template
		/// </summary>
		...
		#region Get and Set
		/// <summary>
		/// Gets or sets the bonus percent of this template
		/// </summary>
		public byte Bonus
		{
			get { return m_bonus; }
		...
		{
			MagicalDust item = new MagicalDust();
			item.Name = m_name;
			item.Level = m_level;
