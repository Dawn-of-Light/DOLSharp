...
{
	/// <summary>
	/// Summary description for a ReactiveTinctureTemplate
	/// </summary> 
	public class ReactiveTinctureTemplate : AlchemieTinctureTemplate
	{
		/// <summary>
		...
		{
			ReactiveTincture item = new ReactiveTincture();
			item.Name = m_name;
			item.Level = m_level;
