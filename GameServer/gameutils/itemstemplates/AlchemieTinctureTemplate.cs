...
{
	/// <summary>
	/// Summary description for a AlchemieTinctureTemplate
	/// </summary> 
	public abstract class AlchemieTinctureTemplate : GenericItemTemplate
	{
		#region Declaraction
		/// <summary>
					...
					if (spells != null)
					{
						foreach(Spell spl in spells)
						{
							if(spl.ID == SpellID)
							{
								...
								ISpellHandler spellHandler = ScriptMgr.CreateSpellHandler(player, spl, spellLine);
