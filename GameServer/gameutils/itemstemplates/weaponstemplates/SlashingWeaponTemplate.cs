...
{
	/// <summary>
	/// Summary description for a SlashingWeaponTemplate
	/// </summary> 
	public class SlashingWeaponTemplate : WeaponTemplate
	{
		/// <summary>
		...
		{
			get { return eObjectType.SlashingWeapon; }
		}
		...
		{
			SlashingWeapon item = new  SlashingWeapon();
			item.Name = m_name;
			item.Level = m_level;
