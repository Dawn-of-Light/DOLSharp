...
{
	/// <summary>
	/// Summary description for a CompositebowTemplate
	/// </summary> 
	public class CompositebowTemplate : RangedWeaponTemplate
	{
		/// <summary>
		...
		{
			get { return eObjectType.CompositeBow; }
		}
		...
		{
			Compositebow item = new Compositebow();
			item.Name = m_name;
			item.Level = m_level;
