...
{
	/// <summary>
	/// Summary description for a RecurvedbowTemplate
	/// </summary> 
	public class RecurvedbowTemplate : RangedWeaponTemplate
	{
		/// <summary>
		...
		{
			get { return eObjectType.RecurvedBow; }
		}
		...
		{
			Recurvedbow item = new Recurvedbow();
			item.Name = m_name;
			item.Level = m_level;
