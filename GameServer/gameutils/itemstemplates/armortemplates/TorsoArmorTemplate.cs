...
{
	/// <summary>
	/// Summary description for a TorsoArmorTemplate
	/// </summary> 
	public class TorsoArmorTemplate : ArmorTemplate
	{
		/// <summary>
		...
		{
			TorsoArmor item = new TorsoArmor();
			item.Name = m_name;
			item.Level = m_level;
			...
			item.Color = m_color;
			item.ArmorFactor = m_armorFactor;
			item.ArmorLevel = m_armorLevel;
			item.ModelExtension = m_modelExtension;
			return item;
		}
	}
}	