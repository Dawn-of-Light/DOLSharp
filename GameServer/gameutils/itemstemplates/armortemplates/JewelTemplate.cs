...
{
	/// <summary>
	/// Summary description for a JewelleryTemplate
	/// </summary> 
	public class JewelTemplate : EquipableItemTemplate
	{
		/// <summary>
		...
		public override GenericItem CreateInstance()
		{
			...
			item.AllowedClass = AllowedClass;
			item.MagicalBonus = MagicalBonus;
