...
//			GameNPC npc = (GameNPC)WorldMgr.GetObjectTypeByIDFromRegion(client.Player.CurrentRegionID, id, typeof(GameNPC));
			Region region = client.Player.Region;
			if (region == null) return 1;
			GameObject obj = region.GetObject(id) as GameObject;

			if(obj != null)
			{
				client.Out.SendNPCCreate(obj);

				GameNPC npcObj = obj as GameNPC;
				if(npcObj != null && npcObj.Inventory != null)
					client.Out.SendLivingEquipementUpdate(npcObj);
