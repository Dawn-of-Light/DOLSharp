...
namespace DOL.GS.PacketHandler
{
	...
	public class PacketLib1112 : PacketLib1111
	{
		...
		/*public void SendUpdatePlayerPosition(GamePlayer source)
		{
			using (GSUDPPacketOut outpak = new GSUDPPacketOut(m_gameClient.Out.GetPacketCode(eServerPackets.PlayerPosition)))
			{
				outpak.WriteShort((ushort)source.Client.SessionID);
				ushort status = (ushort)Math.Abs(source.CurrentSpeed);
				...
				{
					outpak1112.WriteByte((con168.Length == 22) ? con168[21] : (byte)0);
					*//*if (player.Name == "Adam")
						log.Error(client.Player.Name + " = " + con168[21]);*//*
				}
