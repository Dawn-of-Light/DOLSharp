            ...
            switch (text.ToLower())
            {
                case "tales of battle":
                    string reply = string.Format(
                        "Oh, how I wish I could leave the lands of Atlantis at will as you do. {0} {1}",
                ...
                case "leave":
                    reply = string.Format(
                        "I'd even join you in your war if I could, {0} {1} {2}",
                ...
                case "knowledge":
                    reply = string.Format(
                        "Indeed, that is all I am now: a living tome of knowledge, {0} {1}",
