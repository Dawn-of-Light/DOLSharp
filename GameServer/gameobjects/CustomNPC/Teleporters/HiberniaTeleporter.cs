    ...
    public class HiberniaTeleporter : GameTeleporter
    {
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            string intro = string.Format(
                "Greetings. I can channel the energies of this place to send you {0} {1} {2} {3} {4} {5} {6}",
        ...
        protected override void OnSubSelectionPicked(GamePlayer player, Teleport subSelection)
        {
            switch (subSelection.TeleportID.ToLower())
            {
                case "shrouded isles":
                    {
                        string reply = string.Format(
                            "The isles of Hy Brasil are an excellent choice. {0} {1}",
                ...
                case "housing":
                    {
                        string reply = string.Format(
                            "I can send you to your [personal] house. If you do {0} {1} {2} {3}",
