...
namespace DOL.GS
{
    ...
    public class GamePlayer : GameLiving
    {
        ...
        public string ObjectId
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.ObjectId = value;
                }
            }
        }
        ...
        public bool ShowGuildLogins
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.ShowGuildLogins = value;
                }
            }
        }
        ...
        public string[] SerializedFriendsList
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.SerializedFriendsList = string.Join(",", value.Select(name => name.Trim()).Where(name => !string.IsNullOrEmpty(name)));
                }
            }
        }
        ...
        public byte NotDisplayedInHerald
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.NotDisplayedInHerald = value;
                }
            }
        }
        ...
        public int LastFreeLevel
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.LastFreeLevel = value;
                }
            }
        }
        ...
        public DateTime LastFreeLeveled
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.LastFreeLeveled = value;
                }
            }
        }
        ...
        public string[] SerializedIgnoreList
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.SerializedIgnoreList = string.Join(",", value.Select(name => name.Trim()).Where(name => !string.IsNullOrEmpty(name)));
                }
            }
        }
        ...
        public bool UsedLevelCommand
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.UsedLevelCommand = value;
                }
            }
        }
        ...
        public int BindHouseRegion
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.BindHouseRegion = value;
                }
            }
        }
        ...
        public int BindHouseXpos
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.BindHouseXpos = value;
                }
            }
        }
        ...
        public int BindHouseYpos
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.BindHouseYpos = value;
                }
            }
        }
        ...
        public int BindHouseZpos
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.BindHouseZpos = value;
                }
            }
        }
        ...
        public int BindHouseHeading
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.BindHouseHeading = value;
                }
            }
        }
        ...
        public byte CustomisationStep
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.CustomisationStep = value;
                }
            }
        }
        ...
        public bool IgnoreStatistics
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.IgnoreStatistics = value;
                }
            }
        }
        ...
        public bool ShowXFireInfo
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.ShowXFireInfo = value;
                }
            }
        }
        ...
        public virtual bool Quit(bool forced)
        {
            ...
            else
            {
                ...
                // log quit
                AuditMgr.AddAuditEntry(Client, AuditType.Character, AuditSubtype.CharacterLogout, string.Empty, Name);
        ...
        public int TotalConstitutionLostAtDeath
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.ConLostAtDeath = value;
                }
            }
        }
        ...
        public override void StartHealthRegeneration()
        {
            ...
            if (m_healthRegenerationTimer.IsAlive)
            {
                return;
            }
        ...
        public override void StartPowerRegeneration()
        {
            ...
            if (m_powerRegenerationTimer.IsAlive)
            {
                return;
            }
        ...
        public override void StartEnduranceRegeneration()
        {
            ...
            if (m_enduRegenerationTimer.IsAlive)
            {
                return;
            }
            ...
            if (fallDamagePercent > 0)
            {
                ...
                if (mythSafeFall > 0 & mythSafeFall < fallDamagePercent)
                {
                    Client.Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language, "PlayerPositionUpdateHandler.MythSafeFall"),
                                           eChatType.CT_Damaged, eChatLoc.CL_SystemWindow);
                    fallDamagePercent = mythSafeFall;
                    Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language, "PlayerPositionUpdateHandler.FallPercent", fallDamagePercent),
                                    eChatType.CT_Damaged, eChatLoc.CL_SystemWindow);
                }
                ...
                {
                    Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language, "PlayerPositionUpdateHandler.SafeFall"),
                                    eChatType.CT_Damaged, eChatLoc.CL_SystemWindow);
                }
        ...
        public virtual int RespecAmountAllSkill
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.RespecAmountAllSkill = value;
                }
            }
        }
        ...
        public virtual int RespecAmountSingleSkill
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.RespecAmountSingleSkill = value;
                }
            }
        }
        ...
        public virtual int RespecAmountRealmSkill
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.RespecAmountRealmSkill = value;
                }
            }
        }
        ...
        public virtual int RespecAmountDOL
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.RespecAmountDOL = value;
                }
            }
        }
        ...
        public virtual bool IsLevelRespecUsed
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.IsLevelRespecUsed = value;
                }
            }
        }
        ...
        public virtual int RespecBought
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.RespecBought = value;
                }
            }
        }
                        ...
                        if (Style.eOpening.Offensive == style.OpeningRequirementType)
                        {
                            switch (style.AttackResultRequirement)
                            {
                                ...
                                case Style.eAttackResultRequirement.Hit: // TODO: make own message for hit after styles DB is updated
                                    ...
                                    {
                                        message = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.RefreshSpec.AfterStyle", reqStyle.Name);
                                    }
        ...
        public virtual long BountyPoints
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.BountyPoints = value;
                }
            }
        }
        ...
        public virtual void GainRealmPoints(long amount, bool modify, bool sendMessage, bool notify)
        {
            ...
            if (modify)
            {
                ...
                if (ServerProperties.Properties.ENABLE_ZONE_BONUSES)
                {
                    ...
                    {
                        Out.SendMessage(
                            ZoneBonus.GetBonusMessage(this, (int)(zoneBonus * ServerProperties.Properties.RP_RATE), ZoneBonus.eZoneBonusType.RP),
        ...
        public virtual void GainBountyPoints(long amount, bool modify, bool sendMessage, bool notify)
        {
            if (modify)
            {
                ...
                if (ServerProperties.Properties.ENABLE_ZONE_BONUSES)
                {
                    ...
                    {
                        Out.SendMessage(
                            ZoneBonus.GetBonusMessage(this, (int)(zoneBonus * ServerProperties.Properties.BP_RATE), ZoneBonus.eZoneBonusType.BP),
                                        eChatType.CT_Important, eChatLoc.CL_SystemWindow);
        ...
        public override void GainExperience(eXPSource xpSource, long expTotal, long expCampBonus, long expGroupBonus, long expOutpostBonus, bool sendMessage, bool allowMultiply, bool notify)
        {
            ...
            if (allowMultiply)
            {
                ...
                if (ServerProperties.Properties.ENABLE_ZONE_BONUSES)
                {
                    ...
                    {
                        Out.SendMessage(
                            ZoneBonus.GetBonusMessage(this, (int)(zoneBonus * ServerProperties.Properties.XP_RATE), ZoneBonus.eZoneBonusType.XP),
                                        eChatType.CT_Important, eChatLoc.CL_SystemWindow);
        ...
        public virtual bool IsLevelSecondStage
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.IsLevelSecondStage = value;
                }
            }
        }
        ...
        protected virtual void RangeAttackHandler(DOLEvent e, object sender, EventArgs arguments)
        {
            ...
            switch (args.AttackData.AttackResult)
            {
                ...
                case eAttackResult.Fumbled:
                    ...
                    {
                        Endurance -= RANGE_ATTACK_ENDURANCE;
                    }
        ...
        public override void StartAttack(GameObject attackTarget)
        {
            ...
            else
            {
                if (attackTarget == null)
                {
                    ...
                    {
                        Out.SendMessage(
                            LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.StartAttack.CombatTarget",
...
break;
        ...
        protected override void SendAttackingCombatMessages(AttackData ad)
        {
            ...
            if (ad.Target is GameNPC)
            {
                ...
                {
                    case eAttackResult.TargetNotVisible: Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.NotInView",
                        ad.Target.GetName(0, true, Client.Account.Language, ad.Target as GameNPC)), eChatType.CT_YouHit, eChatLoc.CL_SystemWindow); break;
                    case eAttackResult.OutOfRange: Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.TooFarAway",
                        ad.Target.GetName(0, true, Client.Account.Language, ad.Target as GameNPC)), eChatType.CT_YouHit, eChatLoc.CL_SystemWindow); break;
                    case eAttackResult.TargetDead: Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.AlreadyDead",
                        ad.Target.GetName(0, true, Client.Account.Language, ad.Target as GameNPC)), eChatType.CT_YouHit, eChatLoc.CL_SystemWindow); break;
                    case eAttackResult.Blocked: Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Blocked",
                        ad.Target.GetName(0, true, Client.Account.Language, ad.Target as GameNPC)), eChatType.CT_YouHit, eChatLoc.CL_SystemWindow); break;
                    case eAttackResult.Parried: Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Parried",
                        ad.Target.GetName(0, true, Client.Account.Language, ad.Target as GameNPC)), eChatType.CT_YouHit, eChatLoc.CL_SystemWindow); break;
                    case eAttackResult.Evaded: Out.SendMessage(
                        LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Evaded",
                        ad.Target.GetName(0, true, Client.Account.Language, ad.Target as GameNPC)), eChatType.CT_YouHit, eChatLoc.CL_SystemWindow); break;
                    ...
                    case eAttackResult.HitUnstyled:
                        ...
                        {
                            Out.SendMessage(
                                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.InterceptHit", attackTypeMsg,
                        ...
                        {
                            Out.SendMessage(
                                LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Attack.Critical",
        ...
        public override int GetMeleeCriticalDamage(AttackData ad, InventoryItem weapon)
        {
            if (Util.Chance(AttackCriticalChance(weapon)))
            {
                ...
                if (ad.Target.EffectList.GetOfType<TripleWieldEffect>() != null)
                {
                    return 0;
                }
        ...
        public override int AttackRange
        {
            ...
            get
            {
                ...
                if (ActiveWeaponSlot == eActiveWeaponSlot.Distance)
                {
                    ...
                    {
                        range += Math.Min((Z - livingTarget.Z) / 2.0, 500);
                    }
        ...
        public override void EnemyKilled(GameLiving enemy)
        {
            if (Group != null)
            {
                foreach (GamePlayer player in Group.GetPlayersInTheGroup())
                {
                    ...
                    if (enemy.Attackers.Contains(player))
                    {
                        continue;
                    }
                ...
                lock (m_spellQueueAccessMonitor)
                {
                    if (m_runningSpellHandler != null)
                    {
                        ...
                        if (spell.CastTime > 0 && !(m_runningSpellHandler is ChamberSpellHandler) && spell.SpellType != "Chamber")
                        {
                            ...
                            {
                                Out.SendMessage(LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.CastSpell.AlreadyCastNoQueue"), eChatType.CT_SpellResisted, eChatLoc.CL_SystemWindow);
                            }
        ...
        protected virtual bool UseMagicalItem(InventoryItem item, int type)
        {
            ...
            if (cooldown > 0 && Client.Account.PrivLevel == (uint)ePrivLevel.Player)
            {
                ...
                Out.SendMessage(
                    string.Format(
                    "You must wait {0} to discharge this item!",
                                              (minutes <= 0)
                                              ? string.Format("{0} more seconds", seconds)
                                              : string.Format(
                                                  "{0} more minutes and {1} seconds",
                                                              minutes, seconds)),
        ...
        {
            if (poisonPotion == null || toItem == null)
            {
                return false;
            }
        ...
        public virtual bool PrivateMessageReceive(GamePlayer source, string str)
        {
            ...
            {
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.SendReceive.FalseLanguage", source.Name),
            ...
            if (afkmessage != null)
            {
                if (afkmessage == string.Empty)
                {
                    source.Out.SendMessage(
                        LanguageMgr.GetTranslation(source.Client.Account.Language, "GamePlayer.SendReceive.Afk", Name),
                                           eChatType.CT_System, eChatLoc.CL_SystemWindow);
                }
                else
                {
        ...
        public virtual bool SendPrivateMessage(GamePlayer target, string str)
        {
            ...
            {
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.Send.target.DontUnderstandYou", target.Name),
                                eChatType.CT_Send, eChatLoc.CL_ChatWindow);
                return false;
            }
        ...
        public override bool SayReceive(GameLiving source, string str)
        {
            ...
            {
                Out.SendMessage(
                    LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.SayReceive.Says", source.GetName(0, false), str),
        ...
        public override bool WhisperReceive(GameLiving source, string str)
        {
            ...
            {
                Out.SendMessage(
                    source.GetName(0, false) + " whispers something in a language you don't understand.",
                                eChatType.CT_Say, eChatLoc.CL_ChatWindow);
            }
        ...
        public virtual bool DismountSteed(bool forced)
        {
            ...
            if (Steed.Name == "Forceful Zephyr" && !forced)
            {
                return false;
            }
        ...
        public bool ClassNameFlag
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.FlagClassName = value;
                }
            }
        }
            ...
            if ((Client.Account.PrivLevel == 1 || DEBUG_SPEEDHACK) && Properties.SH_ENABLED && Steed == null)
            {
                if (moved)
                {
                    ...
                    if (timediff > 0)
                    {
                        ...
                        if (!hacker && Properties.SH_DETECTFLY)
                        {
                            if (z - LastZ > Properties.JUMP_TOLERANCE)
                            {
                        ...
                        if (!hacker && Properties.SH_DETECTPORT)
                        {
                            if (distance > Properties.SH_MAXDISTANCE)
                            {
                                if (IsJumping)
                                {
                                    IsJumping = false;
                        ...
                        if (!hacker)
                        {
                            ...
                            if (speed > maxspeed && distance > Properties.SH_DISTANCEMIN)
                            {
                                double tolered = (double)maxspeed;
                                double tolerance = 0;
                                if (distance >= Properties.SH_DISTANCEMAX) //115
                                {
                                    tolered += (double)maxspeed * Properties.SH_TOLERANCEMIN / 100; //5%
                                }
                                else if (distance <= Properties.SH_DISTANCEMIN) //15
                                {
                                    tolered += (double)maxspeed * Properties.SH_TOLERANCEMAX / 100; //20%
                                }
                                else
                                {
                                    double ecartdist = Properties.SH_DISTANCEMAX - Properties.SH_DISTANCEMIN; //115-15=100
                                    double ecarttolerance = Properties.SH_TOLERANCEMAX - Properties.SH_TOLERANCEMIN; //20%-5%=15%
                                    double dist = distance - Properties.SH_DISTANCEMIN;
                                    tolerance = Properties.SH_TOLERANCEMAX - (dist * ecarttolerance / ecartdist);
                                ...
                                if (speed > tolered)
                                {
                                    ...
                                    lock (SpeedHacks)
                                    {
                                        ...
                                        {
                                            if (t + Properties.SH_REMAIN < Environment.TickCount
                                                && !remove.Contains(t))
                                                remove.Add(t);
                                        }
                                        ...
                                        if (SpeedHacks.Count >= Properties.SH_COUNT)
                                        {
                                            SpeedHacks.Clear();
                                            foreach (GameClient client in WorldMgr.GetAllPlayingClients())
                                            {
        ...
        public string ItemBonusName(int BonusType)
        {
            ...
            if (BonusType == 1)
            {
                BonusName = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ItemBonusName.Bonus1");// Strength
            }

            if (BonusType == 2)
            {
                BonusName = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ItemBonusName.Bonus2");// Dexterity
            }

            if (BonusType == 3)
            {
                BonusName = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ItemBonusName.Bonus3");// Constitution
            }

            if (BonusType == 4)
            {
                BonusName = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ItemBonusName.Bonus4");// Quickness
            }

            if (BonusType == 5)
            {
                BonusName = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ItemBonusName.Bonus5");// Intelligence
            }

            if (BonusType == 6)
            {
                BonusName = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ItemBonusName.Bonus6");// Piety
            }

            if (BonusType == 7)
            {
                BonusName = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ItemBonusName.Bonus7");// Empathy
            }

            if (BonusType == 8)
            {
                BonusName = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ItemBonusName.Bonus8");// Charisma
            }

            if (BonusType == 9)
            {
                BonusName = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ItemBonusName.Bonus9");// Power
            }

            if (BonusType == 10)
            {
                BonusName = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ItemBonusName.Bonus10");// Hits
            }

            if (BonusType == 11)
            {
                BonusName = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ItemBonusName.Bonus11");// Body
            }

            if (BonusType == 12)
            {
                BonusName = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ItemBonusName.Bonus12");// Cold
            }

            if (BonusType == 13)
            {
                BonusName = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ItemBonusName.Bonus13");// Crush
            }

            if (BonusType == 14)
            {
                BonusName = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ItemBonusName.Bonus14");// Energy
            }

            if (BonusType == 15)
            {
                BonusName = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ItemBonusName.Bonus15");// Heat
            }

            if (BonusType == 16)
            {
                BonusName = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ItemBonusName.Bonus16");// Matter
            }

            if (BonusType == 17)
            {
                BonusName = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ItemBonusName.Bonus17");// Slash
            }

            if (BonusType == 18)
            {
                BonusName = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ItemBonusName.Bonus18");// Spirit
            }

            if (BonusType == 19)
            {
                BonusName = LanguageMgr.GetTranslation(Client.Account.Language, "GamePlayer.ItemBonusName.Bonus19");// Thrust
            }
        ...
        {
            if (arguments is ItemEquippedArgs == false)
            {
                return;
            }
        ...
        {
            if (arguments is ItemUnequippedArgs == false)
            {
                return;
            }
        ...
        public virtual bool PickupObject(GameObject floorObject, bool checkRange)
        {
            ...
            if ((floorObject is GameBoat == false) && !checkRange && !floorObject.IsWithinRadius(this, GS.ServerProperties.Properties.WORLD_PICKUP_DISTANCE, true))
            {
                ...
                {
                    log.DebugFormat(
                        "Pickup error: {0}  object x{1}, y{2}, z{3}, r{4} - player x{5}, y{6}, z{7}, r{8}",
                                    Name,
        ...
        public virtual int VerifySpecPoints()
        {
            ...
            for (int i = 1; i <= Level; i++)
            {
                if (i <= 5)
                {
                    allpoints += i; // start levels
                }

                if (i > 5)
                {
                    allpoints += CharacterClass.SpecPointsMultiplier * i / 10; // normal levels
                }

                if (i > 40)
                {
                    allpoints += CharacterClass.SpecPointsMultiplier * (i - 1) / 20; // half levels
                }
            }
        ...
        public static void Unstealth(DOLEvent ev, object sender, EventArgs args)
        {
            ...
            if (player == null || atkArgs == null)
            {
                return;
            }

            if (atkArgs.AttackData.AttackResult != eAttackResult.HitUnstyled && atkArgs.AttackData.AttackResult != eAttackResult.HitStyle)
            {
                return;
            }

            if (atkArgs.AttackData.Damage == -1)
            {
                return;
            }
        ...
        protected class UncoverStealthAction : RegionAction
        {
            ...
            protected override void OnTick()
            {
                ...
                foreach (GameNPC npc in player.GetNPCsInRadius(1024))
                {
                    ...
                    if (chanceToUncover < 0.01)
                    {
                        chanceToUncover = 0.01;
                    }
        ...
        public AbstractMission Mission
        {
            ...
            set
            {
                ...
                if (value != null)
                {
                    Out.SendMessage(m_mission.Description, eChatType.CT_System, eChatLoc.CL_SystemWindow);
                }
            }
        }
        ...
        protected void LoadCraftingSkills()
        {
            ...
            if (DBCharacter.SerializedCraftingSkills == string.Empty || DBCharacter.CraftingPrimarySkill == 0)
            {
        ...
        public virtual byte ActiveSaddleBags
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.ActiveSaddleBags = value;
                }
            }
        }
        ...
        public virtual int ChampionLevel
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.ChampionLevel = value;
                }
            }
        }
        ...
        public virtual long ChampionExperience
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.ChampionExperience = value;
                }
            }
        }
        ...
        public virtual int RespecAmountChampionSkill
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.RespecAmountChampionSkill = value;
                }
            }
        }
        ...
        public virtual long MLExperience
        {
            ...
            set { if (DBCharacter != null)
                {
                    DBCharacter.MLExperience = value;
                }
            }
        }
