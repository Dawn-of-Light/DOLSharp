...
namespace DOL.GS
{
	...
	/// </summary>
	public class NecromancerLesserZombieServantPet : NecromancerZombieServantPet
	{
		public NecromancerLesserZombieServantPet(INpcTemplate npcTemplate, int summonConBonus, int summonHitsBonus)
