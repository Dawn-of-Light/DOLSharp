...
namespace DOL.GS.PlayerClass
{
	...
	public class ClassWarlock : ClassMystic
	{
		...
		{
			if (level >= 50) return LanguageMgr.GetTranslation(player.Client, "PlayerClass.Warlock.GetTitle.50");
			if (level >= 45) return LanguageMgr.GetTranslation(player.Client, "PlayerClass.Warlock.GetTitle.45");
			if (level >= 40) return LanguageMgr.GetTranslation(player.Client, "PlayerClass.Warlock.GetTitle.40");
			if (level >= 35) return LanguageMgr.GetTranslation(player.Client, "PlayerClass.Warlock.GetTitle.35");
			if (level >= 30) return LanguageMgr.GetTranslation(player.Client, "PlayerClass.Warlock.GetTitle.30");
			if (level >= 25) return LanguageMgr.GetTranslation(player.Client, "PlayerClass.Warlock.GetTitle.25");
			if (level >= 20) return LanguageMgr.GetTranslation(player.Client, "PlayerClass.Warlock.GetTitle.20");
			if (level >= 15) return LanguageMgr.GetTranslation(player.Client, "PlayerClass.Warlock.GetTitle.15");
			if (level >= 10) return LanguageMgr.GetTranslation(player.Client, "PlayerClass.Warlock.GetTitle.10");
			if (level >= 5) return LanguageMgr.GetTranslation(player.Client, "PlayerClass.Warlock.GetTitle.5");
