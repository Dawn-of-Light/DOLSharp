...
{
	/// <summary>
	/// The Combat Fatigue Consumption bonus percent calculator
	///
	...
	/// </summary>
	[PropertyCalculator(eProperty.CombatFatigueConsumption)]
	public class CombatFatigueConsumptionPercentCalculator : PropertyCalculator
	{
