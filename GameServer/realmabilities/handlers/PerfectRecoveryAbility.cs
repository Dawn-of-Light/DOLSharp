	...
	public class PerfectRecoveryAbility : TimedRealmAbility
	{
		...
		public void ResurrectLiving(GamePlayer resurrectedPlayer, GameLiving rezzer)
		{
			...
			if (rezzer.CurrentRegionID != resurrectedPlayer.CurrentRegionID)
				return;
            resurrectedPlayer.Health = (int) (resurrectedPlayer.MaxHealth * m_resurrectValue * 0.01);
            resurrectedPlayer.Mana = (int) (resurrectedPlayer.MaxMana * m_resurrectValue * 0.01);
            resurrectedPlayer.Endurance = (int) (resurrectedPlayer.MaxEndurance * m_resurrectValue * 0.01); //no endurance after any rez
