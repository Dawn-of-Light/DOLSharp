...
{
    /// <summary>
    /// Quest for the Goddess Necklace artifact.
    /// </summary>
    ...
    class GoddessNecklace : ArtifactQuest
    {
        ...
        public GoddessNecklace(GamePlayer questingPlayer)
            : base(questingPlayer) { }
        ...
        public GoddessNecklace(GamePlayer questingPlayer, DBQuest dbQuest)
        ...
        {
            Init("Goddess Necklace", typeof(GoddessNecklace));
        }
        ...
        /// </summary>
        public override string Name => "Goddess Necklace";

        /// <summary>
        /// The reward for this quest.
        /// </summary>
        public override string ArtifactId => "Goddess Necklace";
    }
}
