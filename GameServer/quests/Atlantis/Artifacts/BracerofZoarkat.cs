...
namespace DOL.GS.Quests.Atlantis.Artifacts
{
    ...
    class BraceletofZoarkat : ArtifactQuest
    {
        ...
        {
            Init("Bracelet of Zo'arkat", typeof(BraceletofZoarkat));
        }
        ...
        /// </summary>
        public override string Name => "Bracelet of Zo'arkat";

        /// <summary>
        /// The reward for this quest.
        /// </summary>
        public override string ArtifactId => "Bracelet of Zo'arkat";
    }
}
