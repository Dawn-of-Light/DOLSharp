...
{
    /// <summary>
    /// Quest for the Tablet of Atlantis artifact.
    /// </summary>
    ...
    class TabletofAtlantis : ArtifactQuest
    {
        ...
        {
            Init("Tablet of Atlantis", typeof(TabletofAtlantis));
        }
        ...
        public override bool WhisperReceive(GameLiving source, GameLiving target, string text)
        {
            ...
            {
                string reply = "Oh, the mysterious Tablet of Atlantis. Do you have the scrolls on it? I've found a few that allude to its true nature, but haven't found anything with any detail.";
                scholar.TurnTo(player);
                scholar.SayTo(player, eChatLoc.CL_PopupWindow, reply);
                Step = 2;
                return true;
        ...
        /// </summary>
        public override string Name => "Tablet of Atlantis";

        /// <summary>
        /// The reward for this quest.
        /// </summary>
        public override string ArtifactId => "Tablet of Atlantis";
    }
}
