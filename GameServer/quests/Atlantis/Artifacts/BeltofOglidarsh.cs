...
{
    /// <summary>
    /// Quest for the Belt of Oglidarsh artifact.
    /// </summary>
    ...
    class BeltofOglidarsh : ArtifactQuest
    {
        ...
        public BeltofOglidarsh(GamePlayer questingPlayer)
            : base(questingPlayer) { }
        ...
        public BeltofOglidarsh(GamePlayer questingPlayer, DBQuest dbQuest)
        ...
        {
            Init("Belt of Oglidarsh", typeof(BeltofOglidarsh));
        }
        ...
        public override bool WhisperReceive(GameLiving source, GameLiving target, string text)
        {
            ...
            {
                string reply = "Oh, the mysterious Belt of Oglidarsh. Do you have the scrolls on it? I've found a few that allude to its true nature, but haven't found anything with any detail.";
                scholar.TurnTo(player);
                scholar.SayTo(player, eChatLoc.CL_PopupWindow, reply);
                Step = 2;
                return true;
        ...
        /// </summary>
        public override string Name => "Belt of Oglidarsh";

        /// <summary>
        /// The reward for this quest.
        /// </summary>
        public override string ArtifactId => "Belt of Oglidarsh";
    }
}
