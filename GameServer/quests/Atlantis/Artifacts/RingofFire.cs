...
{
    /// <summary>
    /// Quest for the Ring of Fire artifact.
    /// </summary>
    ...
    class RingofFire : ArtifactQuest
    {
        ...
        public RingofFire(GamePlayer questingPlayer, DBQuest dbQuest)
        ...
        {
            Init("Ring of Fire", typeof(RingofFire));
        }
        ...
        public override bool WhisperReceive(GameLiving source, GameLiving target, string text)
        {
            ...
            {
                string reply = "Oh, the mysterious Ring of Fire. Do you have the scrolls on it? I've found a few that allude to its true nature, but haven't found anything with any detail.";
                scholar.TurnTo(player);
                scholar.SayTo(player, eChatLoc.CL_PopupWindow, reply);
                Step = 2;
                return true;
        ...
        /// </summary>
        public override string Name => "Ring of Fire";

        /// <summary>
        /// The reward for this quest.
        /// </summary>
        public override string ArtifactId => "Ring of Fire";
    }
}
