...
{
    /// <summary>
    /// Quest for the Ring of Unyielding Will artifact.
    /// </summary>
    ...
    class RingofUnyieldingWill : ArtifactQuest
    {
        ...
        public RingofUnyieldingWill(GamePlayer questingPlayer)
            : base(questingPlayer) { }
        ...
        public RingofUnyieldingWill(GamePlayer questingPlayer, DBQuest dbQuest)
        ...
        {
            Init("Ring of Unyielding Will", typeof(RingofUnyieldingWill));
        }
        ...
        /// </summary>
        public override string Name => "Ring of Unyielding Will";

        /// <summary>
        /// The reward for this quest.
        /// </summary>
        public override string ArtifactId => "Ring of Unyielding Will";
    }
}
