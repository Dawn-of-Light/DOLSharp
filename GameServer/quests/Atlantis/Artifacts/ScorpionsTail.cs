...
{
    /// <summary>
    /// Quest for the Scorpions Tail artifact.
    /// </summary>
    ...
    class ScorpionsTail : ArtifactQuest
    {
        ...
        {
            Init("The Scorpions Tail", typeof(ScorpionsTail));
        }
        ...
        public override bool WhisperReceive(GameLiving source, GameLiving target, string text)
        {
            ...
            {
                string reply = "Oh, the mysterious Scorpions Tail. Do you have the scrolls on it? I've found a few that allude to its true nature, but haven't found anything with any detail.";
                scholar.TurnTo(player);
                scholar.SayTo(player, eChatLoc.CL_PopupWindow, reply);
                Step = 2;
                return true;
        ...
        /// </summary>
        public override string Name => "The Scorpions Tail";

        /// <summary>
        /// The reward for this quest.
        /// </summary>
        public override string ArtifactId => "The Scorpions Tail";
    }
}
