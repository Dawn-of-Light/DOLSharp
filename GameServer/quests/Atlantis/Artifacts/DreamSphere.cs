...
{
    /// <summary>
    /// Quest for the Dream Sphere artifact.
    /// </summary>
    ...
    class DreamSphere : ArtifactQuest
    {
        ...
        {
            Init("Dream Sphere", typeof(DreamSphere));
        }
        ...
        public override bool WhisperReceive(GameLiving source, GameLiving target, string text)
        {
            ...
            {
                string reply = "Oh, the mysterious Dream Sphere. Do you have the scrolls on it? I've found a few that allude to its true nature, but haven't found anything with any detail.";
                scholar.TurnTo(player);
                scholar.SayTo(player, eChatLoc.CL_PopupWindow, reply);
                Step = 2;
                return true;
        ...
        /// </summary>
        public override string Name => "Dream Sphere";

        /// <summary>
        /// The reward for this quest.
        /// </summary>
        public override string ArtifactId => "Dream Sphere";
    }
}
