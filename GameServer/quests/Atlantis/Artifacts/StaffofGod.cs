...
namespace DOL.GS.Quests.Atlantis.Artifacts
{
    ...
    public class StaffofGod : ArtifactQuest
    {
        ...
        public StaffofGod(GamePlayer questingPlayer, DBQuest dbQuest)
        ...
        {
            Init("Staff of the God", typeof(StaffofGod));
        }
        ...
        public override bool WhisperReceive(GameLiving source, GameLiving target, string text)
        {
            ...
            {
                string reply = "Staff of the God is an interesting staff. The story of its making rather unique, don\'t you think? If you give me the scroll, I\'ll give you the staff, with all its ancient powers back.";
                scholar.TurnTo(player);
                scholar.SayTo(player, eChatLoc.CL_PopupWindow, reply);
                Step = 2;
                return true;
        ...
        /// </summary>
        public override string Name => "Staff of the God";

        /// <summary>
        /// The reward for this quest.
        /// </summary>
        public override string ArtifactId => "Staff of the God";
    }
}
