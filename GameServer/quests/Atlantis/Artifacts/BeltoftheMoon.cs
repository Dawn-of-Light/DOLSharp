...
{
    /// <summary>
    /// Quest for the Belt of the Moon artifact.
    /// </summary>
    ...
    class BeltoftheMoon : ArtifactQuest
    {
        ...
        public BeltoftheMoon(GamePlayer questingPlayer)
            : base(questingPlayer) { }
        ...
        public BeltoftheMoon(GamePlayer questingPlayer, DBQuest dbQuest)
        ...
        {
            Init("Belt of the Moon", typeof(BeltoftheMoon));
        }
        ...
        /// </summary>
        public override string Name => "Belt of the Moon";

        /// <summary>
        /// The reward for this quest.
        /// </summary>
        public override string ArtifactId => "Belt of the Moon";
    }
}
