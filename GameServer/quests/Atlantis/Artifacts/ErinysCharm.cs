...
{
    /// <summary>
    /// Quest for the Erinys' Charm artifact.
    /// </summary>
    ...
    class ErinysCharm : ArtifactQuest
    {
        ...
        public ErinysCharm(GamePlayer questingPlayer)
            : base(questingPlayer) { }
        ...
        public ErinysCharm(GamePlayer questingPlayer, DBQuest dbQuest)
        ...
        {
            Init("Erinys Charm", typeof(ErinysCharm));
        }
        ...
        /// </summary>
        public override string Name => "Erinys Charm";

        /// <summary>
        /// The reward for this quest.
        /// </summary>
        public override string ArtifactId => "Erinys Charm";
    }
}
