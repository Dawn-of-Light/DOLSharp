...
namespace DOL.GS.Quests.Atlantis.Artifacts
{
	...
	class CyclopsEyeShield : ArtifactQuest
	{
		/// <summary>
		...
		{
			get { return "Cyclops Eye Shield"; }
		}

		/// <summary>
		/// The reward for this quest.
		/// </summary>
		private static String m_artifactID = "Cyclops Eye Shield";
		...
		{
			ArtifactQuest.Init(m_artifactID, typeof(CyclopsEyeShield));
		}
