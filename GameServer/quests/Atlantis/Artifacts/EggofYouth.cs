...
{
    /// <summary>
    /// Quest for the Egg of Youth artifact.
    /// </summary>
    ...
    class EggofYouth : ArtifactQuest
    {
        ...
        public EggofYouth(GamePlayer questingPlayer)
            : base(questingPlayer) { }
        ...
        public EggofYouth(GamePlayer questingPlayer, DBQuest dbQuest)
        ...
        {
            Init("Egg of Youth", typeof(EggofYouth));
        }
        ...
        public override bool WhisperReceive(GameLiving source, GameLiving target, string text)
        {
            ...
            {
                string reply = "Oh, the mysterious Egg of Youth. Do you have the scrolls on it? I've found a few that allude to its true nature, but haven't found anything with any detail.";
                scholar.TurnTo(player);
                scholar.SayTo(player, eChatLoc.CL_PopupWindow, reply);
                Step = 2;
                return true;
        ...
        /// </summary>
        public override string Name => "Egg of Youth";

        /// <summary>
        /// The reward for this quest.
        /// </summary>
        public override string ArtifactId => "Egg of Youth";
    }
}
