...
{
    /// <summary>
    /// Quest for the Kalare's Necklace artifact.
    /// </summary>
    ...
    class KalaresNecklace : ArtifactQuest
    {
        ...
        public KalaresNecklace(GamePlayer questingPlayer, DBQuest dbQuest)
        ...
        {
            Init("Kalare's Necklace", typeof(KalaresNecklace));
        }
        ...
        public override bool WhisperReceive(GameLiving source, GameLiving target, string text)
        {
            ...
            {
                string reply = "Oh, the mysterious Kalare's Necklace. Do you have the scrolls on it? I've found a few that allude to its true nature, but haven't found anything with any detail.";
                scholar.TurnTo(player);
                scholar.SayTo(player, eChatLoc.CL_PopupWindow, reply);
                Step = 2;
                return true;
        ...
        /// </summary>
        public override string Name => "Kalare's Necklace";

        /// <summary>
        /// The reward for this quest.
        /// </summary>
        public override string ArtifactId => "Kalare's Necklace";
    }
}
