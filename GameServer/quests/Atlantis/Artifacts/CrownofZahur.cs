...
namespace DOL.GS.Quests.Atlantis.Artifacts
{
	...
	class CrownofZahur : ArtifactQuest
	{
		/// <summary>
		...
		{
			get { return "Crown of Zahur"; }
		}

		/// <summary>
		/// The reward for this quest.
		/// </summary>
		private static String m_artifactID = "Crown of Zahur";
		...
		public CrownofZahur(GamePlayer questingPlayer)
			: base(questingPlayer) { }
		...
		public CrownofZahur(GamePlayer questingPlayer, DBQuest dbQuest)
		...
		{
			ArtifactQuest.Init(m_artifactID, typeof(CrownofZahur));
		}
