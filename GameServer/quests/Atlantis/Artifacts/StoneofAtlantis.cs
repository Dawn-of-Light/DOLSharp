...
{
    /// <summary>
    /// Quest for the Stone of Atlantis artifact.
    /// </summary>
    ...
    class StoneofAtlantis : ArtifactQuest
    {
        ...
        {
            Init("Stone of Atlantis", typeof(StoneofAtlantis));
        }
        ...
        /// </summary>
        public override string Name => "Stone of Atlantis";

        /// <summary>
        /// The reward for this quest.
        /// </summary>
        public override string ArtifactId => "Stone of Atlantis";
    }
}
