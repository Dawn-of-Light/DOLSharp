...
{
    /// <summary>
    /// Quest for the Belt of the Sun artifact.
    /// </summary>
    ...
    class BeltoftheSun : ArtifactQuest
    {
        ...
        public BeltoftheSun(GamePlayer questingPlayer)
            : base(questingPlayer) { }
        ...
        public BeltoftheSun(GamePlayer questingPlayer, DBQuest dbQuest)
        ...
        {
            Init("Belt of the Sun", typeof(BeltoftheSun));
        }
        ...
        public override bool WhisperReceive(GameLiving source, GameLiving target, string text)
        {
            ...
            {
                string reply = "Oh, the mysterious Belt of the Sun. Do you have the scrolls on it? I've found a few that allude to its true nature, but haven't found anything with any detail.";
                scholar.TurnTo(player);
                scholar.SayTo(player, eChatLoc.CL_PopupWindow, reply);
                Step = 2;
                return true;
        ...
        /// </summary>
        public override string Name { get; } = "Belt of the Sun";

        /// <summary>
        /// The reward for this quest.
        /// </summary>
        public override string ArtifactId => "Belt of the Sun";
    }
}
