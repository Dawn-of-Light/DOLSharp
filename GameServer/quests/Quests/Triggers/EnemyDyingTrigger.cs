...
{	
    ...
    /// </summary>
    [QuestTriggerAttribute(TriggerType=eTriggerType.EnemyDying,IsNullableK=true, DefaultValueI=eDefaultValueConstants.NPC)]
    public class EnemyDyingTrigger : AbstractQuestTrigger<string,GameLiving>
    {
        ...
        public EnemyDyingTrigger(BaseQuestPart questPart, eTriggerType type, Object k, Object i)
        ...
        /// <param name="k">keyword (K), meaning depends on triggertype</param>
        /// <param name="i">variable (I), meaning depends on triggertype</param>
        public EnemyDyingTrigger(BaseQuestPart questPart,  string k, GameLiving i)
            : this(questPart, eTriggerType.EnemyDying, (object)k,(object) i)
        { }
