...
{	
    ...
    /// </summary>
    [QuestTriggerAttribute(TriggerType=eTriggerType.Whisper,DefaultValueI=eDefaultValueConstants.NPC)]
    public class WhisperTrigger : AbstractQuestTrigger<string,GameNPC>
    {
        ...
        public WhisperTrigger(BaseQuestPart questPart, eTriggerType type, Object k, Object i)
        ...
        /// <param name="k">keyword (K), meaning depends on triggertype</param>
        /// <param name="i">variable (I), meaning depends on triggertype</param>
        public WhisperTrigger(BaseQuestPart questPart,  string k, GameNPC i)
            : this(questPart, eTriggerType.Whisper, (object)k,(object) i)
        { }
        ...
        {            
			GameEventMgr.AddHandlerUnique(I, GameLivingEvent.WhisperReceive, NotifyHandler);
			GameEventMgr.AddHandlerUnique(I, GameObjectEvent.Interact, NotifyHandler);                                
        }
