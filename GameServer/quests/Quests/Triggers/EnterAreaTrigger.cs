...
{	
    ...
    /// </summary>
    [QuestTriggerAttribute(TriggerType=eTriggerType.EnterArea)]
    public class EnterAreaTrigger : AbstractQuestTrigger<Unused, IArea>
    {
        ...
        public EnterAreaTrigger(BaseQuestPart questPart, eTriggerType type, Object k, Object i)
        ...
        /// <param name="questPart">Parent QuestPart of this Trigger</param>        
        /// <param name="i">variable (I), meaning depends on triggertype</param>
        public EnterAreaTrigger(BaseQuestPart questPart, IArea i)
            : this(questPart, eTriggerType.EnterArea, (object)null,(object) i)
        { }
