...
{	
    ...
    /// </summary>
    [QuestTriggerAttribute(TriggerType=eTriggerType.Interact,DefaultValueI=eDefaultValueConstants.NPC)]
    public class InteractTrigger : AbstractQuestTrigger<Unused,GameNPC>
    {
        ...
        public InteractTrigger(BaseQuestPart questPart, eTriggerType type, Object k, Object i)
        ...
        /// <param name="questPart">Parent QuestPart of this Trigger</param>                
        /// <param name="i">variable (I), meaning depends on triggertype</param>
        public InteractTrigger(BaseQuestPart questPart, GameNPC i)
            : this(questPart, eTriggerType.Interact, (object)null,(object) i)
        { }
