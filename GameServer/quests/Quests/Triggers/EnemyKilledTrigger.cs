...
{	
    ...
    /// </summary>
    [QuestTriggerAttribute(TriggerType=eTriggerType.EnemyKilled,IsNullableK=true, DefaultValueI=eDefaultValueConstants.NPC)]
    public class EnemyKilledTrigger : AbstractQuestTrigger<string,GameLiving>
    {
        ...
        public EnemyKilledTrigger(BaseQuestPart questPart, eTriggerType type, Object k, Object i)
        ...
        /// <param name="k">keyword (K), meaning depends on triggertype</param>
        /// <param name="i">variable (I), meaning depends on triggertype</param>
        public EnemyKilledTrigger(BaseQuestPart questPart,  string k, GameLiving i)
            : this(questPart, eTriggerType.EnemyKilled, (object)k,(object) i)
        { }
