...
{	
    ...
    /// </summary>
    [QuestTriggerAttribute(TriggerType=eTriggerType.LeaveArea)]
    public class LeaveAreaTrigger : AbstractQuestTrigger<Unused, IArea>
    {
        ...
        public LeaveAreaTrigger(BaseQuestPart questPart, eTriggerType type, Object k, Object i)
        ...
        /// <param name="questPart">Parent QuestPart of this Trigger</param>        
        /// <param name="i">variable (I), meaning depends on triggertype</param>
        public LeaveAreaTrigger(BaseQuestPart questPart, IArea i)
            : this(questPart, eTriggerType.LeaveArea, (object)null,(object) i)
        { }
