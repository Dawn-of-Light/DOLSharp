...
{	
    ...
    /// </summary>
    [QuestTriggerAttribute(TriggerType=eTriggerType.ContinueQuest,DefaultValueI=eDefaultValueConstants.QuestType)]
    public class ContinueQuestTrigger : AbstractQuestTrigger<Unused,Type>
    {
        ...
        public ContinueQuestTrigger(BaseQuestPart questPart, eTriggerType type, Object k, Object i)
        ...
        /// <param name="questPart">Parent QuestPart of this Trigger</param>        
        /// <param name="i">variable (I), meaning depends on triggertype</param>
        public ContinueQuestTrigger(BaseQuestPart questPart, Type i)
            : this(questPart, eTriggerType.ContinueQuest, (object)null,(object) i)
        { }
