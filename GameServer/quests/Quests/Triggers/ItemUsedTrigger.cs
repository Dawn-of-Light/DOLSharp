...
{	
    ...
    /// </summary>
    [QuestTriggerAttribute(TriggerType=eTriggerType.ItemUsed,DefaultValueI=eDefaultValueConstants.NPC)]
    public class ItemUsedTrigger : AbstractQuestTrigger<Unused,ItemTemplate>
    {
        ...
        public ItemUsedTrigger(BaseQuestPart questPart, eTriggerType type, Object k, Object i)
        ...
        /// <param name="questPart">Parent QuestPart of this Trigger</param>        
        /// <param name="i">variable (I), meaning depends on triggertype</param>
        public ItemUsedTrigger(BaseQuestPart questPart, ItemTemplate i)
            : this(questPart, eTriggerType.ItemUsed, (object)null,(object) i)
        { }
