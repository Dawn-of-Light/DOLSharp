...
namespace DOL.GS.Quests.Hibernia
{
	...
	public class TraitorInMagMell : BaseAddrirQuest
	{
		...
		public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
		{
			...
			// item db check
			sluaghPlans = (ItemTemplate) DatabaseLayer.Instance.SelectObject(typeof (ItemTemplate),"Id_nb", "sluagh_plans");
			if (sluaghPlans == null)
			{
			...
			// item db check
			recruitsBoots = (ItemTemplate) DatabaseLayer.Instance.SelectObject(typeof (ItemTemplate),"Id_nb", "recruits_cailiocht_boots");
