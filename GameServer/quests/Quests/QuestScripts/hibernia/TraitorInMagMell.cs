...
namespace DOL.GS.Quests.Hibernia
{
	...
	public class TraitorInMagMell : BaseAddrirQuest
	{
		...
		public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
		{
			...
			// item db check
			sluaghPlans = (ItemTemplate) GameServer.Database.GetDatabaseObjectFromIDnb(typeof (ItemTemplate), "sluagh_plans");
			if (sluaghPlans == null)
			{
			...
			// item db check
			recruitsBoots = (ItemTemplate) GameServer.Database.GetDatabaseObjectFromIDnb(typeof (ItemTemplate), "recruits_cailiocht_boots");
