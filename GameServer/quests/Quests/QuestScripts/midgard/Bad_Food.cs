...
using DOL.AI.Brain;
	...
	GameNPC[] npcs;
		...
		marinefungus = (ItemTemplate) DatabaseLayer.Instance.SelectObject(typeof (ItemTemplate),"Id_nb", "marinefungus");
			if (marinefungus == null)
			{
				...
				marinefungus.Hand = 0;
				marinefungus.Platinum = 0;
				marinefungus.Gold = 0;
				marinefungus.Silver = 0;
				marinefungus.Copper = 0;
