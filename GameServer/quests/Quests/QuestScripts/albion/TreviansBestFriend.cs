		...
		protected static void PlayerEnterWorld(DOLEvent e, object sender, EventArgs args)
		{
			...
			if (quest != null)
			{
				...
				if (quest.Step == 6)
				{
					...
					if (cloak != null && cloak.TemplateID == treviansHoodedCloak.TemplateID)
					{
				...
				else
				{
					switch (wArgs.Text)
					{
						...
						case "cloak":
							...
							if (quest.Step == 2)
							{
								if (player.Inventory.GetFirstItemByID(treviansHoodedCloak.TemplateID, eInventorySlot.Min_Inv, eInventorySlot.Max_Inv) == null)
								{
