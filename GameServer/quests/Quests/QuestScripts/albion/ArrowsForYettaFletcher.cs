	...
	public class ArrowsForYettaFletcher : BaseQuest
	{
		...
		public static void ScriptLoaded(DOLEvent e, object sender, EventArgs args)
		{
			...
			*/
			...
			// item db check
			bundleOfDecayedZombieLegs = (ItemTemplate) DatabaseLayer.Instance.SelectObject(typeof (ItemTemplate),"Id_nb", "bundle_of_decayed_zombie_legs");
		...
		public override void FinishQuest()
		{
			...
			m_questPlayer.GainExperience((long)(m_questPlayer.ExperienceForNextLevel / 15), true);
