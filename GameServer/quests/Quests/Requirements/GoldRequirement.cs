...
namespace DOL.GS.Quests.Requirements
{
	...
	/// </summary>
    [QuestRequirementAttribute(RequirementType=eRequirementType.Gold)]
	public class GoldRequirement : AbstractQuestRequirement<long,Unused>
	{
        ...
        public GoldRequirement(BaseQuestPart questPart, eRequirementType type, Object n, Object v, eComparator comp)
		...
		/// <param name="n">First Requirement Variable, meaning depends on RequirementType</param>	
		/// <param name="comp">Comparator used if some values are veeing compared</param>
        public GoldRequirement(BaseQuestPart questPart,  long n, eComparator comp)
            : this(questPart, eRequirementType.Gold, (object)n, (object)null, comp)
		{   			
		}
