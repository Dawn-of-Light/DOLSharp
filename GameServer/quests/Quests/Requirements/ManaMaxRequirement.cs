...
namespace DOL.GS.Quests.Requirements
{
	...
	/// </summary>
    [QuestRequirementAttribute(RequirementType=eRequirementType.ManaMax)]
	public class ManaMaxRequirement : AbstractQuestRequirement<int,Unused>
	{
        ...
        public ManaMaxRequirement(BaseQuestPart questPart, eRequirementType type, Object n, Object v, eComparator comp)
		...
		/// <param name="n">First Requirement Variable, meaning depends on RequirementType</param>		
		/// <param name="comp">Comparator used if some values are veeing compared</param>
        public ManaMaxRequirement(BaseQuestPart questPart,  int n, eComparator comp)
            : this(questPart, eRequirementType.ManaMax, (object)n, (object)null, comp)
		{   			
		}
		...
		public override bool Check(DOLEvent e, object sender, EventArgs args, GamePlayer player)
		{
            ...
            result = compare(player.MaxMana, N, Comparator);
