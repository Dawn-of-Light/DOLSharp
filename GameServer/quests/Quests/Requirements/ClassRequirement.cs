...
namespace DOL.GS.Quests.Requirements
{
	...
	/// </summary>
    [QuestRequirementAttribute(RequirementType=eRequirementType.Class)]
	public class ClassRequirement : AbstractQuestRequirement<int,Unused>
	{
        ...
        public ClassRequirement(BaseQuestPart questPart, eRequirementType type, Object n, Object v, eComparator comp)
		...
		/// <param name="questPart">Parent QuestPart of this Requirement</param>		
		/// <param name="n">First Requirement Variable, meaning depends on RequirementType</param>			
        public ClassRequirement(BaseQuestPart questPart,  int n)
            : this(questPart, eRequirementType.Class, (object)n, (object)null, eComparator.None)
		{   			
		}
