...
namespace DOL.GS.Quests.Requirements
{
	...
	/// </summary>
    [QuestRequirementAttribute(RequirementType=eRequirementType.HealthMax)]
	public class HealthMaxRequirement : AbstractQuestRequirement<int,Unused>
	{
        ...
        public HealthMaxRequirement(BaseQuestPart questPart, eRequirementType type, Object n, Object v, eComparator comp)
		...
		/// <param name="n">First Requirement Variable, meaning depends on RequirementType</param>		
		/// <param name="comp">Comparator used if some values are veeing compared</param>
        public HealthMaxRequirement(BaseQuestPart questPart,  int n,  eComparator comp)
            : this(questPart, eRequirementType.HealthMax, (object)n, (object)null, comp)
		{   			
		}
