...
namespace DOL.GS.Quests.Requirements
{
	...
	/// </summary>
    [QuestRequirementAttribute(RequirementType=eRequirementType.EncumbranceMax)]
	public class EncumbranceMaxRequirement : AbstractQuestRequirement<int,Unused>
	{
        ...
        public EncumbranceMaxRequirement(BaseQuestPart questPart, eRequirementType type, Object n, Object v, eComparator comp)
		...
		/// <param name="n">First Requirement Variable, meaning depends on RequirementType</param>		
		/// <param name="comp">Comparator used if some values are veeing compared</param>
        public EncumbranceMaxRequirement(BaseQuestPart questPart, int n, eComparator comp)
            : this(questPart, eRequirementType.EncumbranceMax, (object)n, (object)null, comp)
		{   			
		}
