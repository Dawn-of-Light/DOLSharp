...
namespace DOL.GS.Quests.Requirements
{
	...
	/// </summary>
    [QuestRequirementAttribute(RequirementType=eRequirementType.Health)]
	public class HealthRequirement : AbstractQuestRequirement<int,Unused>
	{
        ...
        public HealthRequirement(BaseQuestPart questPart, eRequirementType type, Object n, Object v, eComparator comp)
		...
		/// <param name="n">First Requirement Variable, meaning depends on RequirementType</param>		
		/// <param name="comp">Comparator used if some values are veeing compared</param>
        public HealthRequirement(BaseQuestPart questPart,  int n,  eComparator comp)
            : this(questPart, eRequirementType.Health, (object)n, (object)null, comp)
		{   			
		}
