...
namespace DOL.GS.Quests.Requirements
{
	...
	/// </summary>
    [QuestRequirementAttribute(RequirementType=eRequirementType.Region)]
	public class RegionRequirement : AbstractQuestRequirement<int,int>
	{
        ...
        public RegionRequirement(BaseQuestPart questPart, eRequirementType type, Object n, Object v, eComparator comp)
		...
		/// <param name="n">First Requirement Variable, meaning depends on RequirementType</param>
		/// <param name="v">Second Requirement Variable, meaning depends on RequirementType</param>		
        public RegionRequirement(BaseQuestPart questPart, int n, int v)
            : this(questPart, eRequirementType.Region, (object)n, (object)v, eComparator.None)
		{   			
		}
