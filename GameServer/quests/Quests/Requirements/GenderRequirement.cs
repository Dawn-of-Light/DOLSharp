...
namespace DOL.GS.Quests.Requirements
{
	...
	/// </summary>
    [QuestRequirementAttribute(RequirementType=eRequirementType.Gender)]
	public class GenderRequirement : AbstractQuestRequirement<int,Unused>
	{
        ...
        public GenderRequirement(BaseQuestPart questPart, eRequirementType type, Object n, Object v, eComparator comp)
		...
		/// <param name="n">First Requirement Variable, meaning depends on RequirementType</param>		
		/// <param name="comp">Comparator used if some values are veeing compared</param>
        public GenderRequirement(BaseQuestPart questPart,  int n, eComparator comp)
            : this(questPart, eRequirementType.Gender, (object)n, (object)null, comp)
		{   			
		}
