...
namespace DOL.GS.Quests.Requirements
{
	...
	/// </summary>
    [QuestRequirementAttribute(RequirementType=eRequirementType.Distance,DefaultValueN=eDefaultValueConstants.NPC)]
	public class DistanceRequirement : AbstractQuestRequirement<GameLiving,int>
	{
        ...
        public DistanceRequirement(BaseQuestPart questPart, eRequirementType type, Object n, Object v, eComparator comp)
		...
		/// <param name="comp">Comparator used if some values are veeing compared</param>
        public DistanceRequirement(BaseQuestPart questPart, GameLiving npc, int distance, eComparator comp)
            : this(questPart, eRequirementType.Distance, (object)npc, (object)distance, comp)
		{   			
		}
