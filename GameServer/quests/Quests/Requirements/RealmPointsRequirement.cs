...
namespace DOL.GS.Quests.Requirements
{
	...
	/// </summary>
    [QuestRequirementAttribute(RequirementType=eRequirementType.RealmPoints)]
	public class RealmPointsRequirement : AbstractQuestRequirement<long,Unused>
	{
        ...
        public RealmPointsRequirement(BaseQuestPart questPart, eRequirementType type, Object n, Object v, eComparator comp)
		...
		/// <param name="n">First Requirement Variable, meaning depends on RequirementType</param>		
		/// <param name="comp">Comparator used if some values are veeing compared</param>
        public RealmPointsRequirement(BaseQuestPart questPart,  long n, eComparator comp)
            : this(questPart, eRequirementType.RealmPoints, (object)n, (object)null, comp)
		{   			
		}
