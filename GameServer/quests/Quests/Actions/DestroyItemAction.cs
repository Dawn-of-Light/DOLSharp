...
{
    [QuestActionAttribute(ActionType = eActionType.DestroyItem,DefaultValueQ = 1)]
    class DestroyItemAction : AbstractQuestAction<ItemTemplate,int>
    {               

        public DestroyItemAction(BaseQuestPart questPart, eActionType actionType, Object p, Object q)
            : base(questPart, actionType, p, q) {                
        }


        public DestroyItemAction(BaseQuestPart questPart, ItemTemplate itemTemplate, int quantity)
            : this(questPart, eActionType.DestroyItem, (object)itemTemplate,(object) quantity) { }
