...
{
    [QuestActionAttribute(ActionType = eActionType.DropItem)]
    class DropItemAction : AbstractQuestAction<ItemTemplate,Unused>
    {               

        public DropItemAction(BaseQuestPart questPart, eActionType actionType, Object p, Object q)
            : base(questPart, actionType, p, q) {                
        }


        public DropItemAction(BaseQuestPart questPart, ItemTemplate itemTemplate)
            : this(questPart, eActionType.DropItem,(object) itemTemplate,(object) null) { }
