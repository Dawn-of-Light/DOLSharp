...
namespace DOL.GS.Quests.Actions
{
    ...
    [QuestActionAttribute(ActionType = eActionType.Timer)]
    class TimerAction : AbstractQuestAction<string,int>
    {
        /// <summary>
        ...
        public TimerAction(BaseQuestPart questPart, eActionType actionType, Object p, Object q)
            : base(questPart, actionType, p, q) { 
            
        }


        public TimerAction(BaseQuestPart questPart,   string timerID, int delay)
            : this(questPart, eActionType.Timer, (object)timerID,(object) delay) { }
