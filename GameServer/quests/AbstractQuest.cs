...
namespace DOL.GS.Quests
{
	...
	public abstract class AbstractQuest
	{
		...
		public virtual void FinishQuest()
		{
			...
			foreach (GameNPC npc in m_questPlayer.GetInRadius(typeof(GameNPC), WorldMgr.VISIBILITY_DISTANCE))
			{
				m_questPlayer.Out.SendNPCsQuestEffect(npc, QuestMgr.CanGiveOneNewQuest(npc, m_questPlayer));
			}
		...
		public void AbortQuest()
		{
			m_step = 0; // tag this quest as finished
			m_questPlayer.Out.SendQuestListUpdate();
			m_questPlayer.Out.SendMessage("Quest ["+Name+"] deleted from your journal ...", eChatType.CT_Important, eChatLoc.CL_SystemWindow);
