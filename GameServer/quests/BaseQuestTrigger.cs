                ...
                case eTriggerType.AcceptQuest:
                    {
                        if (e == GamePlayerEvent.AcceptQuest)
                        {
                            ...
                            result |= (qArgs.Player.ObjectID == player.ObjectID && qArgs.QuestType == questType);
                        }
                        break;
                    }
                case eTriggerType.DeclineQuest:
                ...
                case eTriggerType.AbortQuest:
                    {
                        if (e == GamePlayerEvent.AbortQuest)
                        {
                            ...
                            QuestCancelEventArgs qArgs = (QuestCancelEventArgs)args;
                            result |= (qArgs.Player.ObjectID == player.ObjectID && qArgs.Quest.GetType() == questType);
                        }
                        break;
                    }
                case eTriggerType.ContinueQuest:
        ...
        public override void Register()
        {
            ...
            switch (TriggerType)
            {
                ...
                case eTriggerType.DeclineQuest:
                    ...
                    break;
                case eTriggerType.EnemyDying:
					GameEventMgr.AddHandlerUnique(NPC, GameLivingBaseEvent.Dying, NotifyHandler);
                    break;
                case eTriggerType.EnterArea:
                    //IArea area = (IArea)I;
        ...
        public override void Unregister()
        {
            ...
            switch (TriggerType)
            {
                ...
                case eTriggerType.DeclineQuest:
                    ...
                    break;
                case eTriggerType.EnemyDying:
					GameEventMgr.RemoveHandler(NPC, GameLivingBaseEvent.Dying, NotifyHandler);
                    break;
                case eTriggerType.EnterArea:
                    //IArea area = (IArea)I;
