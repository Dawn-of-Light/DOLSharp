...
namespace DOL.GS.Quests
{
	...
	public class MoneyTask : AbstractTask
	{
		...
		private static readonly ushort[] ObjectModels = { 99, 99, 101, 103, 229, 113, 498, 499, 500, 510, 511, 523, 524, 606, 552, 554, 583, 584, 592, 603, 607, 611, 621, 622, 623, 101, 498 };

		/// <summary>
		/// Constructs a new Task
		/// </summary>
		/// <param name="taskPlayer">The player doing this task</param>
		public MoneyTask(GamePlayer taskPlayer)
			: base(taskPlayer)
		{
		}
		...
		public MoneyTask(GamePlayer taskPlayer, DBTask dbTask)
		...
		public static InventoryItem GenerateNPCItem(string Name, byte Level)
		{
