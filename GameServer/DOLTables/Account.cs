...
namespace DOL
{
	namespace Database2
	{
		...
		public class Account : DatabaseObject
		{
			...
			public int Status {
				get { return m_state; }
				set { m_Dirty = true; m_state = value; }
			}
			...
			public string Language
			{
				...
				set { m_Dirty = true; m_language = value; }
			}
            ...
            {
                Characters = DatabaseLayer.Instance.SelectObjects<Character>("AccountName", Name);
            } 
		}
	}
}
