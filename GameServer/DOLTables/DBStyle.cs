...
namespace DOL.Database2
{
	...
	/// </summary>
	[Serializable]//TableName = "Style")]
	public class DBStyle : DatabaseObject
	{
		/// <summary>
		...
		public string SpecKeyName
		{
			...
			set { m_SpecKeyName = value; m_Dirty = true; }
		}
		...
		public int SpecLevelRequirement
		{
			...
			set { m_SpecLevelRequirement = value; m_Dirty = true; }
		}
		...
		public int EnduranceCost
		{
			...
			set { m_EnduranceCost = value; m_Dirty = true; }
		}
		...
		public bool StealthRequirement
		{
			...
			set { m_StealthRequirement = value; m_Dirty = true; }
		}
		...
		public int OpeningRequirementType
		{
			...
			set { m_openingRequirementType = value; m_Dirty = true; }
		}
		...
		public int OpeningRequirementValue
		{
			...
			set { m_openingRequirementValue = value; m_Dirty = true; }
		}
		...
		public int AttackResultRequirement
		{
			...
			set { m_AttackResultRequirement = value; m_Dirty = true; }
		}
		...
		public int WeaponTypeRequirement
		{
			...
			set { m_WeaponTypeRequirement = value; m_Dirty = true; }
		}
		...
		public double GrowthRate
		{
			...
			set { m_growthRate = value; m_Dirty = true; }
		}
		...
		public int BonusToHit
		{
			...
			set { m_BonusToHit = value; m_Dirty = true; }
		}
		...
		public int BonusToDefense
		{
			...
			set { m_BonusToDefense = value; m_Dirty = true; }
		}
		...
		public int TwoHandAnimation
		{
			...
			set { m_TwoHandAnimation = value; m_Dirty = true; }
		}
		...
		public bool RandomProc
		{
			...
			set { m_RandomProc = value; m_Dirty = true; }
		}
		...
		public int ArmorHitLocation
		{
			...
			set { m_armorHitLocation = value; m_Dirty = true; }
		}
	}
}
