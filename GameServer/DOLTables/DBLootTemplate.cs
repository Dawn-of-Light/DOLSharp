...
namespace DOL.Database2
{
	...
	/// </summary>
	[Serializable]//TableName="LootTemplate")]
	public class DBLootTemplate : DatabaseObject
	{
        ...
        {
            ItemTemplate = (ItemTemplate)DatabaseLayer.Instance.GetDatabaseObjectFromIDnb(typeof(ItemTemplate), ItemTemplateID);
