...
namespace DOL
{
	namespace Database2
	{
		...
		/// </summary>
		[Serializable]//TableName = "DOLCharacters")]
		public class Character : DatabaseObject
		{
			...
			private UInt64 m_guildid;		//not sent in 0x55/0x57		
			...
			public bool Advisor
			{
				...
				set { m_Dirty = true; m_advisor = value; }
			}
			...
			public string CurrentTitleType
			{
				...
				set { m_playerTitleType = value; m_Dirty = true; }
			}
			...
			public int KillsAlbionPlayers
			{
				...
				set { m_killsAlbionPlayers = value; m_Dirty = true; }
			}
			...
			public int KillsMidgardPlayers
			{
				...
				set { m_killsMidgardPlayers = value; m_Dirty = true; }
			}
			...
			public int KillsHiberniaPlayers
			{
				...
				set { m_killsHiberniaPlayers = value; m_Dirty = true; }
			}
			...
			public int KillsAlbionDeathBlows
			{
				...
				set { m_killsAlbionDeathBlows = value; m_Dirty = true; }
			}
			...
			public int KillsMidgardDeathBlows
			{
				...
				set { m_killsMidgardDeathBlows = value; m_Dirty = true; }
			}
			...
			public int KillsHiberniaDeathBlows
			{
				...
				set { m_killsHiberniaDeathBlows = value; m_Dirty = true; }
			}
			...
			public int KillsAlbionSolo
			{
				...
				set { m_killsAlbionSolo = value; m_Dirty = true; }
			}
			...
			public int KillsMidgardSolo
			{
				...
				set { m_killsMidgardSolo = value; m_Dirty = true; }
			}
			...
			public int KillsHiberniaSolo
			{
				...
				set { m_killsHiberniaSolo = value; m_Dirty = true; }
			}
			...
			public int CapturedKeeps
			{
				...
				set { m_capturedKeeps = value; m_Dirty = true; }
			}
			...
			public int CapturedTowers
			{
				...
				set { m_capturedTowers = value; m_Dirty = true; }
			}
			...
			public int CapturedRelics
			{
				...
				set { m_capturedRelics = value; m_Dirty = true; }
			}
			...
			public int KillsDragon
			{
				...
				set { m_killsDragon = value; m_Dirty = true; }
			}
			...
			public int DeathsPvP
			{
				...
				set { m_deathsPvP = value; m_Dirty = true; }
			}
			...
			public int KillsLegion
			{
				...
				set { m_killsLegion = value; m_Dirty = true; }
			}
			...
			public int KillsEpicBoss
			{
				...
				set { m_killsEpicBoss = value; m_Dirty = true; }
			} 
			...
			{
				get { return m_noHelp; }
				set { m_Dirty = true; m_noHelp = value; }
			}
			...
			public bool ShowGuildLogins
			{
				...
				set { m_Dirty = true; m_showGuildLogins = value; }
			}	
