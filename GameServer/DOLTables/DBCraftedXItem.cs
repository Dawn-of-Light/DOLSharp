...
namespace DOL
{
	namespace Database2
	{
		...
		/// </summary>
		[Serializable]//TableName="CraftedXItem")]
		public class DBCraftedXItem : DatabaseObject
		{
            ...
            {
                ItemTemplate = (ItemTemplate)DatabaseLayer.Instance.GetDatabaseObjectFromIDnb(typeof(ItemTemplate), IngredientId_nb);
