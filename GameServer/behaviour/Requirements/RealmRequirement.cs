...
namespace DOL.GS.Behaviour.Requirements
{
	...
	/// </summary>
    [RequirementAttribute(RequirementType=eRequirementType.Realm)]
	public class RealmRequirement : AbstractRequirement<int,Unused>
	{
        ...
        public RealmRequirement(GameNPC defaultNPC,  int n,  eComparator comp)
