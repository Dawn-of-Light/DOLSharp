...
namespace DOL.GS.Behaviour.Requirements
{
	...
	/// </summary>
    [RequirementAttribute(RequirementType=eRequirementType.ManaMax)]
	public class ManaMaxRequirement : AbstractRequirement<int,Unused>
	{
        ...
        public ManaMaxRequirement(GameNPC defaultNPC,  Object n, Object v, eComparator comp)
            : base(defaultNPC, eRequirementType.ManaMax, n, v, comp)
		{   			
		}
        ...
        public ManaMaxRequirement(GameNPC defaultNPC,  int n, eComparator comp)
