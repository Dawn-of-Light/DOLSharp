...
namespace DOL.GS.Behaviour.Requirements
{
	...
	/// </summary>
    [RequirementAttribute(RequirementType=eRequirementType.Gold)]
	public class GoldRequirement : AbstractRequirement<long,Unused>
	{
		...
		public override bool Check(DOLEvent e, object sender, EventArgs args)
		{
            ...
            result = compare(player.CopperBalance, N, Comparator);
