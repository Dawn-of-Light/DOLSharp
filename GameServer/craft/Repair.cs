...
namespace DOL.GS
{
    ...
    public class Repair
    {
        ...
        public static int BeginWork(GamePlayer player, InventoryItem item)
        {
            ...
            if (player.TradeWindow != null)
            {
                tradePartner = player.TradeWindow.Partner;
            }
            ...
            if (player.IsMoving || player.IsStrafing)
            {
                ...
                {
                    tradePartner.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "Repair.BeginWork.StopRepair2", player.Name, item.Name), eChatType.CT_System, eChatLoc.CL_SystemWindow);
                }
            ...
            if (tradePartner != null)
            {
                tradePartner.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "Repair.BeginWork.BeginRepairing2", player.Name, item.Name), eChatType.CT_System, eChatLoc.CL_SystemWindow);
            }
