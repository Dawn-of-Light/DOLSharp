...
namespace DOL.GS.Spells
{
	...
	public interface ISpellHandler
	{
		...
		/// <summary>
		/// The last attackdata generated by this handler
		/// </summary>
		AttackData GetLastAttackData(GameLiving target);
		...
		/// <summary>
		/// When pulsing spell stop
		/// </summary>
		/// <param name="effect">The effect doing the pulses</param>
		/// <param name="playerCanceled">Is it Canceled by Player.</param>
		void OnSpellPulseCancel(PulsingSpellEffect effect, bool playerCanceled);
		...
		/// <returns></returns>
		int PowerCost(GameLiving caster, bool consuming);
