...
namespace DOL.GS.Spells
{
    ...
    public class LoreDebuff : SpellHandler
    {
        ...
        {
        	base.OnEffectStart(effect);      
        	effect.Owner.BuffBonusCategory3[(int)eProperty.SpellDamage] += (int)Spell.Value;
            effect.Owner.BuffBonusCategory3[(int)eProperty.Resist_Heat] += (int)Spell.Value;
            effect.Owner.BuffBonusCategory3[(int)eProperty.Resist_Cold] += (int)Spell.Value;
            effect.Owner.BuffBonusCategory3[(int)eProperty.Resist_Matter] += (int)Spell.Value;
            effect.Owner.BuffBonusCategory3[(int)eProperty.Resist_Spirit] += (int)Spell.Value;
            effect.Owner.BuffBonusCategory3[(int)eProperty.Resist_Energy] += (int)Spell.Value;
