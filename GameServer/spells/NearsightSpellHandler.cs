    ...
    public class NearsightSpellHandler : ImmunityEffectSpellHandler
    {
        ...
        public override IList<string> DelveInfo
        {
            get
            {
                ...
                list.Add(LanguageMgr.GetTranslation((Caster as GamePlayer)?.Client, "NearsightSpellHandler.DelveInfo.Function", Spell.SpellType == string.Empty ? "(not implemented)" : Spell.SpellType));
                list.Add(" "); // empty line
