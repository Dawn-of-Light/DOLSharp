...
namespace DOL.GS.Spells
{
	...
	public abstract class DualStatBuff : SingleStatBuff
	{
		...
		public override int BonusCategory2 { get { return (int)eBuffBonusCategory.SpecBuff; } }

		// constructor
		public DualStatBuff(GameLiving caster, Spell spell, SpellLine line)
	...
	public class StrengthConBuff : DualStatBuff
	{
		...
		// constructor
		public StrengthConBuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class DexterityQuiBuff : DualStatBuff
	{
		...
		// constructor
		public DexterityQuiBuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	/// <summary>
	/// Special Magic/Physic Absorb buff
	/// </summary>
	public class AllAbsorbtionBuffHandler : DualStatBuff
	{
		public override int BonusCategory1 { get { return (int)eBuffBonusCategory.Other; } }
		public override int BonusCategory2 { get { return (int)eBuffBonusCategory.Other; } }
		...
		// constructor
		public AllAbsorbtionBuffHandler(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
