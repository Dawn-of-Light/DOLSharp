...
namespace DOL.GS.Spells
{
	...
	/// </summary>
	public abstract class AbstractResistBuff : SingleStatBuff
	{		
		/// <summary>
		...
		{
			// Effectiveness doesn't change resists buff value.
		...
		public AbstractResistBuff(GameLiving caster, Spell spell, SpellLine line)
	...
	public class BodyResistBuff : AbstractResistBuff
	{
		...
		// constructor
		public BodyResistBuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class ColdResistBuff : AbstractResistBuff
	{
		...
		// constructor
		public ColdResistBuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class EnergyResistBuff : AbstractResistBuff
	{
		...
		// constructor
		public EnergyResistBuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class HeatResistBuff : AbstractResistBuff
	{
		...
		// constructor
		public HeatResistBuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class MatterResistBuff : AbstractResistBuff
	{
		...
		// constructor
		public MatterResistBuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class SpiritResistBuff : AbstractResistBuff
	{
		...
		// constructor
		public SpiritResistBuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class BodySpiritEnergyBuff : AbstractResistBuff
	{
		...
		// constructor
		public BodySpiritEnergyBuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class HeatColdMatterBuff : AbstractResistBuff
	{
		...
		// constructor
		public HeatColdMatterBuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class AllMagicResistsBuff : AbstractResistBuff
	{
		...
		// constructor
		public AllMagicResistsBuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class CrushSlashThrustBuff : AbstractResistBuff
	{
		...
		// constructor
		public CrushSlashThrustBuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class CrushResistBuff : AbstractResistBuff
	{
		...
		// constructor
		public CrushResistBuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class SlashResistBuff : AbstractResistBuff
	{
		...
		// constructor
		public SlashResistBuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class ThrustResistBuff : AbstractResistBuff
	{
		...
		// constructor
		public ThrustResistBuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class AllResistsBuff : AbstractResistBuff
	{
		...
		// constructor
		public AllResistsBuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
