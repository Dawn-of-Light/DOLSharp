...
namespace DOL.GS.Spells
{
	...
	public class StyleStun : StunSpellHandler
	{
		...
		{
			return (int)(Spell.Duration*effectiveness);
		}
		...
		{
			// TODO this is bad compare should be based on object hierarchy.
			if (Spell.EffectGroup != 0)
				return Spell.EffectGroup == compare.Spell.EffectGroup;
			if (compare.Spell.SpellType == "Stun")
				return true;
		...
		// constructor
		public StyleStun(GameLiving caster, Spell spell, SpellLine line)
