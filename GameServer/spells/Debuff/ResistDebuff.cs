...
namespace DOL.GS.Spells
{
	...
	/// </summary>
	public abstract class AbstractResistDebuff : SingleStatDebuff
	{
		/// <summary>
		...
		//constructor
		public AbstractResistDebuff(GameLiving caster, Spell spell, SpellLine line)
	...
	public class BodyResistDebuff : AbstractResistDebuff
	{
		...
		// constructor
		public BodyResistDebuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class ColdResistDebuff : AbstractResistDebuff
	{
		...
		// constructor
		public ColdResistDebuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class EnergyResistDebuff : AbstractResistDebuff
	{
		...
		// constructor
		public EnergyResistDebuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class HeatResistDebuff : AbstractResistDebuff
	{
		...
		// constructor
		public HeatResistDebuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class MatterResistDebuff : AbstractResistDebuff
	{
		...
		// constructor
		public MatterResistDebuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class SpiritResistDebuff : AbstractResistDebuff
	{
		...
		// constructor
		public SpiritResistDebuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class SlashResistDebuff : AbstractResistDebuff
	{
		...
		// constructor
		public SlashResistDebuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class ThrustResistDebuff : AbstractResistDebuff
	{
		...
		// constructor
		public ThrustResistDebuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class CrushResistDebuff : AbstractResistDebuff
	{
		...
		// constructor
		public CrushResistDebuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	...
	public class CrushSlashThrustDebuff : AbstractResistDebuff
	{
		...
		// constructor
		public CrushSlashThrustDebuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
	
	[SpellHandlerAttribute("EssenceResistDebuff")]
	public class EssenceResistDebuff : AbstractResistDebuff
	{
		...
		// constructor
		public EssenceResistDebuff(GameLiving caster, Spell spell, SpellLine line)
			: base(caster, spell, line)
		{
		}
	}
