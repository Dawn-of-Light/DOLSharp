...
namespace DOL.GS.Spells
{
    ...
    public class DoTSpellHandler : SpellHandler
    {
        ...
        public override void SendDamageMessages(AttackData ad)
        {
            ...
            {
                MessageToCaster(
                    string.Format(LanguageMgr.GetTranslation(PlayerReceivingMessages.Client, "DoTSpellHandler.SendDamageMessages.YouHitFor",
                    ad.Target.GetName(0, false), ad.Damage)), eChatType.CT_YouHit);
            }
            else
            {
                MessageToCaster(
                    string.Format(LanguageMgr.GetTranslation(PlayerReceivingMessages.Client, "DoTSpellHandler.SendDamageMessages.YourHitsFor",
