...
namespace DOL.GS.Spells
{
	...
	public class PetSpellHandler : SpellHandler
	{
		/// <summary>
		/// Cast the spell.
		/// </summary>
		public override bool CastSpell()
		{
			...
			if (GameServer.ServerRules.IsAllowedToCastSpell(Caster, SpellCastTarget, Spell, SpellLine) && CheckBeginCast(SpellCastTarget))
            {
		...
		public override void FinishSpellCast(GameLiving target)
		{
			...
			if (petBrain != null && Spell.SubSpellID > 0)
			{
                ...
                if (spell != null && spell.SubSpellID == 0)
                {
                    ...
                    petBrain.Notify(GameNPCEvent.PetSpell, Caster, new PetSpellEventArgs(spell, SpellLine, target));
                }
			}
