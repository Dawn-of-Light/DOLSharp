...
namespace DOL.GS.Spells
{
	...
	public class PowerlessSpellHandler : PrimerSpellHandler
	{
		public override bool CheckBeginCast(GameLiving selectedTarget)
		{
            ...
            GameSpellEffect RangeSpell = SpellHelper.FindEffectOnTarget(Caster, "Range");
  			if(RangeSpell != null) { MessageToCaster("You already preparing a Range spell", eChatType.CT_System); return false; }
            GameSpellEffect UninterruptableSpell = SpellHelper.FindEffectOnTarget(Caster, "Uninterruptable");
            ...
            GameSpellEffect PowerlessSpell = SpellHelper.FindEffectOnTarget(Caster, "Powerless");
