	...
	public class SummonMinionHandler : SummonSpellHandler
	{
		...
		public override IList<string> DelveInfo
		{
			get
			{
                ...
                delve.Add(String.Format(LanguageMgr.GetTranslation((Caster as GamePlayer).Client, "SummonMinionHandler.DelveInfo.Text3", (Spell.CastTime / 1000).ToString("0.0## " + LanguageMgr.GetTranslation((Caster as GamePlayer).Client, "Effects.DelveInfo.Seconds").Replace("{0} ", "")))));
                return delve;
			}
		}
	}
