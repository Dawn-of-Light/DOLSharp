...
namespace DOL.GS.Spells
{
	...
	public class BoltSpellHandler : SpellHandler
	{
		...
		public override bool StartSpell(GameLiving target)
		{
			...
			{
				if (targ is GamePlayer && Spell.Target.ToLower() == "cone" && MustCheckLOS(Caster))
				{
					if(ServerProperties.Properties.LOSMGR_ENABLE)
					{
						try
						{
							targ.CurrentRegion.LosCheckManager.LosCheckVincinity(targ, Caster, new LosMgrResponseHandler(DealDamageCheckLOS));
						}
