...
namespace DOL.GS.PlayerTitles
{
	...
	/// </summary>
	public class StrongholdChiefTitle  : EventPlayerTitle
	{
		/// <summary>
		...
		{
			return LanguageMgr.GetTranslation(source.Client.Account.Language, "Titles.Claim.Stronghold.StrongholdChief");
		}
		...
		{
			get { return GamePlayerEvent.CapturedTowersChanged; }
		}
		...
		{
			//1000+
			return player.CapturedTowers >= 1000;
		}
	}
}
