...
namespace DOL.GS.PlayerTitles
{
	...
	/// </summary>
	public class FrontierChallengerTitle : EventPlayerTitle
	{
		/// <summary>
		...
		{
			return LanguageMgr.GetTranslation(player.Client.Account.Language, "Titles.Claim.Frontier.FrontierChallenger");
		}
		...
		{
			return LanguageMgr.GetTranslation(source.Client.Account.Language, "Titles.Claim.Frontier.FrontierChallenger");
		}
		...
		{
			//10 - 49
			return ((player.CapturedKeeps >= 10) && (player.CapturedKeeps < 50));
		}
	}
}
