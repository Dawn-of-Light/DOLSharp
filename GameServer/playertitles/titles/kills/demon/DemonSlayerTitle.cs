...
namespace DOL.GS.PlayerTitles
{
	...
	/// </summary>
	public class DemonSlayerTitle : EventPlayerTitle
	{
		/// <summary>
		...
		{
			return LanguageMgr.GetTranslation(player.Client.Account.Language, "Titles.Kills.Demon.DemonSlayer");
		}
		...
		{
			return LanguageMgr.GetTranslation(source.Client.Account.Language, "Titles.Kills.Demon.DemonSlayer");
		}
		...
		{
			//10-24
			return ((player.KillsLegion >= 10) && (player.KillsLegion < 25));
		}
	}
}
