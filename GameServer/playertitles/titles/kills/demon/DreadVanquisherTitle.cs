...
namespace DOL.GS.PlayerTitles
{
	...
	/// </summary>
	public class DreadVanquisherTitle : EventPlayerTitle
	{
		/// <summary>
		...
		{
			return LanguageMgr.GetTranslation(player.Client.Account.Language, "Titles.Kills.Demon.DreadVanquisher");
		}
		...
		{
			return LanguageMgr.GetTranslation(source.Client.Account.Language, "Titles.Kills.Demon.DreadVanquisher");
		}
		...
		{
			//1000+
			return player.KillsLegion >= 1000;
		}
	}
}
