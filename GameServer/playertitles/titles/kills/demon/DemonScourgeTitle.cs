...
namespace DOL.GS.PlayerTitles
{
	...
	/// </summary>
	public class DemonScourgeTitle : EventPlayerTitle
	{
		/// <summary>
		...
		{
			return LanguageMgr.GetTranslation(player.Client.Account.Language, "Titles.Kills.Demon.DemonScourge");
		}
		...
		{
			return LanguageMgr.GetTranslation(source.Client.Account.Language, "Titles.Kills.Demon.DemonScourge");
		}
		...
		{
			get { return GamePlayerEvent.KillsLegionChanged; }
		}
		...
		{
			//250-999
			return ((player.KillsLegion >= 250) && (player.KillsLegion < 1000));
		}
	}
}
