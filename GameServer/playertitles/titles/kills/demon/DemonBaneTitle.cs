...
namespace DOL.GS.PlayerTitles
{
	...
	/// </summary>
	public class DemonBaneTitle : EventPlayerTitle
	{
		/// <summary>
		...
		{
			return LanguageMgr.GetTranslation(player.Client.Account.Language, "Titles.Kills.Demon.DemonBane");
		}
		...
		{
			return LanguageMgr.GetTranslation(source.Client.Account.Language, "Titles.Kills.Demon.DemonBane");
		}
		...
		{
			//25-249
			return ((player.KillsLegion >= 25) && (player.KillsLegion < 250));
		}
	}
}
