...
namespace DOL.GS.PlayerTitles
{
	...
	/// </summary>
	public class BaneOfMidgardTitle : EventPlayerTitle
	{
		/// <summary>
		...
		{
			return LanguageMgr.GetTranslation(player.Client.Account.Language, "Titles.Kills.Midgard.BaneOfMidgard");
		}
		...
		{
			return LanguageMgr.GetTranslation(source.Client.Account.Language, "Titles.Kills.Midgard.BaneOfMidgard");
		}
		...
		{
			//2000-24999
			return ((player.KillsMidgardPlayers >= 2000) && (player.KillsMidgardPlayers < 25000));
		}
	}
}
