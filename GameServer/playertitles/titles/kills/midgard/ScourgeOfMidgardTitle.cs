...
namespace DOL.GS.PlayerTitles
{
	...
	/// </summary>
	public class ScourgeOfMidgardTitle : EventPlayerTitle
	{
		/// <summary>
		...
		{
			return LanguageMgr.GetTranslation(player.Client.Account.Language, "Titles.Kills.Midgard.ScourgeOfMidgard");
		}
		...
		{
			return LanguageMgr.GetTranslation(source.Client.Account.Language, "Titles.Kills.Midgard.ScourgeOfMidgard");
		}
		...
		{
			//25000 - 99999
			return ((player.KillsMidgardPlayers >= 25000) && (player.KillsMidgardPlayers < 100000));
		}
	}
}
