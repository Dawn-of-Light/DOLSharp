...
namespace DOL.GS.PlayerTitles
{
	...
	/// </summary>
	public class ScourgeOfHiberniaTitle : EventPlayerTitle
	{
		/// <summary>
		...
		{
			return LanguageMgr.GetTranslation(player.Client.Account.Language, "Titles.Kills.Hibernia.ScourgeOfHibernia");
		}
		...
		{
			return LanguageMgr.GetTranslation(source.Client.Account.Language, "Titles.Kills.Hibernia.ScourgeOfHibernia");
		}
		...
		{
			//25000 - 99999
			return ((player.KillsHiberniaPlayers >= 25000) && (player.KillsHiberniaPlayers < 100000));
		}
	}
}
