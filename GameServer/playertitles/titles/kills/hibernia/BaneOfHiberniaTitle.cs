...
namespace DOL.GS.PlayerTitles
{
	...
	/// </summary>
	public class BaneOfHiberniaTitle : EventPlayerTitle
	{
		/// <summary>
		...
		{
			return LanguageMgr.GetTranslation(player.Client.Account.Language, "Titles.Kills.Hibernia.BaneOfHibernia");
		}
		...
		{
			return LanguageMgr.GetTranslation(source.Client.Account.Language, "Titles.Kills.Hibernia.BaneOfHibernia");
		}
		...
		{
			//2000-24999
			return ((player.KillsHiberniaPlayers >= 2000) && (player.KillsHiberniaPlayers < 25000));
		}
	}
}
