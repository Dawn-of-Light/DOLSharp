...
namespace DOL.GS.PlayerTitles
{
	...
	/// </summary>
	public class SlayerOfAlbionTitle : EventPlayerTitle
	{
		/// <summary>
		...
		{
			return LanguageMgr.GetTranslation(player.Client.Account.Language, "Titles.Kills.Albion.SlayerOfAlbion");
		}
		...
		{
			return LanguageMgr.GetTranslation(source.Client.Account.Language, "Titles.Kills.Albion.SlayerOfAlbion");
		}
		...
		{
			//100000+
			return player.KillsAlbionPlayers >= 100000;
		}
	}
}
