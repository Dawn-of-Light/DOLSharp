...
namespace DOL.GS.Scripts
{
	...
	/// </summary>
	public class BaneOfAlbionTitle : EventPlayerTitle
	{
		/// <summary>
		...
		{
            return LanguageMgr.GetTranslation(player.Client, "Titles.Kills.Albion.BaneOfAlbion");
		}
		...
		{
			//2000-24999
			return ((player.KillsAlbionPlayers >= 2000) && (player.KillsAlbionPlayers < 25000));
		}
	}
}
