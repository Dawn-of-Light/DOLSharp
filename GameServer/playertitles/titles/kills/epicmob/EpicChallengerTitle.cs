...
namespace DOL.GS.PlayerTitles
{
	...
	/// </summary>
	public class EpicChallengerTitle : EventPlayerTitle
	{
		/// <summary>
		...
		{
			return LanguageMgr.GetTranslation(player.Client.Account.Language, "Titles.Kills.Epic.EpicChallenger");
		}
		...
		{
			return LanguageMgr.GetTranslation(source.Client.Account.Language, "Titles.Kills.Epic.EpicChallenger");
		}
		...
		{
			get { return GamePlayerEvent.KillsEpicBossChanged; }
		}
		...
		{
			//10-49
			return ((player.KillsEpicBoss >= 10) && (player.KillsEpicBoss < 50));
		}
	}
}
