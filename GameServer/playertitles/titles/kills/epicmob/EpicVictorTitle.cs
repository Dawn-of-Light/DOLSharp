...
namespace DOL.GS.PlayerTitles
{
	...
	/// </summary>
	public class EpicVictorTitle : EventPlayerTitle
	{
		/// <summary>
		...
		{
			return LanguageMgr.GetTranslation(player.Client.Account.Language, "Titles.Kills.Epic.EpicVictor");
		}
		...
		{
			return LanguageMgr.GetTranslation(source.Client.Account.Language, "Titles.Kills.Epic.EpicVictor");
		}
		...
		{
			//50+
			return player.KillsEpicBoss >= 50;
		}
	}
}
