...
namespace DOL.GS.PlayerTitles
{
	...
	/// </summary>
	public class DragonFoeTitle : EventPlayerTitle
	{
		/// <summary>
		...
		{
			return LanguageMgr.GetTranslation(player.Client.Account.Language, "Titles.Kills.Dragon.DragonFoe");
		}
		...
		{
			return LanguageMgr.GetTranslation(source.Client.Account.Language, "Titles.Kills.Dragon.DragonFoe");
		}
		...
		{
			//10-49
			return ((player.KillsDragon >= 10) && (player.KillsDragon < 50));
		}
	}
}
