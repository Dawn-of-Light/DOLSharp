...
namespace DOL.GS.PlayerTitles
{
	...
	/// </summary>
	public class DragonScourgeTitle : EventPlayerTitle
	{
		/// <summary>
		...
		{
			return LanguageMgr.GetTranslation(player.Client.Account.Language, "Titles.Kills.Dragon.DragonScourge");
		}
		...
		{
			return LanguageMgr.GetTranslation(source.Client.Account.Language, "Titles.Kills.Dragon.DragonScourge");
		}
		...
		{
			//50-99
			return ((player.KillsDragon >= 50) && (player.KillsDragon < 100));
		}
	}
}
