...
namespace DOL.GS.PlayerTitles
{
    ...
    public class MasterEnforcerTitle : EventPlayerTitle
    {
        ...
        {
            return LanguageMgr.GetTranslation(player.Client.Account.Language, "Titles.Kills.All.MasterEnforcer");
        }
		...
		{
			return LanguageMgr.GetTranslation(source.Client.Account.Language, "Titles.Kills.All.MasterEnforcer");
		}
		...
		//25000-99999
        	return ((kills >= 25000) && (kills < 100000));
        }
    }
}
