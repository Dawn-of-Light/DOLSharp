...
namespace DOL.GS.PlayerTitles
{
    ...
    /// </summary>
    public class MasterSoldierTitle : EventPlayerTitle
    {
        /// <summary>
        ...
        {
            return LanguageMgr.GetTranslation(player.Client.Account.Language, "Titles.Kills.All.MasterSoldier");
        }
		...
		{
			return LanguageMgr.GetTranslation(source.Client.Account.Language, "Titles.Kills.All.MasterSoldier");
		}
        ...
        {
                int kills = (player.KillsHiberniaPlayers + player.KillsMidgardPlayers + player.KillsAlbionPlayers);
		//2000-24999
