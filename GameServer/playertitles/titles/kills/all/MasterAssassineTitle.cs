...
{
    /// <summary>
    /// "Master Assassine" title granted to everyone who killed 25000+ enemy players.
    /// </summary>
    public class MasterAssassineTitle : EventPlayerTitle
    {
        /// <summary>
		...
		{
			return LanguageMgr.GetTranslation(player.Client.Account.Language, "Titles.Kills.All.MasterAssassine");
		}
		...
		{
			return LanguageMgr.GetTranslation(source.Client.Account.Language, "Titles.Kills.All.MasterAssassine");
		}
