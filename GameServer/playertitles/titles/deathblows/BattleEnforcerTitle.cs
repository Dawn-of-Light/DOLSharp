...
namespace DOL.GS.PlayerTitles
{
	...
	/// </summary>
	public class BattleEnforcer: EventPlayerTitle
	{
		/// <summary>
		...
		{
			return LanguageMgr.GetTranslation(player.Client.Account.Language, "Titles.Deathblows.BattleEnforcer");
		}
		...
		{
			return LanguageMgr.GetTranslation(source.Client.Account.Language, "Titles.Deathblows.BattleEnforcer");
		}
		...
		{
			get { return GamePlayerEvent.KillsTotalDeathBlowsChanged; }
		}
		...
		{
			int kills = (player.KillsAlbionDeathBlows + player.KillsMidgardDeathBlows + player.KillsHiberniaDeathBlows);
			//2000-24999
