        ...
        public bool CanUseRanged
        {
            get
            {
                ...
                if (this is GuardArcher || this is GuardLord)
                {
                    ...
                    if (ActiveWeaponSlot == GameLiving.eActiveWeaponSlot.Distance)
                    {
                        return false;
                    }
                }
                ...
                default:
                    {
                        ...
                        {
                            s = LanguageMgr.GetTranslation(ServerProperties.Properties.SERV_LANGUAGE, "GameKeepGuard.GetPronoun.She");
                        }
                ...
                case 1:
                    {
                        ...
                        {
                            s = LanguageMgr.GetTranslation(ServerProperties.Properties.SERV_LANGUAGE, "GameKeepGuard.GetPronoun.Hers");
                        }
                ...
                case 2:
                    {
                        ...
                        {
                            s = LanguageMgr.GetTranslation(ServerProperties.Properties.SERV_LANGUAGE, "GameKeepGuard.GetPronoun.Her");
                        }
