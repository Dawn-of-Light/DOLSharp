...
namespace DOL.GS.Keeps
{
    ...
    public class MissionMaster : GameKeepGuard
    {
        public override bool Interact(GamePlayer player)
        {
            ...
            {
                SayTo(player, "Hail and well met, " + player.Name + "! As the leader of our forces, I am calling upon our finest warriors to aid in the vanquishing of our enemies. Do you wish to do your duty in defence of our [realm]?");
            }
        ...
        public override bool WhisperReceive(GameLiving source, string str)
        {
            ...
            if (str.ToLower().StartsWith("tower capture"))
            {
                ...
                else
                {
                    ...
                    player.Group.Mission = new CaptureMission(CaptureMission.eCaptureType.Tower, player.Group, str.ToLower().Replace("tower capture", string.Empty).Trim());
                }
            }
            else if (str.ToLower().StartsWith("keep capture"))
            {
                ...
                else
                {
                    ...
                    player.Group.Mission = new CaptureMission(CaptureMission.eCaptureType.Keep, player.Group, str.ToLower().Replace("keep capture", string.Empty).Trim());
                }
            }
            else
            {
                    ...
                    case "realm":
                        {
                            ...
                            {
                                SayTo(player, "Excellent! We all must do our part. How would you like to assist the cause? I have [personal missions] and [group missions] available.");
                            }
