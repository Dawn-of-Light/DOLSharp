	...
	public class Tailoring : AbstractCraftingSkill
	{
		...
		public override void GainCraftingSkillPoints(GamePlayer player, CraftItemData item)
		{
			...
			if(player.CraftingPrimarySkill == eCraftingSkill.Tailoring)
			{
				...
				{
					player.Out.SendMessage("You must see your trainer to raise your Tailoring further!",eChatType.CT_Important,eChatLoc.CL_SystemWindow);
					return;
				}
			}
			else
			...
			{
				player.IncreaseCraftingSkill(eCraftingSkill.Tailoring, 1);
