...
namespace DOL.GS.Quests.Requirements
{
	...
	/// </summary>
    [QuestRequirementAttribute(RequirementType=eRequirementType.QuestStep,DefaultValueN=eDefaultValueConstants.QuestType)]
	public class QuestStepRequirement : AbstractQuestRequirement<Type,int>
	{
        ...
        public QuestStepRequirement(BaseQuestPart questPart, eRequirementType type, Object n, Object v, eComparator comp)
		...
		/// <param name="v">Second Requirement Variable, meaning depends on RequirementType</param>
		/// <param name="comp">Comparator used if some values are veeing compared</param>
        public QuestStepRequirement(BaseQuestPart questPart,  Type n, int v, eComparator comp)
            : this(questPart, eRequirementType.QuestStep, (object)n, (object)v, comp)
		{   			
		}
