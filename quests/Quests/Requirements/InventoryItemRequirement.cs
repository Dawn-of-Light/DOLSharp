...
namespace DOL.GS.Quests.Requirements
{
	...
	/// </summary>
    [QuestRequirementAttribute(RequirementType=eRequirementType.InventoryItem, DefaultValueV = 1)]
	public class InventoryItemRequirement : AbstractQuestRequirement<ItemTemplate,int>
	{
        ...
        public InventoryItemRequirement(BaseQuestPart questPart, eRequirementType type, Object n, Object v, eComparator comp)
		...
		/// <param name="v">Second Requirement Variable, meaning depends on RequirementType</param>
		/// <param name="comp">Comparator used if some values are veeing compared</param>
        public InventoryItemRequirement(BaseQuestPart questPart, ItemTemplate n, int v, eComparator comp)
            : this(questPart, eRequirementType.InventoryItem, (object)n, (object)v, comp)
		{   			
		}
