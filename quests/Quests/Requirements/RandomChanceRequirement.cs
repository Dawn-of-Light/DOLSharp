...
namespace DOL.GS.Quests.Requirements
{
	...
	/// </summary>
    [QuestRequirementAttribute(RequirementType=eRequirementType.Random)]
	public class RandomChanceRequirement : AbstractQuestRequirement<int,Unused>
	{
        ...
        public RandomChanceRequirement(BaseQuestPart questPart, eRequirementType type, Object n, Object v, eComparator comp)
		...
		/// <param name="questPart">Parent QuestPart of this Requirement</param>		
		/// <param name="n">First Requirement Variable, meaning depends on RequirementType</param>		
        public RandomChanceRequirement(BaseQuestPart questPart,  int n )
            : this(questPart, eRequirementType.Random, (object)n, (object)null, eComparator.None)
		{   			
		}
