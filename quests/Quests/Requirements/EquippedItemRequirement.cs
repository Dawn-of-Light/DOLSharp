...
namespace DOL.GS.Quests.Requirements
{
	...
	/// </summary>
    [QuestRequirementAttribute(RequirementType=eRequirementType.EquippedItem)]
	public class EquippedItemRequirement : AbstractQuestRequirement<ItemTemplate,Unused>
	{
        ...
        public EquippedItemRequirement(BaseQuestPart questPart, eRequirementType type, Object n, Object v, eComparator comp)
		...
		/// <param name="questPart">Parent QuestPart of this Requirement</param>		
		/// <param name="n">First Requirement Variable, meaning depends on RequirementType</param>				
        public EquippedItemRequirement(BaseQuestPart questPart, ItemTemplate n )
            : this(questPart, eRequirementType.EquippedItem, (object)n, (object)null, eComparator.None)
		{   			
		}
