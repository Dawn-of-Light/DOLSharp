...
{	
    ...
    /// </summary>
    [QuestTriggerAttribute(TriggerType=eTriggerType.GiveItem,DefaultValueK=eDefaultValueConstants.NPC)]
    public class GiveItemTrigger : AbstractQuestTrigger<GameNPC,ItemTemplate>
    {
        ...
        public GiveItemTrigger(BaseQuestPart questPart, eTriggerType type, Object k, Object i)
        ...
        /// <param name="k">keyword (K), meaning depends on triggertype</param>
        /// <param name="i">variable (I), meaning depends on triggertype</param>
        public GiveItemTrigger(BaseQuestPart questPart,  GameNPC k, ItemTemplate i)
            : this(questPart, eTriggerType.GiveItem, (object)k,(object) i)
        { }
        ...
        public override bool Check(DOLEvent e, object sender, EventArgs args, GamePlayer player)
        {
            ...
            if (e == GamePlayerEvent.GiveItem)
            {
                ...
                result = (gArgs.Target == K && gArgs.Item.Name == I.Name);
            }
