...
{	
    ...
    /// </summary>
    [QuestTriggerAttribute(TriggerType=eTriggerType.PlayerKilled,DefaultValueI=eDefaultValueConstants.NPC)]
    public class PlayerKilledTrigger : AbstractQuestTrigger<Unused,GameNPC>
    {
        ...
        public PlayerKilledTrigger(BaseQuestPart questPart, eTriggerType type, Object k, Object i)
        ...
        /// <param name="questPart">Parent QuestPart of this Trigger</param>                
        /// <param name="i">variable (I), meaning depends on triggertype</param>
        public PlayerKilledTrigger(BaseQuestPart questPart, GameNPC i)
            : this(questPart, eTriggerType.PlayerKilled, (object)null,(object) i)
        { }
