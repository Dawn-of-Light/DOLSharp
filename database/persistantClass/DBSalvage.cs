...
namespace DOL.GS.Database
{
	...
	public class DBSalvage
	{
		...
		private StackableItemTemplate m_materialItemtemplate;
		...
		/// </summary>
		public StackableItemTemplate MaterialItemtemplate
		{
			get
			{
				if(m_materialItemtemplate == null) m_materialItemtemplate = new StackableItemTemplate();
