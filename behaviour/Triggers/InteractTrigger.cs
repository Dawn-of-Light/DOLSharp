...
{	
    ...
    /// </summary>
    [TriggerAttribute(Global = true,TriggerType = eTriggerType.Interact, DefaultValueI = eDefaultValueConstants.NPC)]
    public class InteractTrigger : AbstractTrigger<Unused,GameNPC>
    {
