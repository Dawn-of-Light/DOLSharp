...
namespace DOLGameServerConsole
{
	...
	public class ConsolePacketLib : IPacketLib
	{
		...
		public byte GetPacketCode(ePackets packetCode)
		{
			return 0;
		}
		...
		public void SendDialogBox(eDialogCode code, ushort data1, ushort data2, ushort data3, ushort data4, eDialogType type,
		                          bool autoWarpText, string message)
		{
		}
		...
		public void SendPetWindow(GameLiving pet, ePetWindowAction windowAction, eAggressionState aggroState,
